...
/**
 * Enterprise FinVerse Entity: ChipsIntradaySettlementSlip
 * Specification: Clearing House Interbank Payments System (CHIPS) settlement
 */
@Entity
@Table(name = "chipsintradaysettlementslips", indexes = {
    @Index(name = "idx_chipsintradaysettlementslip_tenant", columnList = "tenant_id"),
    @Index(name = "idx_chipsintradaysettlementslip_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ChipsIntradaySettlementSlip extends BaseEntity {
