...
/**
 * Enterprise FinVerse Entity: Iso20022Pacs009HighValue
 * Specification: ISO 20022 PACS.009 financial institutional credit transfer
 */
@Entity
@Table(name = "iso20022pacs009highvalues", indexes = {
    @Index(name = "idx_iso20022pacs009highvalue_tenant", columnList = "tenant_id"),
    @Index(name = "idx_iso20022pacs009highvalue_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class Iso20022Pacs009HighValue extends BaseEntity {
