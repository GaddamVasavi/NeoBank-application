...
/**
 * Enterprise FinVerse Entity: ContinuousLinkedSettlementPvP
 * Specification: CLS PvP multi-currency foreign exchange settlement match
 */
@Entity
@Table(name = "continuouslinkedsettlementpvps", indexes = {
    @Index(name = "idx_continuouslinkedsettlementpvp_tenant", columnList = "tenant_id"),
    @Index(name = "idx_continuouslinkedsettlementpvp_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ContinuousLinkedSettlementPvP extends BaseEntity {
