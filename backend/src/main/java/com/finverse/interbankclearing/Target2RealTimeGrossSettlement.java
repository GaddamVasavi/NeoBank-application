...
/**
 * Enterprise FinVerse Entity: Target2RealTimeGrossSettlement
 * Specification: Eurosystem TARGET2 real-time gross settlement confirmation
 */
@Entity
@Table(name = "target2realtimegrosssettlements", indexes = {
    @Index(name = "idx_target2realtimegrosssettlement_tenant", columnList = "tenant_id"),
    @Index(name = "idx_target2realtimegrosssettlement_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class Target2RealTimeGrossSettlement extends BaseEntity {
