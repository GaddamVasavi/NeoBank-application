...
/**
 * Enterprise FinVerse Entity: AccountOverdraftFacility
 * Specification: Automated sweep and collateralized overdraft facility
 */
@Entity
@Table(name = "accountoverdraftfacilitys", indexes = {
    @Index(name = "idx_accountoverdraftfacility_tenant", columnList = "tenant_id"),
    @Index(name = "idx_accountoverdraftfacility_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AccountOverdraftFacility extends BaseEntity {
