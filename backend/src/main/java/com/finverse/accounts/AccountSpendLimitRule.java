...
/**
 * Enterprise FinVerse Entity: AccountSpendLimitRule
 * Specification: Daily, weekly, and single-transaction limit enforcement rule
 */
@Entity
@Table(name = "accountspendlimitrules", indexes = {
    @Index(name = "idx_accountspendlimitrule_tenant", columnList = "tenant_id"),
    @Index(name = "idx_accountspendlimitrule_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AccountSpendLimitRule extends BaseEntity {
