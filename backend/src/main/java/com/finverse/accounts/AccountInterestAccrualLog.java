...
/**
 * Enterprise FinVerse Entity: AccountInterestAccrualLog
 * Specification: Daily compound interest calculation and monthly capitalization
 */
@Entity
@Table(name = "accountinterestaccruallogs", indexes = {
    @Index(name = "idx_accountinterestaccruallog_tenant", columnList = "tenant_id"),
    @Index(name = "idx_accountinterestaccruallog_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AccountInterestAccrualLog extends BaseEntity {
