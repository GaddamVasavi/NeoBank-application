...
/**
 * Enterprise FinVerse Entity: AccountFreezeOrderFile
 * Specification: Legal garnishment, court order, and compliance freeze record
 */
@Entity
@Table(name = "accountfreezeorderfiles", indexes = {
    @Index(name = "idx_accountfreezeorderfile_tenant", columnList = "tenant_id"),
    @Index(name = "idx_accountfreezeorderfile_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AccountFreezeOrderFile extends BaseEntity {
