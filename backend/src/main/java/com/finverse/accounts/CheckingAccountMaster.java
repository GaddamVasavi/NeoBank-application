...
/**
 * Enterprise FinVerse Entity: CheckingAccountMaster
 * Specification: Multi-currency commercial checking account entity
 */
@Entity
@Table(name = "checkingaccountmasters", indexes = {
    @Index(name = "idx_checkingaccountmaster_tenant", columnList = "tenant_id"),
    @Index(name = "idx_checkingaccountmaster_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CheckingAccountMaster extends BaseEntity {
