...
/**
 * Enterprise FinVerse Entity: SubAccountHierarchyNode
 * Specification: Parent-child multi-entity sub-account consolidation tree
 */
@Entity
@Table(name = "subaccounthierarchynodes", indexes = {
    @Index(name = "idx_subaccounthierarchynode_tenant", columnList = "tenant_id"),
    @Index(name = "idx_subaccounthierarchynode_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SubAccountHierarchyNode extends BaseEntity {
