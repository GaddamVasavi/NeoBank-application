...
/**
 * Enterprise FinVerse Entity: AccountStatementArchive
 * Specification: Cryptographically sealed PDF and MT940 statement archive
 */
@Entity
@Table(name = "accountstatementarchives", indexes = {
    @Index(name = "idx_accountstatementarchive_tenant", columnList = "tenant_id"),
    @Index(name = "idx_accountstatementarchive_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AccountStatementArchive extends BaseEntity {
