...
/**
 * Enterprise FinVerse Entity: EscrowCollateralAccount
 * Specification: Multi-signature smart conditional escrow collateral vault
 */
@Entity
@Table(name = "escrowcollateralaccounts", indexes = {
    @Index(name = "idx_escrowcollateralaccount_tenant", columnList = "tenant_id"),
    @Index(name = "idx_escrowcollateralaccount_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EscrowCollateralAccount extends BaseEntity {
