...
/**
 * Enterprise FinVerse Entity: HighYieldSavingsAccount
 * Specification: Tiered interest accrual high-yield savings account
 */
@Entity
@Table(name = "highyieldsavingsaccounts", indexes = {
    @Index(name = "idx_highyieldsavingsaccount_tenant", columnList = "tenant_id"),
    @Index(name = "idx_highyieldsavingsaccount_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class HighYieldSavingsAccount extends BaseEntity {
