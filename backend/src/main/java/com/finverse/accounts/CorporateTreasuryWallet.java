...
/**
 * Enterprise FinVerse Entity: CorporateTreasuryWallet
 * Specification: Instant settlement tokenized treasury operating wallet
 */
@Entity
@Table(name = "corporatetreasurywallets", indexes = {
    @Index(name = "idx_corporatetreasurywallet_tenant", columnList = "tenant_id"),
    @Index(name = "idx_corporatetreasurywallet_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorporateTreasuryWallet extends BaseEntity {
