...
/**
 * Enterprise FinVerse Entity: CarbonOffsetRegistrySerial
 * Specification: Verra / Gold Standard certified carbon offset serial registry
 */
@Entity
@Table(name = "carbonoffsetregistryserials", indexes = {
    @Index(name = "idx_carbonoffsetregistryserial_tenant", columnList = "tenant_id"),
    @Index(name = "idx_carbonoffsetregistryserial_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CarbonOffsetRegistrySerial extends BaseEntity {
