...
/**
 * Enterprise FinVerse Entity: Scope3FinancedEmissions
 * Specification: PCAF standard bank portfolio financed carbon emissions metric
 */
@Entity
@Table(name = "scope3financedemissionss", indexes = {
    @Index(name = "idx_scope3financedemissions_tenant", columnList = "tenant_id"),
    @Index(name = "idx_scope3financedemissions_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class Scope3FinancedEmissions extends BaseEntity {
