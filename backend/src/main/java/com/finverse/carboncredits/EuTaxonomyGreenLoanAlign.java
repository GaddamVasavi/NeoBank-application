...
/**
 * Enterprise FinVerse Entity: EuTaxonomyGreenLoanAlign
 * Specification: EU Taxonomy green loan alignment and ESG KPI certification
 */
@Entity
@Table(name = "eutaxonomygreenloanaligns", indexes = {
    @Index(name = "idx_eutaxonomygreenloanalign_tenant", columnList = "tenant_id"),
    @Index(name = "idx_eutaxonomygreenloanalign_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EuTaxonomyGreenLoanAlign extends BaseEntity {
