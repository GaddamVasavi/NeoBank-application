...
/**
 * Enterprise FinVerse Entity: SustainabilityLinkedStepUp
 * Specification: Coupon penalty step-up sustainability-linked bond metric
 */
@Entity
@Table(name = "sustainabilitylinkedstepups", indexes = {
    @Index(name = "idx_sustainabilitylinkedstepup_tenant", columnList = "tenant_id"),
    @Index(name = "idx_sustainabilitylinkedstepup_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SustainabilityLinkedStepUp extends BaseEntity {
