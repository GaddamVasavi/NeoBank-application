...
/**
 * Enterprise FinVerse Entity: ProductCatalogMaster
 * Specification: Standard product and service catalog with multi-currency pricing
 */
@Entity
@Table(name = "productcatalogmasters", indexes = {
    @Index(name = "idx_productcatalogmaster_tenant", columnList = "tenant_id"),
    @Index(name = "idx_productcatalogmaster_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ProductCatalogMaster extends BaseEntity {
