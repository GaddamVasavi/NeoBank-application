...
/**
 * Enterprise FinVerse Entity: CustomerBillingProfile
 * Specification: Customer tax ID, billing address, and default payment method
 */
@Entity
@Table(name = "customerbillingprofiles", indexes = {
    @Index(name = "idx_customerbillingprofile_tenant", columnList = "tenant_id"),
    @Index(name = "idx_customerbillingprofile_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CustomerBillingProfile extends BaseEntity {
