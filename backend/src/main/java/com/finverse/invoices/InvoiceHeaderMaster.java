...
/**
 * Enterprise FinVerse Entity: InvoiceHeaderMaster
 * Specification: B2B itemized invoice header, sequence numbering, and lifecycle
 */
@Entity
@Table(name = "invoiceheadermasters", indexes = {
    @Index(name = "idx_invoiceheadermaster_tenant", columnList = "tenant_id"),
    @Index(name = "idx_invoiceheadermaster_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InvoiceHeaderMaster extends BaseEntity {
