...
/**
 * Enterprise FinVerse Entity: InvoicePaymentAllocation
 * Specification: Partial and full payment allocation against outstanding invoices
 */
@Entity
@Table(name = "invoicepaymentallocations", indexes = {
    @Index(name = "idx_invoicepaymentallocation_tenant", columnList = "tenant_id"),
    @Index(name = "idx_invoicepaymentallocation_ref", columnList = "system_reference")
})
