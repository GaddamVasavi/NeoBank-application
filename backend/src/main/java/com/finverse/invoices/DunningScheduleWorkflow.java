...
/**
 * Enterprise FinVerse Entity: DunningScheduleWorkflow
 * Specification: Overdue invoice automated dunning letter and penalty interest
 */
@Entity
@Table(name = "dunningscheduleworkflows", indexes = {
    @Index(name = "idx_dunningscheduleworkflow_tenant", columnList = "tenant_id"),
    @Index(name = "idx_dunningscheduleworkflow_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DunningScheduleWorkflow extends BaseEntity {
