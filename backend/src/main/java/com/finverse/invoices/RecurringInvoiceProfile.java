...
/**
 * Enterprise FinVerse Entity: RecurringInvoiceProfile
 * Specification: Automated calendar recurring subscription and retainer invoice
 */
@Entity
@Table(name = "recurringinvoiceprofiles", indexes = {
    @Index(name = "idx_recurringinvoiceprofile_tenant", columnList = "tenant_id"),
    @Index(name = "idx_recurringinvoiceprofile_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RecurringInvoiceProfile extends BaseEntity {
