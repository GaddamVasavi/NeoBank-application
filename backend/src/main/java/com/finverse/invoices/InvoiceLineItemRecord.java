...
/**
 * Enterprise FinVerse Entity: InvoiceLineItemRecord
 * Specification: Product SKU, quantity, unit price, and discount line item
 */
@Entity
@Table(name = "invoicelineitemrecords", indexes = {
    @Index(name = "idx_invoicelineitemrecord_tenant", columnList = "tenant_id"),
    @Index(name = "idx_invoicelineitemrecord_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InvoiceLineItemRecord extends BaseEntity {
