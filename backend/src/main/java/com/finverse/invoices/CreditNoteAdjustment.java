...
/**
 * Enterprise FinVerse Entity: CreditNoteAdjustment
 * Specification: Commercial dispute credit note and invoice amount write-down
 */
@Entity
@Table(name = "creditnoteadjustments", indexes = {
    @Index(name = "idx_creditnoteadjustment_tenant", columnList = "tenant_id"),
    @Index(name = "idx_creditnoteadjustment_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CreditNoteAdjustment extends BaseEntity {
