...
/**
 * Enterprise FinVerse Entity: TaxJurisdictionRate
 * Specification: Cross-border VAT, GST, and state sales tax calculation engine
 */
@Entity
@Table(name = "taxjurisdictionrates", indexes = {
    @Index(name = "idx_taxjurisdictionrate_tenant", columnList = "tenant_id"),
    @Index(name = "idx_taxjurisdictionrate_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TaxJurisdictionRate extends BaseEntity {
