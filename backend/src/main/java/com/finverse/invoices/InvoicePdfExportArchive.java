...
/**
 * Enterprise FinVerse Entity: InvoicePdfExportArchive
 * Specification: Digitally signed PDF/A invoice document archive
 */
@Entity
@Table(name = "invoicepdfexportarchives", indexes = {
    @Index(name = "idx_invoicepdfexportarchive_tenant", columnList = "tenant_id"),
    @Index(name = "idx_invoicepdfexportarchive_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InvoicePdfExportArchive extends BaseEntity {
