...
/**
 * Enterprise FinVerse Entity: InAppNotificationEvent
 * Specification: Real-time WebSockets / SSE in-app user notification event
 */
@Entity
@Table(name = "inappnotificationevents", indexes = {
    @Index(name = "idx_inappnotificationevent_tenant", columnList = "tenant_id"),
    @Index(name = "idx_inappnotificationevent_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InAppNotificationEvent extends BaseEntity {
