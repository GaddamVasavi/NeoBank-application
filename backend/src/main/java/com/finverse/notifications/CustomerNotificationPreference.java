...
/**
 * Enterprise FinVerse Entity: CustomerNotificationPreference
 * Specification: Per-channel, per-topic opt-in and quiet hours configuration
 */
@Entity
@Table(name = "customernotificationpreferences", indexes = {
    @Index(name = "idx_customernotificationpreference_tenant", columnList = "tenant_id"),
    @Index(name = "idx_customernotificationpreference_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CustomerNotificationPreference extends BaseEntity {
