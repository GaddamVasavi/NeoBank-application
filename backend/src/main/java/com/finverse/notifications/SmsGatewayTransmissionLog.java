...
/**
 * Enterprise FinVerse Entity: SmsGatewayTransmissionLog
 * Specification: Twilio / Infobip priority SMS OTP and alert dispatch log
 */
@Entity
@Table(name = "smsgatewaytransmissionlogs", indexes = {
    @Index(name = "idx_smsgatewaytransmissionlog_tenant", columnList = "tenant_id"),
    @Index(name = "idx_smsgatewaytransmissionlog_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SmsGatewayTransmissionLog extends BaseEntity {
