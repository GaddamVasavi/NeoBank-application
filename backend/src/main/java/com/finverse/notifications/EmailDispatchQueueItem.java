...
/**
 * Enterprise FinVerse Entity: EmailDispatchQueueItem
 * Specification: Transactional SMTP / AWS SES email dispatch receipt
 */
@Entity
@Table(name = "emaildispatchqueueitems", indexes = {
    @Index(name = "idx_emaildispatchqueueitem_tenant", columnList = "tenant_id"),
    @Index(name = "idx_emaildispatchqueueitem_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EmailDispatchQueueItem extends BaseEntity {
