...
/**
 * Enterprise FinVerse Entity: CorsAllowedOriginConfig
 * Specification: Strict cross-origin resource sharing whitelist domain entry
 */
@Entity
@Table(name = "corsallowedoriginconfigs", indexes = {
    @Index(name = "idx_corsallowedoriginconfig_tenant", columnList = "tenant_id"),
    @Index(name = "idx_corsallowedoriginconfig_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorsAllowedOriginConfig extends BaseEntity {
