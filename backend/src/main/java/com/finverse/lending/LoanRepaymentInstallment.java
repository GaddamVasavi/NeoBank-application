...
/**
 * Enterprise FinVerse Entity: LoanRepaymentInstallment
 * Specification: Monthly principal, interest, and escrow repayment processing
 */
@Entity
@Table(name = "loanrepaymentinstallments", indexes = {
    @Index(name = "idx_loanrepaymentinstallment_tenant", columnList = "tenant_id"),
    @Index(name = "idx_loanrepaymentinstallment_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LoanRepaymentInstallment extends BaseEntity {
