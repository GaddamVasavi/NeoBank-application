...
/**
 * Enterprise FinVerse Entity: NonPerformingLoanWorkout
 * Specification: Default notice, 90-day delinquency, and debt recovery case
 */
@Entity
@Table(name = "nonperformingloanworkouts", indexes = {
    @Index(name = "idx_nonperformingloanworkout_tenant", columnList = "tenant_id"),
    @Index(name = "idx_nonperformingloanworkout_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class NonPerformingLoanWorkout extends BaseEntity {
