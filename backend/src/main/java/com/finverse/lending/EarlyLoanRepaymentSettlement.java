...
/**
 * Enterprise FinVerse Entity: EarlyLoanRepaymentSettlement
 * Specification: Principal prepayment calculation and early penalty waiver
 */
@Entity
@Table(name = "earlyloanrepaymentsettlements", indexes = {
    @Index(name = "idx_earlyloanrepaymentsettlement_tenant", columnList = "tenant_id"),
    @Index(name = "idx_earlyloanrepaymentsettlement_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EarlyLoanRepaymentSettlement extends BaseEntity {
