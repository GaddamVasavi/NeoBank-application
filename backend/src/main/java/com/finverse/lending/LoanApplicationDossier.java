...
/**
 * Enterprise FinVerse Entity: LoanApplicationDossier
 * Specification: Commercial and retail loan origination application dossier
 */
@Entity
@Table(name = "loanapplicationdossiers", indexes = {
    @Index(name = "idx_loanapplicationdossier_tenant", columnList = "tenant_id"),
    @Index(name = "idx_loanapplicationdossier_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LoanApplicationDossier extends BaseEntity {
