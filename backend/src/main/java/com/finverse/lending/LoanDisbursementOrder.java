...
/**
 * Enterprise FinVerse Entity: LoanDisbursementOrder
 * Specification: Approved loan principal funds disbursement and fee deduction
 */
@Entity
@Table(name = "loandisbursementorders", indexes = {
    @Index(name = "idx_loandisbursementorder_tenant", columnList = "tenant_id"),
    @Index(name = "idx_loandisbursementorder_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LoanDisbursementOrder extends BaseEntity {
