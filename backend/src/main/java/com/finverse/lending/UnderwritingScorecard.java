...
/**
 * Enterprise FinVerse Entity: UnderwritingScorecard
 * Specification: Automated credit score, debt-to-income, and risk rating matrix
 */
@Entity
@Table(name = "underwritingscorecards", indexes = {
    @Index(name = "idx_underwritingscorecard_tenant", columnList = "tenant_id"),
    @Index(name = "idx_underwritingscorecard_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class UnderwritingScorecard extends BaseEntity {
