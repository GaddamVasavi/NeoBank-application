...
/**
 * Enterprise FinVerse Entity: LoanAmortizationSchedule
 * Specification: Fixed and floating rate French/German amortization schedule
 */
@Entity
@Table(name = "loanamortizationschedules", indexes = {
    @Index(name = "idx_loanamortizationschedule_tenant", columnList = "tenant_id"),
    @Index(name = "idx_loanamortizationschedule_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LoanAmortizationSchedule extends BaseEntity {
