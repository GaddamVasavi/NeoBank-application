...
/**
 * Enterprise FinVerse Entity: EquipmentLeasingFacility
 * Specification: Asset finance lease agreement and MACRS depreciation schedule
 */
@Entity
@Table(name = "equipmentleasingfacilitys", indexes = {
    @Index(name = "idx_equipmentleasingfacility_tenant", columnList = "tenant_id"),
    @Index(name = "idx_equipmentleasingfacility_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EquipmentLeasingFacility extends BaseEntity {
