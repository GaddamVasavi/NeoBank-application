...
/**
 * Enterprise FinVerse Entity: WorkingCapitalCreditLine
 * Specification: Revolving commercial line of credit and drawdown facility
 */
@Entity
@Table(name = "workingcapitalcreditlines", indexes = {
    @Index(name = "idx_workingcapitalcreditline_tenant", columnList = "tenant_id"),
    @Index(name = "idx_workingcapitalcreditline_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class WorkingCapitalCreditLine extends BaseEntity {
