...
/**
 * Enterprise FinVerse Entity: DeviceFingerprintProfile
 * Specification: Hardware canvas, WebGL, and TLS client fingerprint profile
 */
@Entity
@Table(name = "devicefingerprintprofiles", indexes = {
    @Index(name = "idx_devicefingerprintprofile_tenant", columnList = "tenant_id"),
    @Index(name = "idx_devicefingerprintprofile_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DeviceFingerprintProfile extends BaseEntity {
