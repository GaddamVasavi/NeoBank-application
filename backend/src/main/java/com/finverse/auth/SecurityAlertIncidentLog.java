...
/**
 * Enterprise FinVerse Entity: SecurityAlertIncidentLog
 * Specification: Account lockout, brute-force attack, and anomalous login alert
 */
@Entity
@Table(name = "securityalertincidentlogs", indexes = {
    @Index(name = "idx_securityalertincidentlog_tenant", columnList = "tenant_id"),
    @Index(name = "idx_securityalertincidentlog_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SecurityAlertIncidentLog extends BaseEntity {
