...
/**
 * Enterprise FinVerse Entity: ApiKeyCredentialRegistry
 * Specification: Tenant API gateway secret key and HMAC signing authorization
 */
@Entity
@Table(name = "apikeycredentialregistrys", indexes = {
    @Index(name = "idx_apikeycredentialregistry_tenant", columnList = "tenant_id"),
    @Index(name = "idx_apikeycredentialregistry_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ApiKeyCredentialRegistry extends BaseEntity {
