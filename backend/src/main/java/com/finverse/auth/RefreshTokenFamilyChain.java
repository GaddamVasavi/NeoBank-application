...
/**
 * Enterprise FinVerse Entity: RefreshTokenFamilyChain
 * Specification: Rotating refresh token family lineage for token theft detection
 */
@Entity
@Table(name = "refreshtokenfamilychains", indexes = {
    @Index(name = "idx_refreshtokenfamilychain_tenant", columnList = "tenant_id"),
    @Index(name = "idx_refreshtokenfamilychain_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RefreshTokenFamilyChain extends BaseEntity {
