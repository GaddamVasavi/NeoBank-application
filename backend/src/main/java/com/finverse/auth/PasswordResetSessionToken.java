...
/**
 * Enterprise FinVerse Entity: PasswordResetSessionToken
 * Specification: Cryptographic single-use tokenized password reset session
 */
@Entity
@Table(name = "passwordresetsessiontokens", indexes = {
    @Index(name = "idx_passwordresetsessiontoken_tenant", columnList = "tenant_id"),
    @Index(name = "idx_passwordresetsessiontoken_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PasswordResetSessionToken extends BaseEntity {
