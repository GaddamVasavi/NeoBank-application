...
/**
 * Enterprise FinVerse Entity: AuthMfaEnrollmentMaster
 * Specification: TOTP RFC 6238 and FIDO2 WebAuthn hardware authenticator enrollment
 */
@Entity
@Table(name = "authmfaenrollmentmasters", indexes = {
    @Index(name = "idx_authmfaenrollmentmaster_tenant", columnList = "tenant_id"),
    @Index(name = "idx_authmfaenrollmentmaster_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AuthMfaEnrollmentMaster extends BaseEntity {
