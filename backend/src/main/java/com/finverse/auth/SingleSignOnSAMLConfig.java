...
/**
 * Enterprise FinVerse Entity: SingleSignOnSAMLConfig
 * Specification: Enterprise Okta / Azure AD SAML 2.0 Identity Provider config
 */
@Entity
@Table(name = "singlesignonsamlconfigs", indexes = {
    @Index(name = "idx_singlesignonsamlconfig_tenant", columnList = "tenant_id"),
    @Index(name = "idx_singlesignonsamlconfig_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SingleSignOnSAMLConfig extends BaseEntity {
