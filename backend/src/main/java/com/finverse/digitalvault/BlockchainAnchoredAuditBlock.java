...
/**
 * Enterprise FinVerse Entity: BlockchainAnchoredAuditBlock
 * Specification: Public blockchain-anchored SHA-256 hash time-stamped log
 */
@Entity
@Table(name = "blockchainanchoredauditblocks", indexes = {
    @Index(name = "idx_blockchainanchoredauditblock_tenant", columnList = "tenant_id"),
    @Index(name = "idx_blockchainanchoredauditblock_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BlockchainAnchoredAuditBlock extends BaseEntity {
