...
/**
 * Enterprise FinVerse Entity: ClientSecureDepositVaultFile
 * Specification: AES-256 GCM client document digital safe deposit box item
 */
@Entity
@Table(name = "clientsecuredepositvaultfiles", indexes = {
    @Index(name = "idx_clientsecuredepositvaultfile_tenant", columnList = "tenant_id"),
    @Index(name = "idx_clientsecuredepositvaultfile_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ClientSecureDepositVaultFile extends BaseEntity {
