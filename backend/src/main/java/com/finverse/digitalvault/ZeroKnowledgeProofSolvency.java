...
/**
 * Enterprise FinVerse Entity: ZeroKnowledgeProofSolvency
 * Specification: Zk-SNARK identity and solvency proof verification token
 */
@Entity
@Table(name = "zeroknowledgeproofsolvencys", indexes = {
    @Index(name = "idx_zeroknowledgeproofsolvency_tenant", columnList = "tenant_id"),
    @Index(name = "idx_zeroknowledgeproofsolvency_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ZeroKnowledgeProofSolvency extends BaseEntity {
