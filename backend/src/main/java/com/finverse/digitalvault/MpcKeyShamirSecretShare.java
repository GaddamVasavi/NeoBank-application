...
/**
 * Enterprise FinVerse Entity: MpcKeyShamirSecretShare
 * Specification: Shamir secret sharing threshold MPC private key shard
 */
@Entity
@Table(name = "mpckeyshamirsecretshares", indexes = {
    @Index(name = "idx_mpckeyshamirsecretshare_tenant", columnList = "tenant_id"),
    @Index(name = "idx_mpckeyshamirsecretshare_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MpcKeyShamirSecretShare extends BaseEntity {
