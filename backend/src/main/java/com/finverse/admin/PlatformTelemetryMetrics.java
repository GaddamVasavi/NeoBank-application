...
/**
 * Enterprise FinVerse Entity: PlatformTelemetryMetrics
 * Specification: System JVM memory, database pool, and Kafka latency metrics
 */
@Entity
@Table(name = "platformtelemetrymetricss", indexes = {
    @Index(name = "idx_platformtelemetrymetrics_tenant", columnList = "tenant_id"),
    @Index(name = "idx_platformtelemetrymetrics_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PlatformTelemetryMetrics extends BaseEntity {
