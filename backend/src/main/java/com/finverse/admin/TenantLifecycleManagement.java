...
/**
 * Enterprise FinVerse Entity: TenantLifecycleManagement
 * Specification: Tenant provisioning, plan upgrades, and suspension control
 */
@Entity
@Table(name = "tenantlifecyclemanagements", indexes = {
    @Index(name = "idx_tenantlifecyclemanagement_tenant", columnList = "tenant_id"),
    @Index(name = "idx_tenantlifecyclemanagement_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TenantLifecycleManagement extends BaseEntity {
