...
/**
 * Enterprise FinVerse Entity: SuperAdminAccessLog
 * Specification: Privileged super-admin action, impersonation, and policy audit
 */
@Entity
@Table(name = "superadminaccesslogs", indexes = {
    @Index(name = "idx_superadminaccesslog_tenant", columnList = "tenant_id"),
    @Index(name = "idx_superadminaccesslog_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SuperAdminAccessLog extends BaseEntity {
