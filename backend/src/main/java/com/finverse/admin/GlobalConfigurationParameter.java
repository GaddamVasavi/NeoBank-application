...
/**
 * Enterprise FinVerse Entity: GlobalConfigurationParameter
 * Specification: Platform-wide rate limits, fee schedules, and maintenance switches
 */
@Entity
@Table(name = "globalconfigurationparameters", indexes = {
    @Index(name = "idx_globalconfigurationparameter_tenant", columnList = "tenant_id"),
    @Index(name = "idx_globalconfigurationparameter_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class GlobalConfigurationParameter extends BaseEntity {
