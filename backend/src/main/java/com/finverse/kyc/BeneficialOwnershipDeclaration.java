...
/**
 * Enterprise FinVerse Entity: BeneficialOwnershipDeclaration
 * Specification: Ultimate Beneficial Owner (UBO 25%+) corporate ownership graph
 */
@Entity
@Table(name = "beneficialownershipdeclarations", indexes = {
    @Index(name = "idx_beneficialownershipdeclaration_tenant", columnList = "tenant_id"),
    @Index(name = "idx_beneficialownershipdeclaration_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BeneficialOwnershipDeclaration extends BaseEntity {
