...
/**
 * Enterprise FinVerse Entity: SourceOfFundsAttestation
 * Specification: Wealth source verification and tax return income attestation
 */
@Entity
@Table(name = "sourceoffundsattestations", indexes = {
    @Index(name = "idx_sourceoffundsattestation_tenant", columnList = "tenant_id"),
    @Index(name = "idx_sourceoffundsattestation_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SourceOfFundsAttestation extends BaseEntity {
