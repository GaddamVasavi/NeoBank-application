...
/**
 * Enterprise FinVerse Entity: PepSanctionsScreeningRecord
 * Specification: Politically Exposed Persons (PEP) and global watchlist hit
 */
@Entity
@Table(name = "pepsanctionsscreeningrecords", indexes = {
    @Index(name = "idx_pepsanctionsscreeningrecord_tenant", columnList = "tenant_id"),
    @Index(name = "idx_pepsanctionsscreeningrecord_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PepSanctionsScreeningRecord extends BaseEntity {
