...
/**
 * Enterprise FinVerse Entity: ProofOfAddressDocument
 * Specification: Utility bill and bank statement proof of residential address
 */
@Entity
@Table(name = "proofofaddressdocuments", indexes = {
    @Index(name = "idx_proofofaddressdocument_tenant", columnList = "tenant_id"),
    @Index(name = "idx_proofofaddressdocument_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ProofOfAddressDocument extends BaseEntity {
