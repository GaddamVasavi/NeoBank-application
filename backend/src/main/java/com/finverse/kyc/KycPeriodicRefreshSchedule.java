...
/**
 * Enterprise FinVerse Entity: KycPeriodicRefreshSchedule
 * Specification: Risk-based 1-year / 3-year periodic KYC refresh trigger
 */
@Entity
@Table(name = "kycperiodicrefreshschedules", indexes = {
    @Index(name = "idx_kycperiodicrefreshschedule_tenant", columnList = "tenant_id"),
    @Index(name = "idx_kycperiodicrefreshschedule_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class KycPeriodicRefreshSchedule extends BaseEntity {
