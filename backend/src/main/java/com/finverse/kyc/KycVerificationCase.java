...
/**
 * Enterprise FinVerse Entity: KycVerificationCase
 * Specification: Customer identity verification dossier and workflow
 */
@Entity
@Table(name = "kycverificationcases", indexes = {
    @Index(name = "idx_kycverificationcase_tenant", columnList = "tenant_id"),
    @Index(name = "idx_kycverificationcase_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class KycVerificationCase extends BaseEntity {
