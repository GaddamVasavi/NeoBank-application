...
/**
 * Enterprise FinVerse Entity: BiometricIdentityMatch
 * Specification: Facial liveness verification and government ID biometric match
 */
@Entity
@Table(name = "biometricidentitymatchs", indexes = {
    @Index(name = "idx_biometricidentitymatch_tenant", columnList = "tenant_id"),
    @Index(name = "idx_biometricidentitymatch_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BiometricIdentityMatch extends BaseEntity {
