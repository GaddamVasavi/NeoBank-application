...
/**
 * Enterprise FinVerse Entity: KycReviewerDecisionLog
 * Specification: Compliance analyst approval, rejection, and manual notes
 */
@Entity
@Table(name = "kycreviewerdecisionlogs", indexes = {
    @Index(name = "idx_kycreviewerdecisionlog_tenant", columnList = "tenant_id"),
    @Index(name = "idx_kycreviewerdecisionlog_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class KycReviewerDecisionLog extends BaseEntity {
