...
/**
 * Enterprise FinVerse Entity: CorporateCardExpenseMatch
 * Specification: Automated matching of corporate card swipes to receipt files
 */
@Entity
@Table(name = "corporatecardexpensematchs", indexes = {
    @Index(name = "idx_corporatecardexpensematch_tenant", columnList = "tenant_id"),
    @Index(name = "idx_corporatecardexpensematch_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorporateCardExpenseMatch extends BaseEntity {
