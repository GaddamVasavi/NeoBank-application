...
/**
 * Enterprise FinVerse Entity: ExpenseReceiptOcrScan
 * Specification: OCR scanned receipt image, merchant, tax, and date extraction
 */
@Entity
@Table(name = "expensereceiptocrscans", indexes = {
    @Index(name = "idx_expensereceiptocrscan_tenant", columnList = "tenant_id"),
    @Index(name = "idx_expensereceiptocrscan_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ExpenseReceiptOcrScan extends BaseEntity {
