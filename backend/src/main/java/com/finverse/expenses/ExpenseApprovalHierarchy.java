...
/**
 * Enterprise FinVerse Entity: ExpenseApprovalHierarchy
 * Specification: Multi-level managerial and finance director approval chain
 */
@Entity
@Table(name = "expenseapprovalhierarchys", indexes = {
    @Index(name = "idx_expenseapprovalhierarchy_tenant", columnList = "tenant_id"),
    @Index(name = "idx_expenseapprovalhierarchy_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ExpenseApprovalHierarchy extends BaseEntity {
