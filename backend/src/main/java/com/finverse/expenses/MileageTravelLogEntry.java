...
/**
 * Enterprise FinVerse Entity: MileageTravelLogEntry
 * Specification: Business travel GPS mileage tracking and reimbursement rate
 */
@Entity
@Table(name = "mileagetravellogentrys", indexes = {
    @Index(name = "idx_mileagetravellogentry_tenant", columnList = "tenant_id"),
    @Index(name = "idx_mileagetravellogentry_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MileageTravelLogEntry extends BaseEntity {
