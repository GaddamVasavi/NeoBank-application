...
/**
 * Enterprise FinVerse Entity: ExpensePolicyViolationAlert
 * Specification: Out-of-policy expense alert (alcohol, luxury, missing receipt)
 */
@Entity
@Table(name = "expensepolicyviolationalerts", indexes = {
    @Index(name = "idx_expensepolicyviolationalert_tenant", columnList = "tenant_id"),
    @Index(name = "idx_expensepolicyviolationalert_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ExpensePolicyViolationAlert extends BaseEntity {
