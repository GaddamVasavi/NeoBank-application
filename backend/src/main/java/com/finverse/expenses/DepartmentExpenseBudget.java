...
/**
 * Enterprise FinVerse Entity: DepartmentExpenseBudget
 * Specification: Departmental quarterly expense budget and variance tracker
 */
@Entity
@Table(name = "departmentexpensebudgets", indexes = {
    @Index(name = "idx_departmentexpensebudget_tenant", columnList = "tenant_id"),
    @Index(name = "idx_departmentexpensebudget_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DepartmentExpenseBudget extends BaseEntity {
