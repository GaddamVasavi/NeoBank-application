...
/**
 * Enterprise FinVerse Entity: PerDiemAllowanceSchedule
 * Specification: Government standard travel, meals, and lodging per diem rates
 */
@Entity
@Table(name = "perdiemallowanceschedules", indexes = {
    @Index(name = "idx_perdiemallowanceschedule_tenant", columnList = "tenant_id"),
    @Index(name = "idx_perdiemallowanceschedule_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PerDiemAllowanceSchedule extends BaseEntity {
