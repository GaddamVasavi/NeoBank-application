...
/**
 * Enterprise FinVerse Entity: ReimbursementPayoutBatch
 * Specification: Approved employee out-of-pocket expense direct deposit batch
 */
@Entity
@Table(name = "reimbursementpayoutbatchs", indexes = {
    @Index(name = "idx_reimbursementpayoutbatch_tenant", columnList = "tenant_id"),
    @Index(name = "idx_reimbursementpayoutbatch_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ReimbursementPayoutBatch extends BaseEntity {
