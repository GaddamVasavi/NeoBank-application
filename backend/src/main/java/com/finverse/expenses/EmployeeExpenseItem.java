...
/**
 * Enterprise FinVerse Entity: EmployeeExpenseItem
 * Specification: Individual employee corporate expense claim and line items
 */
@Entity
@Table(name = "employeeexpenseitems", indexes = {
    @Index(name = "idx_employeeexpenseitem_tenant", columnList = "tenant_id"),
    @Index(name = "idx_employeeexpenseitem_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EmployeeExpenseItem extends BaseEntity {
