...
/**
 * Enterprise FinVerse Entity: ExpenseCategoryTaxMapping
 * Specification: Corporate chart of accounts and tax deductible category map
 */
@Entity
@Table(name = "expensecategorytaxmappings", indexes = {
    @Index(name = "idx_expensecategorytaxmapping_tenant", columnList = "tenant_id"),
    @Index(name = "idx_expensecategorytaxmapping_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ExpenseCategoryTaxMapping extends BaseEntity {
