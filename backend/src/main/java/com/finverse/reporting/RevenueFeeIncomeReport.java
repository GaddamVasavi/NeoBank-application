...
/**
 * Enterprise FinVerse Entity: RevenueFeeIncomeReport
 * Specification: Interchange, subscription, and transaction fee revenue report
 */
@Entity
@Table(name = "revenuefeeincomereports", indexes = {
    @Index(name = "idx_revenuefeeincomereport_tenant", columnList = "tenant_id"),
    @Index(name = "idx_revenuefeeincomereport_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RevenueFeeIncomeReport extends BaseEntity {
