...
/**
 * Enterprise FinVerse Entity: TaxWithholdingSummaryReport
 * Specification: Annual 1099-INT, 1099-MISC, and VAT collected tax summary
 */
@Entity
@Table(name = "taxwithholdingsummaryreports", indexes = {
    @Index(name = "idx_taxwithholdingsummaryreport_tenant", columnList = "tenant_id"),
    @Index(name = "idx_taxwithholdingsummaryreport_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TaxWithholdingSummaryReport extends BaseEntity {
