...
/**
 * Enterprise FinVerse Entity: RegulatoryCapitalAdequacyReport
 * Specification: Basel III Standardized Approach Risk-Weighted Asset report
 */
@Entity
@Table(name = "regulatorycapitaladequacyreports", indexes = {
    @Index(name = "idx_regulatorycapitaladequacyreport_tenant", columnList = "tenant_id"),
    @Index(name = "idx_regulatorycapitaladequacyreport_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RegulatoryCapitalAdequacyReport extends BaseEntity {
