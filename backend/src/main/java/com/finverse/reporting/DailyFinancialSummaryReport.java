...
/**
 * Enterprise FinVerse Entity: DailyFinancialSummaryReport
 * Specification: End-of-day multi-tenant balance sheet and P&L statement
 */
@Entity
@Table(name = "dailyfinancialsummaryreports", indexes = {
    @Index(name = "idx_dailyfinancialsummaryreport_tenant", columnList = "tenant_id"),
    @Index(name = "idx_dailyfinancialsummaryreport_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DailyFinancialSummaryReport extends BaseEntity {
