...
/**
 * Enterprise FinVerse Entity: DistributionWaterfallLedger
 * Specification: Hurdle rate, catch-up, and carried interest calculation
 */
@Entity
@Table(name = "distributionwaterfallledgers", indexes = {
    @Index(name = "idx_distributionwaterfallledger_tenant", columnList = "tenant_id"),
    @Index(name = "idx_distributionwaterfallledger_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DistributionWaterfallLedger extends BaseEntity {
