...
/**
 * Enterprise FinVerse Entity: LpCommitmentTrackerMaster
 * Specification: Institutional LP fund commitment and unfunded capital tracker
 */
@Entity
@Table(name = "lpcommitmenttrackermasters", indexes = {
    @Index(name = "idx_lpcommitmenttrackermaster_tenant", columnList = "tenant_id"),
    @Index(name = "idx_lpcommitmenttrackermaster_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LpCommitmentTrackerMaster extends BaseEntity {
