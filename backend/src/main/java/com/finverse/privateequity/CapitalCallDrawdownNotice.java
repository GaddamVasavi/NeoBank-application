...
/**
 * Enterprise FinVerse Entity: CapitalCallDrawdownNotice
 * Specification: Limited partner capital call drawdown notice and receipt
 */
@Entity
@Table(name = "capitalcalldrawdownnotices", indexes = {
    @Index(name = "idx_capitalcalldrawdownnotice_tenant", columnList = "tenant_id"),
    @Index(name = "idx_capitalcalldrawdownnotice_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CapitalCallDrawdownNotice extends BaseEntity {
