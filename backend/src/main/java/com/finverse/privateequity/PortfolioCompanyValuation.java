...
/**
 * Enterprise FinVerse Entity: PortfolioCompanyValuation
 * Specification: EBITDA multiple and discounted cash flow quarterly valuation
 */
@Entity
@Table(name = "portfoliocompanyvaluations", indexes = {
    @Index(name = "idx_portfoliocompanyvaluation_tenant", columnList = "tenant_id"),
    @Index(name = "idx_portfoliocompanyvaluation_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PortfolioCompanyValuation extends BaseEntity {
