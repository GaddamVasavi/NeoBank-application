...
/**
 * Enterprise FinVerse Entity: DividendReinvestmentPlan
 * Specification: Automated cash dividend reinvestment share purchase plan
 */
@Entity
@Table(name = "dividendreinvestmentplans", indexes = {
    @Index(name = "idx_dividendreinvestmentplan_tenant", columnList = "tenant_id"),
    @Index(name = "idx_dividendreinvestmentplan_ref", columnList = "system_reference")
})
