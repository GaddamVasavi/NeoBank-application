...
/**
 * Enterprise FinVerse Entity: SubCustodianNetworkNode
 * Specification: Global sub-custodian clearing link and omnibus settlement node
 */
@Entity
@Table(name = "subcustodiannetworknodes", indexes = {
    @Index(name = "idx_subcustodiannetworknode_tenant", columnList = "tenant_id"),
    @Index(name = "idx_subcustodiannetworknode_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SubCustodianNetworkNode extends BaseEntity {
