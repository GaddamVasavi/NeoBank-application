...
/**
 * Enterprise FinVerse Entity: CorporateActionProxyVote
 * Specification: Annual shareholder meeting proxy voting instruction log
 */
@Entity
@Table(name = "corporateactionproxyvotes", indexes = {
    @Index(name = "idx_corporateactionproxyvote_tenant", columnList = "tenant_id"),
    @Index(name = "idx_corporateactionproxyvote_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorporateActionProxyVote extends BaseEntity {
