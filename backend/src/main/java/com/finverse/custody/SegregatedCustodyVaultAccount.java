...
/**
 * Enterprise FinVerse Entity: SegregatedCustodyVaultAccount
 * Specification: Qualified institutional investor asset segregation vault
 */
@Entity
@Table(name = "segregatedcustodyvaultaccounts", indexes = {
    @Index(name = "idx_segregatedcustodyvaultaccount_tenant", columnList = "tenant_id"),
    @Index(name = "idx_segregatedcustodyvaultaccount_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SegregatedCustodyVaultAccount extends BaseEntity {
