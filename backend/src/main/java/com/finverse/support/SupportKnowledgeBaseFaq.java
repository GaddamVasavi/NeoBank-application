...
/**
 * Enterprise FinVerse Entity: SupportKnowledgeBaseFaq
 * Specification: Searchable help center and automated deflection FAQ article
 */
@Entity
@Table(name = "supportknowledgebasefaqs", indexes = {
    @Index(name = "idx_supportknowledgebasefaq_tenant", columnList = "tenant_id"),
    @Index(name = "idx_supportknowledgebasefaq_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SupportKnowledgeBaseFaq extends BaseEntity {
