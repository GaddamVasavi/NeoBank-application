...
/**
 * Enterprise FinVerse Entity: SupportTicketMessageThread
 * Specification: Customer and agent timestamped message interaction thread
 */
@Entity
@Table(name = "supportticketmessagethreads", indexes = {
    @Index(name = "idx_supportticketmessagethread_tenant", columnList = "tenant_id"),
    @Index(name = "idx_supportticketmessagethread_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SupportTicketMessageThread extends BaseEntity {
