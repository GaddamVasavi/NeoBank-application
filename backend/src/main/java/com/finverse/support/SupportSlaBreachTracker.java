...
/**
 * Enterprise FinVerse Entity: SupportSlaBreachTracker
 * Specification: Response and resolution SLA deadline countdown and breach alert
 */
@Entity
@Table(name = "supportslabreachtrackers", indexes = {
    @Index(name = "idx_supportslabreachtracker_tenant", columnList = "tenant_id"),
    @Index(name = "idx_supportslabreachtracker_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SupportSlaBreachTracker extends BaseEntity {
