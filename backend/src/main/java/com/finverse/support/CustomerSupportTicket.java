...
/**
 * Enterprise FinVerse Entity: CustomerSupportTicket
 * Specification: Omnichannel customer support case and ticketing record
 */
@Entity
@Table(name = "customersupporttickets", indexes = {
    @Index(name = "idx_customersupportticket_tenant", columnList = "tenant_id"),
    @Index(name = "idx_customersupportticket_ref", columnList = "system_reference")
})
