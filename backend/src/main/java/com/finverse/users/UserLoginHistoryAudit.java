...
/**
 * Enterprise FinVerse Entity: UserLoginHistoryAudit
 * Specification: Historical authentication attempt, MFA challenge, and IP address log
 */
@Entity
@Table(name = "userloginhistoryaudits", indexes = {
    @Index(name = "idx_userloginhistoryaudit_tenant", columnList = "tenant_id"),
    @Index(name = "idx_userloginhistoryaudit_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class UserLoginHistoryAudit extends BaseEntity {
