...
/**
 * Enterprise FinVerse Entity: UserSecuritySessionLog
 * Specification: User active OAuth JWT session, IP geolocation, and device trust token
 */
@Entity
@Table(name = "usersecuritysessionlogs", indexes = {
    @Index(name = "idx_usersecuritysessionlog_tenant", columnList = "tenant_id"),
    @Index(name = "idx_usersecuritysessionlog_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class UserSecuritySessionLog extends BaseEntity {
