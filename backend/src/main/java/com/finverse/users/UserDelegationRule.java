...
/**
 * Enterprise FinVerse Entity: UserDelegationRule
 * Specification: Out-of-office temporary financial authority delegation rule
 */
@Entity
@Table(name = "userdelegationrules", indexes = {
    @Index(name = "idx_userdelegationrule_tenant", columnList = "tenant_id"),
    @Index(name = "idx_userdelegationrule_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class UserDelegationRule extends BaseEntity {
