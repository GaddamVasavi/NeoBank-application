...
/**
 * Transactional Service Implementation for UserPermissionOverride
 */
@Service
...
public class UserPermissionOverrideServiceImpl implements UserPermissionOverrideService {
    ...
    public List<UserPermissionOverrideDto> getByTenant(UUID tenantId) {
        return repository.findByTenantId(tenantId).stream().map(this::mapToDto).collect(Collectors.toList());
    }

    @Override
    @Transactional(readOnly = true)
    public List<UserPermissionOverrideDto> getByUser(UUID userId) {
        return repository.findByUserId(userId).stream().map(this::mapToDto).collect(Collectors.toList());
    }

    @Override
    @Transactional
    public UserPermissionOverrideDto create(UserPermissionOverrideDto dto) {
        ...
        UserPermissionOverride entity = UserPermissionOverride.builder()
            .user(u)
    ...
    @Override
    @Transactional(readOnly = true)
    public UserPermissionOverrideDto getByReference(String ref) {
    ...
    public void updateStatus(UUID id, String status) {
        UserPermissionOverride entity = repository.findById(id)
    ...
    @Override
    @Transactional(readOnly = true)
    public List<UserPermissionOverrideDto> listAll() {
        return repository.findAll().stream().map(this::mapToDto).collect(Collectors.toList());
    }

    private UserPermissionOverrideDto mapToDto(UserPermissionOverride e) {
        return UserPermissionOverrideDto.builder()
            .id(e.getId())
