...
/**
 * Enterprise FinVerse Entity: UserRoleAssignment
 * Specification: Multi-tenant granular RBAC role-to-user binding entity
 */
@Entity
@Table(name = "userroleassignments", indexes = {
    @Index(name = "idx_userroleassignment_tenant", columnList = "tenant_id"),
    @Index(name = "idx_userroleassignment_ref", columnList = "system_reference")
})
