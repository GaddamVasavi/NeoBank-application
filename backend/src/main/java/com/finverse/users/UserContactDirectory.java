...
/**
 * Enterprise FinVerse Entity: UserContactDirectory
 * Specification: Corporate employee communication channels and emergency phone
 */
@Entity
@Table(name = "usercontactdirectorys", indexes = {
    @Index(name = "idx_usercontactdirectory_tenant", columnList = "tenant_id"),
    @Index(name = "idx_usercontactdirectory_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class UserContactDirectory extends BaseEntity {
