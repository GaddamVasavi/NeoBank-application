...
/**
 * Transactional Service Implementation for UserRoleAssignment
 */
@Service
...
public class UserRoleAssignmentServiceImpl implements UserRoleAssignmentService {
    ...
    @Override
    @Transactional(readOnly = true)
    public UserRoleAssignmentDto getByReference(String ref) {
    ...
    public void updateStatus(UUID id, String status) {
        UserRoleAssignment entity = repository.findById(id)
    ...
    @Override
    @Transactional(readOnly = true)
    public List<UserRoleAssignmentDto> listAll() {
        return repository.findAll().stream().map(this::mapToDto).collect(Collectors.toList());
    }

    private UserRoleAssignmentDto mapToDto(UserRoleAssignment e) {
