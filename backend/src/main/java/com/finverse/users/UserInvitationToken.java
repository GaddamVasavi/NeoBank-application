...
/**
 * Enterprise FinVerse Entity: UserInvitationToken
 * Specification: Expiring corporate employee invite and role pre-assignment token
 */
@Entity
@Table(name = "userinvitationtokens", indexes = {
    @Index(name = "idx_userinvitationtoken_tenant", columnList = "tenant_id"),
    @Index(name = "idx_userinvitationtoken_ref", columnList = "system_reference")
})
