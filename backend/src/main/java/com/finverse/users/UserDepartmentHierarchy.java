...
/**
 * Enterprise FinVerse Entity: UserDepartmentHierarchy
 * Specification: Corporate department hierarchy and departmental budgeting group
 */
@Entity
@Table(name = "userdepartmenthierarchys", indexes = {
    @Index(name = "idx_userdepartmenthierarchy_tenant", columnList = "tenant_id"),
    @Index(name = "idx_userdepartmenthierarchy_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class UserDepartmentHierarchy extends BaseEntity {
