...
/**
 * Enterprise FinVerse Entity: UserPermissionOverride
 * Specification: Exceptional explicit resource permission grant and revocation
 */
@Entity
@Table(name = "userpermissionoverrides", indexes = {
    @Index(name = "idx_userpermissionoverride_tenant", columnList = "tenant_id"),
    @Index(name = "idx_userpermissionoverride_ref", columnList = "system_reference")
})
