...
/**
 * Enterprise FinVerse Entity: DeviceTakeoverDetectionRule
 * Specification: New device + password change + instant transfer heuristic
 */
@Entity
@Table(name = "devicetakeoverdetectionrules", indexes = {
    @Index(name = "idx_devicetakeoverdetectionrule_tenant", columnList = "tenant_id"),
    @Index(name = "idx_devicetakeoverdetectionrule_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DeviceTakeoverDetectionRule extends BaseEntity {
