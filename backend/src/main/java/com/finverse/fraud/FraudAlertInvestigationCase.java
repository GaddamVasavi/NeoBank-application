...
/**
 * Enterprise FinVerse Entity: FraudAlertInvestigationCase
 * Specification: Tier-1 and Tier-2 fraud triage investigation and disposition
 */
@Entity
@Table(name = "fraudalertinvestigationcases", indexes = {
    @Index(name = "idx_fraudalertinvestigationcase_tenant", columnList = "tenant_id"),
    @Index(name = "idx_fraudalertinvestigationcase_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FraudAlertInvestigationCase extends BaseEntity {
