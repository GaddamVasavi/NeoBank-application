...
/**
 * Enterprise FinVerse Entity: CardTestingVelocityRule
 * Specification: Multiple micro-transaction card brute-force testing detection
 */
@Entity
@Table(name = "cardtestingvelocityrules", indexes = {
    @Index(name = "idx_cardtestingvelocityrule_tenant", columnList = "tenant_id"),
    @Index(name = "idx_cardtestingvelocityrule_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CardTestingVelocityRule extends BaseEntity {
