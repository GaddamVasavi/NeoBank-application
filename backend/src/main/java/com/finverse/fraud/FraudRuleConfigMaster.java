...
/**
 * Enterprise FinVerse Entity: FraudRuleConfigMaster
 * Specification: Dynamic rule configuration with threshold weights and actions
 */
@Entity
@Table(name = "fraudruleconfigmasters", indexes = {
    @Index(name = "idx_fraudruleconfigmaster_tenant", columnList = "tenant_id"),
    @Index(name = "idx_fraudruleconfigmaster_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FraudRuleConfigMaster extends BaseEntity {
