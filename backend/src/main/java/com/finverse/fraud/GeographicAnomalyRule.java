...
/**
 * Enterprise FinVerse Entity: GeographicAnomalyRule
 * Specification: Impossible travel velocity and cross-border IP anomaly rule
 */
@Entity
@Table(name = "geographicanomalyrules", indexes = {
    @Index(name = "idx_geographicanomalyrule_tenant", columnList = "tenant_id"),
    @Index(name = "idx_geographicanomalyrule_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class GeographicAnomalyRule extends BaseEntity {
