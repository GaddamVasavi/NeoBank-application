...
/**
 * Enterprise FinVerse Entity: MuleAccountBehaviorModel
 * Specification: Rapid pass-through funds aggregation and mule account model
 */
@Entity
@Table(name = "muleaccountbehaviormodels", indexes = {
    @Index(name = "idx_muleaccountbehaviormodel_tenant", columnList = "tenant_id"),
    @Index(name = "idx_muleaccountbehaviormodel_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MuleAccountBehaviorModel extends BaseEntity {
