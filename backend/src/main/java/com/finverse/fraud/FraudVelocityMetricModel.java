...
/**
 * Enterprise FinVerse Entity: FraudVelocityMetricModel
 * Specification: Real-time payment frequency and volume acceleration metric
 */
@Entity
@Table(name = "fraudvelocitymetricmodels", indexes = {
    @Index(name = "idx_fraudvelocitymetricmodel_tenant", columnList = "tenant_id"),
    @Index(name = "idx_fraudvelocitymetricmodel_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FraudVelocityMetricModel extends BaseEntity {
