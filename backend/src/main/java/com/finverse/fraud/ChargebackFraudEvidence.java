...
/**
 * Enterprise FinVerse Entity: ChargebackFraudEvidence
 * Specification: Representment evidence bundle for Visa/Mastercard disputes
 */
@Entity
@Table(name = "chargebackfraudevidences", indexes = {
    @Index(name = "idx_chargebackfraudevidence_tenant", columnList = "tenant_id"),
    @Index(name = "idx_chargebackfraudevidence_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ChargebackFraudEvidence extends BaseEntity {
