...
/**
 * Enterprise FinVerse Entity: ProrationAdjustmentLog
 * Specification: Mid-cycle plan upgrade and downgrade proration calculation
 */
@Entity
@Table(name = "prorationadjustmentlogs", indexes = {
    @Index(name = "idx_prorationadjustmentlog_tenant", columnList = "tenant_id"),
    @Index(name = "idx_prorationadjustmentlog_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ProrationAdjustmentLog extends BaseEntity {
