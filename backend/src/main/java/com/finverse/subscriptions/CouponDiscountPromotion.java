...
/**
 * Enterprise FinVerse Entity: CouponDiscountPromotion
 * Specification: Percentage and fixed amount promotional coupon campaign
 */
@Entity
@Table(name = "coupondiscountpromotions", indexes = {
    @Index(name = "idx_coupondiscountpromotion_tenant", columnList = "tenant_id"),
    @Index(name = "idx_coupondiscountpromotion_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CouponDiscountPromotion extends BaseEntity {
