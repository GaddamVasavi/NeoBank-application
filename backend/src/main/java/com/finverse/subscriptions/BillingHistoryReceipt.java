...
/**
 * Enterprise FinVerse Entity: BillingHistoryReceipt
 * Specification: Historical subscription charge invoice and tax receipt
 */
@Entity
@Table(name = "billinghistoryreceipts", indexes = {
    @Index(name = "idx_billinghistoryreceipt_tenant", columnList = "tenant_id"),
    @Index(name = "idx_billinghistoryreceipt_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BillingHistoryReceipt extends BaseEntity {
