...
/**
 * Enterprise FinVerse Entity: SaaSSubscriptionContract
 * Specification: Multi-tenant recurring SaaS subscription contract instance
 */
@Entity
@Table(name = "saassubscriptioncontracts", indexes = {
    @Index(name = "idx_saassubscriptioncontract_tenant", columnList = "tenant_id"),
    @Index(name = "idx_saassubscriptioncontract_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SaaSSubscriptionContract extends BaseEntity {
