...
/**
 * Enterprise FinVerse Entity: SubscriptionDunningRetry
 * Specification: Smart payment retry logic (dunning) for failed recurring cards
 */
@Entity
@Table(name = "subscriptiondunningretrys", indexes = {
    @Index(name = "idx_subscriptiondunningretry_tenant", columnList = "tenant_id"),
    @Index(name = "idx_subscriptiondunningretry_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SubscriptionDunningRetry extends BaseEntity {
