...
/**
 * Enterprise FinVerse Entity: UsageMeteredBillingRecord
 * Specification: High-throughput API usage metering and overage calculation
 */
@Entity
@Table(name = "usagemeteredbillingrecords", indexes = {
    @Index(name = "idx_usagemeteredbillingrecord_tenant", columnList = "tenant_id"),
    @Index(name = "idx_usagemeteredbillingrecord_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class UsageMeteredBillingRecord extends BaseEntity {
