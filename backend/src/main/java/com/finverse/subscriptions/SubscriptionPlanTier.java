...
/**
 * Enterprise FinVerse Entity: SubscriptionPlanTier
 * Specification: Feature matrix, API call limits, and seats pricing tier
 */
@Entity
@Table(name = "subscriptionplantiers", indexes = {
    @Index(name = "idx_subscriptionplantier_tenant", columnList = "tenant_id"),
    @Index(name = "idx_subscriptionplantier_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SubscriptionPlanTier extends BaseEntity {
