...
/**
 * Enterprise FinVerse Entity: SubscriptionRenewalSchedule
 * Specification: Automated monthly/annual recurring renewal and charge cycle
 */
@Entity
@Table(name = "subscriptionrenewalschedules", indexes = {
    @Index(name = "idx_subscriptionrenewalschedule_tenant", columnList = "tenant_id"),
    @Index(name = "idx_subscriptionrenewalschedule_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SubscriptionRenewalSchedule extends BaseEntity {
