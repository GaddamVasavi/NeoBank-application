...
/**
 * Enterprise FinVerse Entity: ChurnAnalyticsRecord
 * Specification: Customer subscription cancellation reason and cohort churn metric
 */
@Entity
@Table(name = "churnanalyticsrecords", indexes = {
    @Index(name = "idx_churnanalyticsrecord_tenant", columnList = "tenant_id"),
    @Index(name = "idx_churnanalyticsrecord_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ChurnAnalyticsRecord extends BaseEntity {
