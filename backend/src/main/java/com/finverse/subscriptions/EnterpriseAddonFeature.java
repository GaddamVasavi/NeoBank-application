...
/**
 * Enterprise FinVerse Entity: EnterpriseAddonFeature
 * Specification: Dedicated support, SSO, and audit compliance add-on module
 */
@Entity
@Table(name = "enterpriseaddonfeatures", indexes = {
    @Index(name = "idx_enterpriseaddonfeature_tenant", columnList = "tenant_id"),
    @Index(name = "idx_enterpriseaddonfeature_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EnterpriseAddonFeature extends BaseEntity {
