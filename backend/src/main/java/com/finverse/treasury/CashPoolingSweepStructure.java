...
/**
 * Enterprise FinVerse Entity: CashPoolingSweepStructure
 * Specification: Multi-entity zero-balance cash concentration pool structure
 */
@Entity
@Table(name = "cashpoolingsweepstructures", indexes = {
    @Index(name = "idx_cashpoolingsweepstructure_tenant", columnList = "tenant_id"),
    @Index(name = "idx_cashpoolingsweepstructure_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CashPoolingSweepStructure extends BaseEntity {
