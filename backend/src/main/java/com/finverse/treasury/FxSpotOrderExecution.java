...
/**
 * Enterprise FinVerse Entity: FxSpotOrderExecution
 * Specification: Institutional multi-currency spot foreign exchange execution slip
 */
@Entity
@Table(name = "fxspotorderexecutions", indexes = {
    @Index(name = "idx_fxspotorderexecution_tenant", columnList = "tenant_id"),
    @Index(name = "idx_fxspotorderexecution_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FxSpotOrderExecution extends BaseEntity {
