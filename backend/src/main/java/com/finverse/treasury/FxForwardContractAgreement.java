...
/**
 * Enterprise FinVerse Entity: FxForwardContractAgreement
 * Specification: Custom maturity deliverable currency forward hedge agreement
 */
@Entity
@Table(name = "fxforwardcontractagreements", indexes = {
    @Index(name = "idx_fxforwardcontractagreement_tenant", columnList = "tenant_id"),
    @Index(name = "idx_fxforwardcontractagreement_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FxForwardContractAgreement extends BaseEntity {
