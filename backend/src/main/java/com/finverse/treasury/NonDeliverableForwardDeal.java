...
/**
 * Enterprise FinVerse Entity: NonDeliverableForwardDeal
 * Specification: Emerging market non-deliverable forward (NDF) cash settlement
 */
@Entity
@Table(name = "nondeliverableforwarddeals", indexes = {
    @Index(name = "idx_nondeliverableforwarddeal_tenant", columnList = "tenant_id"),
    @Index(name = "idx_nondeliverableforwarddeal_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class NonDeliverableForwardDeal extends BaseEntity {
