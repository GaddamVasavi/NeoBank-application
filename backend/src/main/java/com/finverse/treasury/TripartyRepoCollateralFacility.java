...
/**
 * Enterprise FinVerse Entity: TripartyRepoCollateralFacility
 * Specification: Euroclear / Clearstream triparty collateral margin facility
 */
@Entity
@Table(name = "tripartyrepocollateralfacilitys", indexes = {
    @Index(name = "idx_tripartyrepocollateralfacility_tenant", columnList = "tenant_id"),
    @Index(name = "idx_tripartyrepocollateralfacility_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TripartyRepoCollateralFacility extends BaseEntity {
