...
/**
 * Enterprise FinVerse Entity: InterestRateSwapContract
 * Specification: Fixed-for-floating SOFR benchmark interest rate swap deal
 */
@Entity
@Table(name = "interestrateswapcontracts", indexes = {
    @Index(name = "idx_interestrateswapcontract_tenant", columnList = "tenant_id"),
    @Index(name = "idx_interestrateswapcontract_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InterestRateSwapContract extends BaseEntity {
