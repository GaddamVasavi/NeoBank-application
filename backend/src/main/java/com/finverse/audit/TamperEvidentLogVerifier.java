...
/**
 * Enterprise FinVerse Entity: TamperEvidentLogVerifier
 * Specification: Continuous audit stream checksum and tampering verification
 */
@Entity
@Table(name = "tamperevidentlogverifiers", indexes = {
    @Index(name = "idx_tamperevidentlogverifier_tenant", columnList = "tenant_id"),
    @Index(name = "idx_tamperevidentlogverifier_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TamperEvidentLogVerifier extends BaseEntity {
