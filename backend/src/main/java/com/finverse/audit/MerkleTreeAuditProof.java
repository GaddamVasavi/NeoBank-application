...
/**
 * Enterprise FinVerse Entity: MerkleTreeAuditProof
 * Specification: Mathematical Merkle tree root hash proof of log integrity
 */
@Entity
@Table(name = "merkletreeauditproofs", indexes = {
    @Index(name = "idx_merkletreeauditproof_tenant", columnList = "tenant_id"),
    @Index(name = "idx_merkletreeauditproof_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MerkleTreeAuditProof extends BaseEntity {
