...
/**
 * Enterprise FinVerse Entity: RegulatoryInspectorSession
 * Specification: External bank examiner read-only access and export session
 */
@Entity
@Table(name = "regulatoryinspectorsessions", indexes = {
    @Index(name = "idx_regulatoryinspectorsession_tenant", columnList = "tenant_id"),
    @Index(name = "idx_regulatoryinspectorsession_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RegulatoryInspectorSession extends BaseEntity {
