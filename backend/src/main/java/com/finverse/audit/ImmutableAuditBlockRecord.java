...
/**
 * Enterprise FinVerse Entity: ImmutableAuditBlockRecord
 * Specification: WORM storage cryptographic SHA-256 HMAC audit log block
 */
@Entity
@Table(name = "immutableauditblockrecords", indexes = {
    @Index(name = "idx_immutableauditblockrecord_tenant", columnList = "tenant_id"),
    @Index(name = "idx_immutableauditblockrecord_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ImmutableAuditBlockRecord extends BaseEntity {
