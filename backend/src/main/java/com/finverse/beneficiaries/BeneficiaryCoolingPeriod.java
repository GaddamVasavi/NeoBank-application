...
/**
 * Enterprise FinVerse Entity: BeneficiaryCoolingPeriod
 * Specification: New payee 24-hour cooling off period and velocity throttle
 */
@Entity
@Table(name = "beneficiarycoolingperiods", indexes = {
    @Index(name = "idx_beneficiarycoolingperiod_tenant", columnList = "tenant_id"),
    @Index(name = "idx_beneficiarycoolingperiod_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BeneficiaryCoolingPeriod extends BaseEntity {
