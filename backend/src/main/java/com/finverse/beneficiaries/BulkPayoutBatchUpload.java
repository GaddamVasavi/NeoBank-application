...
/**
 * Enterprise FinVerse Entity: BulkPayoutBatchUpload
 * Specification: Multi-row CSV/Excel payroll and vendor batch payout sheet
 */
@Entity
@Table(name = "bulkpayoutbatchuploads", indexes = {
    @Index(name = "idx_bulkpayoutbatchupload_tenant", columnList = "tenant_id"),
    @Index(name = "idx_bulkpayoutbatchupload_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BulkPayoutBatchUpload extends BaseEntity {
