...
/**
 * Enterprise FinVerse Entity: IbanValidationRegistry
 * Specification: ISO 13616 IBAN format and BIC routing code validation
 */
@Entity
@Table(name = "ibanvalidationregistrys", indexes = {
    @Index(name = "idx_ibanvalidationregistry_tenant", columnList = "tenant_id"),
    @Index(name = "idx_ibanvalidationregistry_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class IbanValidationRegistry extends BaseEntity {
