...
/**
 * Enterprise FinVerse Entity: TrustedBeneficiaryProfile
 * Specification: Whitelisted corporate beneficiary and vendor payout profile
 */
@Entity
@Table(name = "trustedbeneficiaryprofiles", indexes = {
    @Index(name = "idx_trustedbeneficiaryprofile_tenant", columnList = "tenant_id"),
    @Index(name = "idx_trustedbeneficiaryprofile_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TrustedBeneficiaryProfile extends BaseEntity {
