...
/**
 * Enterprise FinVerse Entity: CreditRiskMigrationMatrix
 * Specification: Moody's / S&P grade transition and default probability model
 */
@Entity
@Table(name = "creditriskmigrationmatrixs", indexes = {
    @Index(name = "idx_creditriskmigrationmatrix_tenant", columnList = "tenant_id"),
    @Index(name = "idx_creditriskmigrationmatrix_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CreditRiskMigrationMatrix extends BaseEntity {
