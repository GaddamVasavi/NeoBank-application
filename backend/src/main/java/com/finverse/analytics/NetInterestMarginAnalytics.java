...
/**
 * Enterprise FinVerse Entity: NetInterestMarginAnalytics
 * Specification: Treasury yield curve, funding cost, and NIM spread tracker
 */
@Entity
@Table(name = "netinterestmarginanalyticss", indexes = {
    @Index(name = "idx_netinterestmarginanalytics_tenant", columnList = "tenant_id"),
    @Index(name = "idx_netinterestmarginanalytics_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class NetInterestMarginAnalytics extends BaseEntity {
