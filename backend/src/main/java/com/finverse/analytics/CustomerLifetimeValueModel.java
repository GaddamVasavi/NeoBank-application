...
/**
 * Enterprise FinVerse Entity: CustomerLifetimeValueModel
 * Specification: Cohort-based customer profitability and unit economics
 */
@Entity
@Table(name = "customerlifetimevaluemodels", indexes = {
    @Index(name = "idx_customerlifetimevaluemodel_tenant", columnList = "tenant_id"),
    @Index(name = "idx_customerlifetimevaluemodel_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CustomerLifetimeValueModel extends BaseEntity {
