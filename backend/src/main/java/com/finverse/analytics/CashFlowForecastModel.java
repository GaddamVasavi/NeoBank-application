...
/**
 * Enterprise FinVerse Entity: CashFlowForecastModel
 * Specification: ARIMA statistical 30-day corporate cash flow forecasting
 */
@Entity
@Table(name = "cashflowforecastmodels", indexes = {
    @Index(name = "idx_cashflowforecastmodel_tenant", columnList = "tenant_id"),
    @Index(name = "idx_cashflowforecastmodel_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CashFlowForecastModel extends BaseEntity {
