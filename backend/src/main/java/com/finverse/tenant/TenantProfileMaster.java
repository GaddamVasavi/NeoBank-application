...
/**
 * Enterprise FinVerse Entity: TenantProfileMaster
 * Specification: Tenant corporate organization profile and multi-tenant isolation configuration
 */
@Entity
@Table(name = "tenantprofilemasters", indexes = {
    @Index(name = "idx_tenantprofilemaster_tenant", columnList = "tenant_id"),
    @Index(name = "idx_tenantprofilemaster_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TenantProfileMaster extends BaseEntity {
