...
/**
 * Enterprise FinVerse Entity: TenantCustomBranding
 * Specification: White-label portal theme colors, logo assets, and email styling
 */
@Entity
@Table(name = "tenantcustombrandings", indexes = {
    @Index(name = "idx_tenantcustombranding_tenant", columnList = "tenant_id"),
    @Index(name = "idx_tenantcustombranding_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TenantCustomBranding extends BaseEntity {
