...
/**
 * Enterprise FinVerse Entity: TenantDomainMapping
 * Specification: Custom corporate CNAME and white-label custom domain mapping
 */
@Entity
@Table(name = "tenantdomainmappings", indexes = {
    @Index(name = "idx_tenantdomainmapping_tenant", columnList = "tenant_id"),
    @Index(name = "idx_tenantdomainmapping_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TenantDomainMapping extends BaseEntity {
