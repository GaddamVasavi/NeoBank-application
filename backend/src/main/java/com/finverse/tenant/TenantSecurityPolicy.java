...
/**
 * Enterprise FinVerse Entity: TenantSecurityPolicy
 * Specification: Tenant-specific password complexity and session lifetime rule
 */
@Entity
@Table(name = "tenantsecuritypolicys", indexes = {
    @Index(name = "idx_tenantsecuritypolicy_tenant", columnList = "tenant_id"),
    @Index(name = "idx_tenantsecuritypolicy_ref", columnList = "system_reference")
})
