...
/**
 * Enterprise FinVerse Entity: TenantBillingAddress
 * Specification: Statutory tax identification and corporate invoicing billing address
 */
@Entity
@Table(name = "tenantbillingaddresss", indexes = {
    @Index(name = "idx_tenantbillingaddress_tenant", columnList = "tenant_id"),
    @Index(name = "idx_tenantbillingaddress_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TenantBillingAddress extends BaseEntity {
