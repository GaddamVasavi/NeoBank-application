...
/**
 * Enterprise FinVerse Entity: TenantAuditTrailConfig
 * Specification: Immutable compliance audit log destination and WORM retention policy
 */
@Entity
@Table(name = "tenantaudittrailconfigs", indexes = {
    @Index(name = "idx_tenantaudittrailconfig_tenant", columnList = "tenant_id"),
    @Index(name = "idx_tenantaudittrailconfig_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TenantAuditTrailConfig extends BaseEntity {
