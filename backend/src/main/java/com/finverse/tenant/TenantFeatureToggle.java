...
/**
 * Enterprise FinVerse Entity: TenantFeatureToggle
 * Specification: Dynamic feature flag gatekeeper and experimental pilot feature switch
 */
@Entity
@Table(name = "tenantfeaturetoggles", indexes = {
    @Index(name = "idx_tenantfeaturetoggle_tenant", columnList = "tenant_id"),
    @Index(name = "idx_tenantfeaturetoggle_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TenantFeatureToggle extends BaseEntity {
