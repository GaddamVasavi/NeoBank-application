...
/**
 * Enterprise FinVerse Entity: CurrencyTransactionReportCtr
 * Specification: Threshold cash transaction report ($10K+) automated filing
 */
@Entity
@Table(name = "currencytransactionreportctrs", indexes = {
    @Index(name = "idx_currencytransactionreportctr_tenant", columnList = "tenant_id"),
    @Index(name = "idx_currencytransactionreportctr_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CurrencyTransactionReportCtr extends BaseEntity {
