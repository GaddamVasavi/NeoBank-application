...
/**
 * Enterprise FinVerse Entity: TradeSanctionsVesselCheck
 * Specification: Maritime vessel and aircraft cargo trade sanctions screening
 */
@Entity
@Table(name = "tradesanctionsvesselchecks", indexes = {
    @Index(name = "idx_tradesanctionsvesselcheck_tenant", columnList = "tenant_id"),
    @Index(name = "idx_tradesanctionsvesselcheck_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TradeSanctionsVesselCheck extends BaseEntity {
