...
/**
 * Enterprise FinVerse Entity: GdprDataErasureRequest
 * Specification: Article 17 Right to Erasure data redaction and audit exception
 */
@Entity
@Table(name = "gdprdataerasurerequests", indexes = {
    @Index(name = "idx_gdprdataerasurerequest_tenant", columnList = "tenant_id"),
    @Index(name = "idx_gdprdataerasurerequest_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class GdprDataErasureRequest extends BaseEntity {
