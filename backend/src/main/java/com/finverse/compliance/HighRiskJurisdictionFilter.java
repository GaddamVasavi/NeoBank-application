...
/**
 * Enterprise FinVerse Entity: HighRiskJurisdictionFilter
 * Specification: FATF grey/black listed jurisdiction payment blocking rule
 */
@Entity
@Table(name = "highriskjurisdictionfilters", indexes = {
    @Index(name = "idx_highriskjurisdictionfilter_tenant", columnList = "tenant_id"),
    @Index(name = "idx_highriskjurisdictionfilter_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class HighRiskJurisdictionFilter extends BaseEntity {
