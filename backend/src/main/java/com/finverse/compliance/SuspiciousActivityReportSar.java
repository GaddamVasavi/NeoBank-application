...
/**
 * Enterprise FinVerse Entity: SuspiciousActivityReportSar
 * Specification: FinCEN Form 111 / FIU Suspicious Activity Report filing
 */
@Entity
@Table(name = "suspiciousactivityreportsars", indexes = {
    @Index(name = "idx_suspiciousactivityreportsar_tenant", columnList = "tenant_id"),
    @Index(name = "idx_suspiciousactivityreportsar_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SuspiciousActivityReportSar extends BaseEntity {
