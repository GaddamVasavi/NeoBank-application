...
/**
 * Enterprise FinVerse Entity: FatcaCrsTaxWithholdingFile
 * Specification: FATCA Form W-8BEN/W-9 and CRS common reporting standard data
 */
@Entity
@Table(name = "fatcacrstaxwithholdingfiles", indexes = {
    @Index(name = "idx_fatcacrstaxwithholdingfile_tenant", columnList = "tenant_id"),
    @Index(name = "idx_fatcacrstaxwithholdingfile_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FatcaCrsTaxWithholdingFile extends BaseEntity {
