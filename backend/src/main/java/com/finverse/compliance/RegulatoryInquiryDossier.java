...
/**
 * Enterprise FinVerse Entity: RegulatoryInquiryDossier
 * Specification: Subpoena response and central bank inspection audit package
 */
@Entity
@Table(name = "regulatoryinquirydossiers", indexes = {
    @Index(name = "idx_regulatoryinquirydossier_tenant", columnList = "tenant_id"),
    @Index(name = "idx_regulatoryinquirydossier_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RegulatoryInquiryDossier extends BaseEntity {
