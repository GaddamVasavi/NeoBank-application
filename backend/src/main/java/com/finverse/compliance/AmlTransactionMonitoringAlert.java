...
/**
 * Enterprise FinVerse Entity: AmlTransactionMonitoringAlert
 * Specification: Anti-Money Laundering transaction monitoring alert
 */
@Entity
@Table(name = "amltransactionmonitoringalerts", indexes = {
    @Index(name = "idx_amltransactionmonitoringalert_tenant", columnList = "tenant_id"),
    @Index(name = "idx_amltransactionmonitoringalert_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AmlTransactionMonitoringAlert extends BaseEntity {
