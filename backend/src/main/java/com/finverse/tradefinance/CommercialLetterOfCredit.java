...
/**
 * Enterprise FinVerse Entity: CommercialLetterOfCredit
 * Specification: Irrevocable confirmed commercial letter of credit document
 */
@Entity
@Table(name = "commercialletterofcredits", indexes = {
    @Index(name = "idx_commercialletterofcredit_tenant", columnList = "tenant_id"),
    @Index(name = "idx_commercialletterofcredit_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CommercialLetterOfCredit extends BaseEntity {
