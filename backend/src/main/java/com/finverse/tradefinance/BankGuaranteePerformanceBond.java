...
/**
 * Enterprise FinVerse Entity: BankGuaranteePerformanceBond
 * Specification: Tender and performance guarantee surety bond obligation
 */
@Entity
@Table(name = "bankguaranteeperformancebonds", indexes = {
    @Index(name = "idx_bankguaranteeperformancebond_tenant", columnList = "tenant_id"),
    @Index(name = "idx_bankguaranteeperformancebond_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BankGuaranteePerformanceBond extends BaseEntity {
