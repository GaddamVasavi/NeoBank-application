...
/**
 * Enterprise FinVerse Entity: DocumentaryCollectionDraft
 * Specification: UCP 600 documentary bill of exchange collection draft
 */
@Entity
@Table(name = "documentarycollectiondrafts", indexes = {
    @Index(name = "idx_documentarycollectiondraft_tenant", columnList = "tenant_id"),
    @Index(name = "idx_documentarycollectiondraft_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DocumentaryCollectionDraft extends BaseEntity {
