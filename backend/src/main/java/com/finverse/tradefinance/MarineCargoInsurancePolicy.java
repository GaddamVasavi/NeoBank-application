...
/**
 * Enterprise FinVerse Entity: MarineCargoInsurancePolicy
 * Specification: International maritime freight insurance and claims certificate
 */
@Entity
@Table(name = "marinecargoinsurancepolicys", indexes = {
    @Index(name = "idx_marinecargoinsurancepolicy_tenant", columnList = "tenant_id"),
    @Index(name = "idx_marinecargoinsurancepolicy_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MarineCargoInsurancePolicy extends BaseEntity {
