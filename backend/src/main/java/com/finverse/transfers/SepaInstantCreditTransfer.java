...
/**
 * Enterprise FinVerse Entity: SepaInstantCreditTransfer
 * Specification: Single Euro Payments Area (SEPA) Instant 10-second clearing
 */
@Entity
@Table(name = "sepainstantcredittransfers", indexes = {
    @Index(name = "idx_sepainstantcredittransfer_tenant", columnList = "tenant_id"),
    @Index(name = "idx_sepainstantcredittransfer_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SepaInstantCreditTransfer extends BaseEntity {
