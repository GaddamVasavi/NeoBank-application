...
/**
 * Enterprise FinVerse Entity: AchNachaBatchTransfer
 * Specification: NACHA ACH PPD, CCD, and CTX electronic transfer batch
 */
@Entity
@Table(name = "achnachabatchtransfers", indexes = {
    @Index(name = "idx_achnachabatchtransfer_tenant", columnList = "tenant_id"),
    @Index(name = "idx_achnachabatchtransfer_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AchNachaBatchTransfer extends BaseEntity {
