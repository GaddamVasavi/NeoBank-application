...
/**
 * Enterprise FinVerse Entity: TransferOtpApprovalChallenge
 * Specification: High-value transfer step-up OTP and biometric challenge
 */
@Entity
@Table(name = "transferotpapprovalchallenges", indexes = {
    @Index(name = "idx_transferotpapprovalchallenge_tenant", columnList = "tenant_id"),
    @Index(name = "idx_transferotpapprovalchallenge_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TransferOtpApprovalChallenge extends BaseEntity {
