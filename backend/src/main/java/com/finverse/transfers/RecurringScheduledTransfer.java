...
/**
 * Enterprise FinVerse Entity: RecurringScheduledTransfer
 * Specification: Standing order and recurring calendar-driven funds transfer
 */
@Entity
@Table(name = "recurringscheduledtransfers", indexes = {
    @Index(name = "idx_recurringscheduledtransfer_tenant", columnList = "tenant_id"),
    @Index(name = "idx_recurringscheduledtransfer_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RecurringScheduledTransfer extends BaseEntity {
