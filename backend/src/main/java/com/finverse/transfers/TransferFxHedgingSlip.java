...
/**
 * Enterprise FinVerse Entity: TransferFxHedgingSlip
 * Specification: Embedded foreign exchange forward rate lock and hedging slip
 */
@Entity
@Table(name = "transferfxhedgingslips", indexes = {
    @Index(name = "idx_transferfxhedgingslip_tenant", columnList = "tenant_id"),
    @Index(name = "idx_transferfxhedgingslip_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TransferFxHedgingSlip extends BaseEntity {
