...
/**
 * Enterprise FinVerse Entity: TransferCancellationDispute
 * Specification: Pre-settlement transfer recall and cancellation workflow
 */
@Entity
@Table(name = "transfercancellationdisputes", indexes = {
    @Index(name = "idx_transfercancellationdispute_tenant", columnList = "tenant_id"),
    @Index(name = "idx_transfercancellationdispute_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TransferCancellationDispute extends BaseEntity {
