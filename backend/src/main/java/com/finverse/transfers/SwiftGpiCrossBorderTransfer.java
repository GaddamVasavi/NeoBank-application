...
/**
 * Enterprise FinVerse Entity: SwiftGpiCrossBorderTransfer
 * Specification: SWIFT gpi cross-border international wire transfer tracking
 */
@Entity
@Table(name = "swiftgpicrossbordertransfers", indexes = {
    @Index(name = "idx_swiftgpicrossbordertransfer_tenant", columnList = "tenant_id"),
    @Index(name = "idx_swiftgpicrossbordertransfer_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SwiftGpiCrossBorderTransfer extends BaseEntity {
