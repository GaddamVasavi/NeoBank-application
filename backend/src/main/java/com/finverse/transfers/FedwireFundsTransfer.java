...
/**
 * Enterprise FinVerse Entity: FedwireFundsTransfer
 * Specification: Federal Reserve Fedwire real-time high-value funds transfer
 */
@Entity
@Table(name = "fedwirefundstransfers", indexes = {
    @Index(name = "idx_fedwirefundstransfer_tenant", columnList = "tenant_id"),
    @Index(name = "idx_fedwirefundstransfer_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FedwireFundsTransfer extends BaseEntity {
