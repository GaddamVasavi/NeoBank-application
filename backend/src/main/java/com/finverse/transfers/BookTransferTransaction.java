...
/**
 * Enterprise FinVerse Entity: BookTransferTransaction
 * Specification: Zero-latency internal account-to-account book transfer
 */
@Entity
@Table(name = "booktransfertransactions", indexes = {
    @Index(name = "idx_booktransfertransaction_tenant", columnList = "tenant_id"),
    @Index(name = "idx_booktransfertransaction_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BookTransferTransaction extends BaseEntity {
