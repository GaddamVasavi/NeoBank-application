...
/**
 * Enterprise FinVerse Entity: TransferFeeCalculationLog
 * Specification: Dynamic wire fee, correspondent fee, and FX spread breakdown
 */
@Entity
@Table(name = "transferfeecalculationlogs", indexes = {
    @Index(name = "idx_transferfeecalculationlog_tenant", columnList = "tenant_id"),
    @Index(name = "idx_transferfeecalculationlog_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TransferFeeCalculationLog extends BaseEntity {
