...
/**
 * Enterprise FinVerse Entity: ChartOfAccountsMaster
 * Specification: Hierarchical multi-currency general ledger chart of accounts
 */
@Entity
@Table(name = "chartofaccountsmasters", indexes = {
    @Index(name = "idx_chartofaccountsmaster_tenant", columnList = "tenant_id"),
    @Index(name = "idx_chartofaccountsmaster_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ChartOfAccountsMaster extends BaseEntity {
