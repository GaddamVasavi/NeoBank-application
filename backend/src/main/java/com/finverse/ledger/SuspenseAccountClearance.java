...
/**
 * Enterprise FinVerse Entity: SuspenseAccountClearance
 * Specification: Temporary suspense account booking and destination re-allocation
 */
@Entity
@Table(name = "suspenseaccountclearances", indexes = {
    @Index(name = "idx_suspenseaccountclearance_tenant", columnList = "tenant_id"),
    @Index(name = "idx_suspenseaccountclearance_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SuspenseAccountClearance extends BaseEntity {
