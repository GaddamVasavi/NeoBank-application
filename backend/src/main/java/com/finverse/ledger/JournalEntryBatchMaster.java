...
/**
 * Enterprise FinVerse Entity: JournalEntryBatchMaster
 * Specification: Multi-legged balancing double-entry journal voucher batch
 */
@Entity
@Table(name = "journalentrybatchmasters", indexes = {
    @Index(name = "idx_journalentrybatchmaster_tenant", columnList = "tenant_id"),
    @Index(name = "idx_journalentrybatchmaster_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class JournalEntryBatchMaster extends BaseEntity {
