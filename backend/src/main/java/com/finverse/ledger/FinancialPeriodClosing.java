...
/**
 * Enterprise FinVerse Entity: FinancialPeriodClosing
 * Specification: Monthly and fiscal year-end immutable financial period closing
 */
@Entity
@Table(name = "financialperiodclosings", indexes = {
    @Index(name = "idx_financialperiodclosing_tenant", columnList = "tenant_id"),
    @Index(name = "idx_financialperiodclosing_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FinancialPeriodClosing extends BaseEntity {
