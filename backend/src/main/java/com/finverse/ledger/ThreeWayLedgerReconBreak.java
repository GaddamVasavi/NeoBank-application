...
/**
 * Enterprise FinVerse Entity: ThreeWayLedgerReconBreak
 * Specification: Sub-ledger vs general ledger automated reconciliation match
 */
@Entity
@Table(name = "threewayledgerreconbreaks", indexes = {
    @Index(name = "idx_threewayledgerreconbreak_tenant", columnList = "tenant_id"),
    @Index(name = "idx_threewayledgerreconbreak_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ThreeWayLedgerReconBreak extends BaseEntity {
