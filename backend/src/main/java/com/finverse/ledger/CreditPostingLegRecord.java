...
/**
 * Enterprise FinVerse Entity: CreditPostingLegRecord
 * Specification: Traceable credit posting leg with ledger account balance mutation
 */
@Entity
@Table(name = "creditpostinglegrecords", indexes = {
    @Index(name = "idx_creditpostinglegrecord_tenant", columnList = "tenant_id"),
    @Index(name = "idx_creditpostinglegrecord_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CreditPostingLegRecord extends BaseEntity {
