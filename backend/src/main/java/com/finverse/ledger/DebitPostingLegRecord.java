...
/**
 * Enterprise FinVerse Entity: DebitPostingLegRecord
 * Specification: Traceable debit posting leg with ledger account balance mutation
 */
@Entity
@Table(name = "debitpostinglegrecords", indexes = {
    @Index(name = "idx_debitpostinglegrecord_tenant", columnList = "tenant_id"),
    @Index(name = "idx_debitpostinglegrecord_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DebitPostingLegRecord extends BaseEntity {
