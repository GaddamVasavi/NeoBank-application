...
/**
 * Enterprise FinVerse Entity: IntercompanyElimination
 * Specification: Multi-entity consolidated balance sheet intercompany elimination
 */
@Entity
@Table(name = "intercompanyeliminations", indexes = {
    @Index(name = "idx_intercompanyelimination_tenant", columnList = "tenant_id"),
    @Index(name = "idx_intercompanyelimination_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class IntercompanyElimination extends BaseEntity {
