...
/**
 * Enterprise FinVerse Entity: TrialBalanceSnapshotFile
 * Specification: End-of-day trial balance verification snapshot and checksum
 */
@Entity
@Table(name = "trialbalancesnapshotfiles", indexes = {
    @Index(name = "idx_trialbalancesnapshotfile_tenant", columnList = "tenant_id"),
    @Index(name = "idx_trialbalancesnapshotfile_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TrialBalanceSnapshotFile extends BaseEntity {
