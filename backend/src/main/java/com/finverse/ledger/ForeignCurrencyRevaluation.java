...
/**
 * Enterprise FinVerse Entity: ForeignCurrencyRevaluation
 * Specification: FASB 52 / IAS 21 unrealized FX revaluation journal entry
 */
@Entity
@Table(name = "foreigncurrencyrevaluations", indexes = {
    @Index(name = "idx_foreigncurrencyrevaluation_tenant", columnList = "tenant_id"),
    @Index(name = "idx_foreigncurrencyrevaluation_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ForeignCurrencyRevaluation extends BaseEntity {
