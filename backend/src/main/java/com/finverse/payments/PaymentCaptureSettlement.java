...
/**
 * Enterprise FinVerse Entity: PaymentCaptureSettlement
 * Specification: Batch and real-time payment capture and funds capture
 */
@Entity
@Table(name = "paymentcapturesettlements", indexes = {
    @Index(name = "idx_paymentcapturesettlement_tenant", columnList = "tenant_id"),
    @Index(name = "idx_paymentcapturesettlement_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PaymentCaptureSettlement extends BaseEntity {
