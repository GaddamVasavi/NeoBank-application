...
/**
 * Enterprise FinVerse Entity: PaymentReceiptDossier
 * Specification: Digital tax invoice and customer payment receipt archive
 */
@Entity
@Table(name = "paymentreceiptdossiers", indexes = {
    @Index(name = "idx_paymentreceiptdossier_tenant", columnList = "tenant_id"),
    @Index(name = "idx_paymentreceiptdossier_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PaymentReceiptDossier extends BaseEntity {
