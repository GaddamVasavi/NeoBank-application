...
/**
 * Enterprise FinVerse Entity: MerchantVirtualTerminal
 * Specification: Mail order / telephone order (MOTO) virtual terminal charge
 */
@Entity
@Table(name = "merchantvirtualterminals", indexes = {
    @Index(name = "idx_merchantvirtualterminal_tenant", columnList = "tenant_id"),
    @Index(name = "idx_merchantvirtualterminal_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MerchantVirtualTerminal extends BaseEntity {
