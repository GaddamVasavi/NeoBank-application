...
/**
 * Enterprise FinVerse Entity: PaymentIdempotencyKey
 * Specification: Distributed Redis-backed idempotency key and replay protection
 */
@Entity
@Table(name = "paymentidempotencykeys", indexes = {
    @Index(name = "idx_paymentidempotencykey_tenant", columnList = "tenant_id"),
    @Index(name = "idx_paymentidempotencykey_ref", columnList = "system_reference")
})
