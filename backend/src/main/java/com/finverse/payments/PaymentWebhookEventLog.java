...
/**
 * Enterprise FinVerse Entity: PaymentWebhookEventLog
 * Specification: External merchant webhook notification dispatch and retry queue
 */
@Entity
@Table(name = "paymentwebhookeventlogs", indexes = {
    @Index(name = "idx_paymentwebhookeventlog_tenant", columnList = "tenant_id"),
    @Index(name = "idx_paymentwebhookeventlog_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PaymentWebhookEventLog extends BaseEntity {
