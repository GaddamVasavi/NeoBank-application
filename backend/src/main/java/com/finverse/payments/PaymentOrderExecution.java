...
/**
 * Enterprise FinVerse Entity: PaymentOrderExecution
 * Specification: Multi-rail payment orchestration and state machine lifecycle
 */
@Entity
@Table(name = "paymentorderexecutions", indexes = {
    @Index(name = "idx_paymentorderexecution_tenant", columnList = "tenant_id"),
    @Index(name = "idx_paymentorderexecution_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PaymentOrderExecution extends BaseEntity {
