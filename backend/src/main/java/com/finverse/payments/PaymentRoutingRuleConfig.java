...
/**
 * Enterprise FinVerse Entity: PaymentRoutingRuleConfig
 * Specification: Least-cost routing optimization across payment gateway acquirers
 */
@Entity
@Table(name = "paymentroutingruleconfigs", indexes = {
    @Index(name = "idx_paymentroutingruleconfig_tenant", columnList = "tenant_id"),
    @Index(name = "idx_paymentroutingruleconfig_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PaymentRoutingRuleConfig extends BaseEntity {
