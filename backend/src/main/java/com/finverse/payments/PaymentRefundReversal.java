...
/**
 * Enterprise FinVerse Entity: PaymentRefundReversal
 * Specification: Full and partial transaction refund and ledger chargeback
 */
@Entity
@Table(name = "paymentrefundreversals", indexes = {
    @Index(name = "idx_paymentrefundreversal_tenant", columnList = "tenant_id"),
    @Index(name = "idx_paymentrefundreversal_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PaymentRefundReversal extends BaseEntity {
