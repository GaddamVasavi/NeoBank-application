...
/**
 * Enterprise FinVerse Entity: PaymentAuthorizationHold
 * Specification: Two-step pre-authorization hold and risk reservation
 */
@Entity
@Table(name = "paymentauthorizationholds", indexes = {
    @Index(name = "idx_paymentauthorizationhold_tenant", columnList = "tenant_id"),
    @Index(name = "idx_paymentauthorizationhold_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PaymentAuthorizationHold extends BaseEntity {
