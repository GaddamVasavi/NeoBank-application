...
/**
 * Enterprise FinVerse Entity: PaymentFeeAssessmentLog
 * Specification: Interchange plus and merchant processing fee assessment
 */
@Entity
@Table(name = "paymentfeeassessmentlogs", indexes = {
    @Index(name = "idx_paymentfeeassessmentlog_tenant", columnList = "tenant_id"),
    @Index(name = "idx_paymentfeeassessmentlog_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PaymentFeeAssessmentLog extends BaseEntity {
