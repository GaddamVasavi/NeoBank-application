...
/**
 * Enterprise FinVerse Entity: CardPinSecurityToken
 * Specification: HSM encrypted PIN verification and failed attempts counter
 */
@Entity
@Table(name = "cardpinsecuritytokens", indexes = {
    @Index(name = "idx_cardpinsecuritytoken_tenant", columnList = "tenant_id"),
    @Index(name = "idx_cardpinsecuritytoken_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CardPinSecurityToken extends BaseEntity {
