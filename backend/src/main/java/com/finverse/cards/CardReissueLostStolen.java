...
/**
 * Enterprise FinVerse Entity: CardReissueLostStolen
 * Specification: Instant card freeze, cancellation, and re-issue workflow
 */
@Entity
@Table(name = "cardreissueloststolens", indexes = {
    @Index(name = "idx_cardreissueloststolen_tenant", columnList = "tenant_id"),
    @Index(name = "idx_cardreissueloststolen_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CardReissueLostStolen extends BaseEntity {
