...
/**
 * Enterprise FinVerse Entity: VirtualCardTokenMaster
 * Specification: Tokenized single-use and multi-use corporate virtual card
 */
@Entity
@Table(name = "virtualcardtokenmasters", indexes = {
    @Index(name = "idx_virtualcardtokenmaster_tenant", columnList = "tenant_id"),
    @Index(name = "idx_virtualcardtokenmaster_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class VirtualCardTokenMaster extends BaseEntity {
