...
/**
 * Enterprise FinVerse Entity: CardSpendLimitControls
 * Specification: Per-transaction, daily, and monthly MCC spending limit rule
 */
@Entity
@Table(name = "cardspendlimitcontrolss", indexes = {
    @Index(name = "idx_cardspendlimitcontrols_tenant", columnList = "tenant_id"),
    @Index(name = "idx_cardspendlimitcontrols_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CardSpendLimitControls extends BaseEntity {
