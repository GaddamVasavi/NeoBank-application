...
/**
 * Enterprise FinVerse Entity: CardCashbackRewardsPool
 * Specification: Interchange revenue share and merchant cashback reward accrual
 */
@Entity
@Table(name = "cardcashbackrewardspools", indexes = {
    @Index(name = "idx_cardcashbackrewardspool_tenant", columnList = "tenant_id"),
    @Index(name = "idx_cardcashbackrewardspool_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CardCashbackRewardsPool extends BaseEntity {
