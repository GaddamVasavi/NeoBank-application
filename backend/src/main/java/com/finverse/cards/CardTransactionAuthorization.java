...
/**
 * Enterprise FinVerse Entity: CardTransactionAuthorization
 * Specification: Real-time card network authorization and settlement matching
 */
@Entity
@Table(name = "cardtransactionauthorizations", indexes = {
    @Index(name = "idx_cardtransactionauthorization_tenant", columnList = "tenant_id"),
    @Index(name = "idx_cardtransactionauthorization_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CardTransactionAuthorization extends BaseEntity {
