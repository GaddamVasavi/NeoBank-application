...
/**
 * Enterprise FinVerse Entity: PhysicalCardIssuanceFile
 * Specification: EMV chip and contactless physical card embossing request
 */
@Entity
@Table(name = "physicalcardissuancefiles", indexes = {
    @Index(name = "idx_physicalcardissuancefile_tenant", columnList = "tenant_id"),
    @Index(name = "idx_physicalcardissuancefile_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PhysicalCardIssuanceFile extends BaseEntity {
