...
/**
 * Enterprise FinVerse Entity: CardMonthlyStatementFile
 * Specification: Itemized card transaction monthly billing statement
 */
@Entity
@Table(name = "cardmonthlystatementfiles", indexes = {
    @Index(name = "idx_cardmonthlystatementfile_tenant", columnList = "tenant_id"),
    @Index(name = "idx_cardmonthlystatementfile_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CardMonthlyStatementFile extends BaseEntity {
