...
/**
 * Enterprise FinVerse Entity: CardOnlineToggleState
 * Specification: E-commerce and international transaction toggle switch
 */
@Entity
@Table(name = "cardonlinetogglestates", indexes = {
    @Index(name = "idx_cardonlinetogglestate_tenant", columnList = "tenant_id"),
    @Index(name = "idx_cardonlinetogglestate_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CardOnlineToggleState extends BaseEntity {
