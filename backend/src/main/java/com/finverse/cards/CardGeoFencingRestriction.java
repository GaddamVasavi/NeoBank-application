...
/**
 * Enterprise FinVerse Entity: CardGeoFencingRestriction
 * Specification: Country and geographic coordinate authorization filter
 */
@Entity
@Table(name = "cardgeofencingrestrictions", indexes = {
    @Index(name = "idx_cardgeofencingrestriction_tenant", columnList = "tenant_id"),
    @Index(name = "idx_cardgeofencingrestriction_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CardGeoFencingRestriction extends BaseEntity {
