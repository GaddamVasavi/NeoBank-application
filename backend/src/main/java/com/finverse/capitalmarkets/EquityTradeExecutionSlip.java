...
/**
 * Enterprise FinVerse Entity: EquityTradeExecutionSlip
 * Specification: Electronic exchange stock trade execution and clearing confirmation
 */
@Entity
@Table(name = "equitytradeexecutionslips", indexes = {
    @Index(name = "idx_equitytradeexecutionslip_tenant", columnList = "tenant_id"),
    @Index(name = "idx_equitytradeexecutionslip_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EquityTradeExecutionSlip extends BaseEntity {
