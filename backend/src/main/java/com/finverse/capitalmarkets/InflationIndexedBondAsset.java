...
/**
 * Enterprise FinVerse Entity: InflationIndexedBondAsset
 * Specification: TIPS consumer price index inflation protected bond holding
 */
@Entity
@Table(name = "inflationindexedbondassets", indexes = {
    @Index(name = "idx_inflationindexedbondasset_tenant", columnList = "tenant_id"),
    @Index(name = "idx_inflationindexedbondasset_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InflationIndexedBondAsset extends BaseEntity {
