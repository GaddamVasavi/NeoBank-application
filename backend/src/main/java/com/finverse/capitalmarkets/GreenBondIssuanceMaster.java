...
/**
 * Enterprise FinVerse Entity: GreenBondIssuanceMaster
 * Specification: ESG certified sustainable green bond issuance and impact report
 */
@Entity
@Table(name = "greenbondissuancemasters", indexes = {
    @Index(name = "idx_greenbondissuancemaster_tenant", columnList = "tenant_id"),
    @Index(name = "idx_greenbondissuancemaster_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class GreenBondIssuanceMaster extends BaseEntity {
