...
/**
 * Enterprise FinVerse Entity: MutualFundOrderBookEntry
 * Specification: Open-end mutual fund forward pricing unit subscription order
 */
@Entity
@Table(name = "mutualfundorderbookentrys", indexes = {
    @Index(name = "idx_mutualfundorderbookentry_tenant", columnList = "tenant_id"),
    @Index(name = "idx_mutualfundorderbookentry_ref", columnList = "system_reference")
})
@Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MutualFundOrderBookEntry extends BaseEntity {
