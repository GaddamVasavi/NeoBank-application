...
/**
 * Transactional Service Implementation for InflationIndexedBondAsset
 */
@Service
@RequiredArgsConstructor
public class InflationIndexedBondAssetServiceImpl implements InflationIndexedBondAssetService {
    private final InflationIndexedBondAssetRepository repository;
    private final UserRepository userRepository;

    @Override
    @Transactional(readOnly = true)
    public List<InflationIndexedBondAssetDto> getByTenant(UUID tenantId) {
        return repository.findByTenantId(tenantId).stream().map(this::mapToDto).collect(Collectors.toList());
    }

    @Override
    @Transactional(readOnly = true)
    public List<InflationIndexedBondAssetDto> getByUser(UUID userId) {
        return repository.findByUserId(userId).stream().map(this::mapToDto).collect(Collectors.toList());
    }

    @Override
    @Transactional
    public InflationIndexedBondAssetDto create(InflationIndexedBondAssetDto dto) {
        ...
        InflationIndexedBondAsset entity = InflationIndexedBondAsset.builder()
            .user(u)
    ...
    @Override
    @Transactional(readOnly = true)
    public InflationIndexedBondAssetDto getByReference(String ref) {
    ...
    public void updateStatus(UUID id, String status) {
        InflationIndexedBondAsset entity = repository.findById(id)
    ...
    @Override
    @Transactional(readOnly = true)
    public List<InflationIndexedBondAssetDto> listAll() {
