...
/** Algorithmic automated break resolution and variance write-off */
@Entity @Table(name = "automatedbreakresolutions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AutomatedBreakResolution extends BaseEntity {
