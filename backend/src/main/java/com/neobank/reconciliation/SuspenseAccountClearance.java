...
/** Temporary suspense account booking and destination re-allocation */
@Entity @Table(name = "suspenseaccountclearances") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
