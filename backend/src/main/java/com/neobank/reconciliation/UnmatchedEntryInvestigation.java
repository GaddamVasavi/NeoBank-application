...
/** Ledger break and unmatched financial item investigation case */
@Entity @Table(name = "unmatchedentryinvestigations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class UnmatchedEntryInvestigation extends BaseEntity {
