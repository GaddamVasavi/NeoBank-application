...
/** Automated bank statement feed transaction matching and clearing */
@Entity @Table(name = "bankfeedtransactionmatchs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BankFeedTransactionMatch extends BaseEntity {
