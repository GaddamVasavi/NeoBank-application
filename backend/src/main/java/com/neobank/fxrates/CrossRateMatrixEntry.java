...
/** Triangular arbitrage cross-currency implied rate matrix */
@Entity @Table(name = "crossratematrixentrys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CrossRateMatrixEntry extends BaseEntity {
