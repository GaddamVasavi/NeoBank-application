...
/** Streaming Bloomberg / Refinitiv FX tick data snapshot */
@Entity @Table(name = "realtimefxratestreamlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RealTimeFxRateStreamLog extends BaseEntity {
