...
/** Special Drawing Rights (SDR) currency basket weighting */
@Entity @Table(name = "currencybasketallocations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CurrencyBasketAllocation extends BaseEntity {
