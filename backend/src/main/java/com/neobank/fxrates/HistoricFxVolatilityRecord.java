...
/** 30-day and 90-day annualized currency pair volatility */
@Entity @Table(name = "historicfxvolatilityrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class HistoricFxVolatilityRecord extends BaseEntity {
