...
/** Overnight marginal lending and deposit facility usage log */
@Entity @Table(name = "centralbankstandingfacilitys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CentralBankStandingFacility extends BaseEntity {
