...
/** ISO 20022 PACS.009 financial institutional direct debit/credit */
@Entity @Table(name = "iso20022pacs009financials") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class Iso20022Pacs009Financial extends BaseEntity {
