...
/** Correspondent banking Nostro/Vostro daily ledger variance break */
@Entity @Table(name = "nostroaccountreconbreaks") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class NostroAccountReconBreak extends BaseEntity {
