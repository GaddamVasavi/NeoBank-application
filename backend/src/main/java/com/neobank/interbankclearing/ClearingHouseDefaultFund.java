...
/** CCP default waterfall mutualized risk contribution ledger */
@Entity @Table(name = "clearinghousedefaultfunds") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ClearingHouseDefaultFund extends BaseEntity {
