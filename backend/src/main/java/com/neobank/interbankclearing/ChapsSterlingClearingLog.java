...
/** Bank of England CHAPS real-time sterling high-value transfer */
@Entity @Table(name = "chapssterlingclearinglogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ChapsSterlingClearingLog extends BaseEntity {
