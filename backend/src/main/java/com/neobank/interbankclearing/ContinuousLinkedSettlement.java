...
/** CLS PvP multi-currency foreign exchange settlement match */
@Entity @Table(name = "continuouslinkedsettlements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ContinuousLinkedSettlement extends BaseEntity {
