...
/** Federal Reserve Fedwire funds transfer priority message */
@Entity @Table(name = "fedwirehighvaluemessages") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FedwireHighValueMessage extends BaseEntity {
