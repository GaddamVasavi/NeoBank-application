...
/** Clearing House Interbank Payments System (CHIPS) intraday slip */
@Entity @Table(name = "chipssettlementconfirmations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ChipsSettlementConfirmation extends BaseEntity {
