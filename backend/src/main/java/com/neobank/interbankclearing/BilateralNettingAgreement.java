...
/** ISDA master agreement close-out bilateral netting calculation */
@Entity @Table(name = "bilateralnettingagreements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BilateralNettingAgreement extends BaseEntity {
