...
/** Eurosystem TARGET2 real-time gross settlement confirmation */
@Entity @Table(name = "target2grosssettlementlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class Target2GrossSettlementLog extends BaseEntity {
