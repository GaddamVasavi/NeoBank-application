...
/** Customer privacy preference, consent ledger, and right to be forgotten */
@Entity @Table(name = "gdprconsentaudits") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class GdprConsentAudit extends BaseEntity {
