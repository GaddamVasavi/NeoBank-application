...
/** US IRS FATCA W-8BEN / W-9 foreign account compliance */
@Entity @Table(name = "fatcadeclarationcertificates") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FatcaDeclarationCertificate extends BaseEntity {
