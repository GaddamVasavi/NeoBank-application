...
/** Consolidated OFAC, EU, UN, and HMT sanctions list registry */
@Entity @Table(name = "sanctionslistmasterentrys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SanctionsListMasterEntry extends BaseEntity {
