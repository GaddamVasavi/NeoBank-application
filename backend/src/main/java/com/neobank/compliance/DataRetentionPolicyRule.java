...
/** Statutory 7-year financial record retention lifecycle rule */
@Entity @Table(name = "dataretentionpolicyrules") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DataRetentionPolicyRule extends BaseEntity {
