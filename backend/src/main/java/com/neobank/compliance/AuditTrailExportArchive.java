...
/** Tamper-evident WORM audit log export archive */
@Entity @Table(name = "audittrailexportarchives") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AuditTrailExportArchive extends BaseEntity {
