...
/** Complex structuring, smurfing, and layering detection rule */
@Entity @Table(name = "suspiciousmonitoringrules") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SuspiciousMonitoringRule extends BaseEntity {
