...
/** Anonymous compliance ethics hotline case file */
@Entity @Table(name = "whistleblowercasefiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class WhistleblowerCaseFile extends BaseEntity {
