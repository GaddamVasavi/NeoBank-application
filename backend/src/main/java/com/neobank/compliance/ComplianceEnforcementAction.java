...
/** Internal supervisory corrective action and remediation */
@Entity @Table(name = "complianceenforcementactions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ComplianceEnforcementAction extends BaseEntity {
