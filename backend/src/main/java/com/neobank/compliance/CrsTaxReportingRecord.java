...
/** OECD Common Reporting Standard tax residency exchange */
@Entity @Table(name = "crstaxreportingrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CrsTaxReportingRecord extends BaseEntity {
