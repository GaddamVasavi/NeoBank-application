...
/** Basel III capital adequacy and leverage ratio filing */
@Entity @Table(name = "regulatoryfilingpackages") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RegulatoryFilingPackage extends BaseEntity {
