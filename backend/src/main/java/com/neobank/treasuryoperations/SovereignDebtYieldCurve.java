...
/** Multi-tenor sovereign benchmark zero-coupon yield curve interpolation */
@Entity @Table(name = "sovereigndebtyieldcurves") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SovereignDebtYieldCurve extends BaseEntity {
