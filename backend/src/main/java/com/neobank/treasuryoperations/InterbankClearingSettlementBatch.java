...
/** High-value RTGS / Fedwire multi-bank netting and settlement batch */
@Entity @Table(name = "interbankclearingsettlementbatchs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InterbankClearingSettlementBatch extends BaseEntity {
