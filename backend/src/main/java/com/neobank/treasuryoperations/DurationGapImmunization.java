...
/** Asset liability management ALM duration gap interest risk immunization */
@Entity @Table(name = "durationgapimmunizations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DurationGapImmunization extends BaseEntity {
