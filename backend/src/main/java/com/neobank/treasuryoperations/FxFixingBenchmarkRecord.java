...
/** WMR / ECB benchmark fixing rate publication and trade fixing slip */
@Entity @Table(name = "fxfixingbenchmarkrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FxFixingBenchmarkRecord extends BaseEntity {
