...
/** Severe 30-day idiosyncratic deposit run-off stress simulation */
@Entity @Table(name = "liquiditycoveragestressruns") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LiquidityCoverageStressRun extends BaseEntity {
