...
/** Euroclear / Clearstream triparty collateral allocation and margin call */
@Entity @Table(name = "tripartycollateralmargins") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TripartyCollateralMargin extends BaseEntity {
