...
/** Multi-currency triparty collateralized repurchase facility */
@Entity @Table(name = "crosscurrencyrepofacilitys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CrossCurrencyRepoFacility extends BaseEntity {
