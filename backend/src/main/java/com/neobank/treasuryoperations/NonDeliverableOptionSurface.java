...
/** Emerging market non-deliverable currency option implied volatility */
@Entity @Table(name = "nondeliverableoptionsurfaces") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class NonDeliverableOptionSurface extends BaseEntity {
