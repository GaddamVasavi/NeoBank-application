...
/** Automated recurring bill execution engine with weekend adjustments */
@Entity
@Table(name = "recurringbillschedulers")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class RecurringBillScheduler extends BaseEntity {
