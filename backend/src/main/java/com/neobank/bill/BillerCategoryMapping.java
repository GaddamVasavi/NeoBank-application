...
/** Category mapping and merchant categorization for utility billing */
@Entity
@Table(name = "billercategorymappings")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class BillerCategoryMapping extends BaseEntity {
