...
/** Twilio / Infobip transactional OTP SMS delivery audit log */
@Entity @Table(name = "smsgatewayauditlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SmsGatewayAuditLog extends BaseEntity {
