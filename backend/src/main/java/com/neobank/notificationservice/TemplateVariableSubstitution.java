...
/** Dynamic notification template multilingual localization */
@Entity @Table(name = "templatevariablesubstitutions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TemplateVariableSubstitution extends BaseEntity {
