...
/** SendGrid / AWS SES transactional email delivery receipt */
@Entity @Table(name = "emaildispatcharchiverecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EmailDispatchArchiveRecord extends BaseEntity {
