...
/** Apple APNs and Google FCM priority push dispatch queue */
@Entity @Table(name = "pushnotificationdeliveryqueues") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PushNotificationDeliveryQueue extends BaseEntity {
