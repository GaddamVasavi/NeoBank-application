...
/** Coupon penalty step-up sustainability-linked bond metric */
@Entity @Table(name = "sustainabilitylinkedbonds") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SustainabilityLinkedBond extends BaseEntity {
