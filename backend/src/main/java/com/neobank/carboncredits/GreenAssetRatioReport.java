...
/** Pillar 3 ESG prudential Green Asset Ratio (GAR) disclosure */
@Entity @Table(name = "greenassetratioreports") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class GreenAssetRatioReport extends BaseEntity {
