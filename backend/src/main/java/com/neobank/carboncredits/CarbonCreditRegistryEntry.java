...
/** Verra / Gold Standard certified carbon offset registry serial number */
@Entity @Table(name = "carboncreditregistryentrys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CarbonCreditRegistryEntry extends BaseEntity {
