...
/** I-REC international renewable energy certificate retirement */
@Entity @Table(name = "renewableenergycertificates") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RenewableEnergyCertificate extends BaseEntity {
