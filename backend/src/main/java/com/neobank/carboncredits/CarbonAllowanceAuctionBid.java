...
/** EU ETS compliance carbon allowance primary auction tender */
@Entity @Table(name = "carbonallowanceauctionbids") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CarbonAllowanceAuctionBid extends BaseEntity {
