...
/** Financed emissions PCAF standard carbon footprint calculation */
@Entity @Table(name = "scope3emissionsallocations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class Scope3EmissionsAllocation extends BaseEntity {
