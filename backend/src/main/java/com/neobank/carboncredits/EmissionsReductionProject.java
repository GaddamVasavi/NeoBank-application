...
/** Renewable energy and reforestation carbon offset project */
@Entity @Table(name = "emissionsreductionprojects") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EmissionsReductionProject extends BaseEntity {
