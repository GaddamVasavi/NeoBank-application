...
/** MSCI / Sustainalytics ESG risk rating and controversy screen */
@Entity @Table(name = "esgscorecardassessments") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EsgScorecardAssessment extends BaseEntity {
