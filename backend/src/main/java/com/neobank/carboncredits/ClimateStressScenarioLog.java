...
/** NGFS physical and transition climate risk stress test scenario */
@Entity @Table(name = "climatestressscenariologs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ClimateStressScenarioLog extends BaseEntity {
