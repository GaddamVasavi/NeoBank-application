...
/** EU Taxonomy green loan alignment and ESG sustainability KPI */
@Entity @Table(name = "greenfinancingeligibilitys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class GreenFinancingEligibility extends BaseEntity {
