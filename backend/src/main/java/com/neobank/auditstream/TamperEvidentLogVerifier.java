...
/** Continuous audit log chain verification and merkle tree proof */
@Entity @Table(name = "tamperevidentlogverifiers") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
