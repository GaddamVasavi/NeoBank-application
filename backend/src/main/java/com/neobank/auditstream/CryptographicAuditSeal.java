...
/** SHA-256 HMAC digital audit seal verification record */
@Entity @Table(name = "cryptographicauditseals") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CryptographicAuditSeal extends BaseEntity {
