...
/** External regulator inspection session and read-only access */
@Entity @Table(name = "complianceinspectorsessions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ComplianceInspectorSession extends BaseEntity {
