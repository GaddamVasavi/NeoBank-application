...
/** WORM storage immutable cryptographic audit log block */
@Entity @Table(name = "immutableauditlogblocks") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ImmutableAuditLogBlock extends BaseEntity {
