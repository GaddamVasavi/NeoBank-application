...
/** Subpoena and regulatory examination evidence package */
@Entity @Table(name = "regulatoryevidencepackages") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RegulatoryEvidencePackage extends BaseEntity {
