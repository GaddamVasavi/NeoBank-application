...
/** Index-linked structured note fair value and secondary quote */
@Entity @Table(name = "structurednotevaluationlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class StructuredNoteValuationLog extends BaseEntity {
