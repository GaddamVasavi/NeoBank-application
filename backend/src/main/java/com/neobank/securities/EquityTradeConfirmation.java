...
/** Electronic stock execution trade confirmation and clearing slip */
@Entity @Table(name = "equitytradeconfirmations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EquityTradeConfirmation extends BaseEntity {
