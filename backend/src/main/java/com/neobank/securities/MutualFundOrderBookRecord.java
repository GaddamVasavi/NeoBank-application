...
/** Open-end fund forward-pricing unit subscription order */
@Entity @Table(name = "mutualfundorderbookrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MutualFundOrderBookRecord extends BaseEntity {
