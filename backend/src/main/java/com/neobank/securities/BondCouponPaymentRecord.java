...
/** Semi-annual sovereign and corporate bond coupon credit */
@Entity @Table(name = "bondcouponpaymentrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BondCouponPaymentRecord extends BaseEntity {
