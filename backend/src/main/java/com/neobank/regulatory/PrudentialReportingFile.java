...
/** Central bank quarterly prudential reporting submission package */
@Entity @Table(name = "prudentialreportingfiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PrudentialReportingFile extends BaseEntity {
