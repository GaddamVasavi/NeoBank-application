...
/** Single counterparty and connected group concentration limit */
@Entity @Table(name = "largeexposurereturns") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LargeExposureReturn extends BaseEntity {
