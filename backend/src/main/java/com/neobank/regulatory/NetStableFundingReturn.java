...
/** NSFR structural stable funding asset/liability return */
@Entity @Table(name = "netstablefundingreturns") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class NetStableFundingReturn extends BaseEntity {
