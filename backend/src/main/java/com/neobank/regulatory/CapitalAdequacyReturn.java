...
/** Basel III Pillar 1 capital adequacy calculation return */
@Entity @Table(name = "capitaladequacyreturns") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CapitalAdequacyReturn extends BaseEntity {
