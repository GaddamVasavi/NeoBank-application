...
/** High-grade G10 sovereign bond holding and yield-to-maturity */
@Entity @Table(name = "sovereigndebtholdingassets") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SovereignDebtHoldingAsset extends BaseEntity {
