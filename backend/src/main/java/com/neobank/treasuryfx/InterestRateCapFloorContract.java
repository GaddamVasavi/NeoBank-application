...
/** Interest rate collar, cap, and floor derivative structure */
@Entity @Table(name = "interestratecapfloorcontracts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InterestRateCapFloorContract extends BaseEntity {
