...
/** FX vanilla option delta hedge and gamma risk metric */
@Entity @Table(name = "foreignexchangeoptiondeltas") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ForeignExchangeOptionDelta extends BaseEntity {
