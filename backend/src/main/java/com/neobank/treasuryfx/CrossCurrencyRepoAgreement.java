...
/** Multi-currency collateralized repo and haircut schedule */
@Entity @Table(name = "crosscurrencyrepoagreements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CrossCurrencyRepoAgreement extends BaseEntity {
