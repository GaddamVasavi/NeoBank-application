...
/** Fixed income Macaulay duration and modified convexity metric */
@Entity @Table(name = "bondconvexitymetricrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BondConvexityMetricRecord extends BaseEntity {
