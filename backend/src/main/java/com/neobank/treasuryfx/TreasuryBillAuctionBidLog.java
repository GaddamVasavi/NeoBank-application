...
/** Short-term sovereign treasury bill primary issue tender */
@Entity @Table(name = "treasurybillauctionbidlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TreasuryBillAuctionBidLog extends BaseEntity {
