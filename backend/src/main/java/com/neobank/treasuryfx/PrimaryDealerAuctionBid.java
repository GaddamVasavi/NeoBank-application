...
/** Government sovereign bond primary dealer auction allotment */
@Entity @Table(name = "primarydealerauctionbids") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PrimaryDealerAuctionBid extends BaseEntity {
