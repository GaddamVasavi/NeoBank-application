...
/** Asset-liability management (ALM) duration gap immunization */
@Entity @Table(name = "durationmatchingschedules") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DurationMatchingSchedule extends BaseEntity {
