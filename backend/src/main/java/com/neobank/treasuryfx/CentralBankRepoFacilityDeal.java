...
/** Open market repo operation and standing liquidity facility */
@Entity @Table(name = "centralbankrepofacilitydeals") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CentralBankRepoFacilityDeal extends BaseEntity {
