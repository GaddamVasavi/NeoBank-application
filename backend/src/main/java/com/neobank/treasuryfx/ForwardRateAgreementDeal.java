...
/** Over-the-counter forward rate agreement (FRA) interest fixing */
@Entity @Table(name = "forwardrateagreementdeals") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ForwardRateAgreementDeal extends BaseEntity {
