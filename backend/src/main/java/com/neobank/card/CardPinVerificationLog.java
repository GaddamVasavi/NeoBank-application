...
/** HSM PIN verification attempt and cryptographic verification log */
@Entity
@Table(name = "cardpinverificationlogs")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class CardPinVerificationLog extends BaseEntity {
