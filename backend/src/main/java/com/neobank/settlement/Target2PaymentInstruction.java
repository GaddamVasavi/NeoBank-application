...
/** European Eurosystem TARGET2 RTGS payment instruction */
@Entity @Table(name = "target2paymentinstructions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class Target2PaymentInstruction extends BaseEntity {
