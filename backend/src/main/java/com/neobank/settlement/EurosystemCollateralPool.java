...
/** Central bank monetary policy eligible collateral pledge */
@Entity @Table(name = "eurosystemcollateralpools") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EurosystemCollateralPool extends BaseEntity {
