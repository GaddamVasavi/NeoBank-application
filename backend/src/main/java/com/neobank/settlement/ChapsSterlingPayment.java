...
/** Bank of England CHAPS real-time sterling settlement */
@Entity @Table(name = "chapssterlingpayments") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ChapsSterlingPayment extends BaseEntity {
