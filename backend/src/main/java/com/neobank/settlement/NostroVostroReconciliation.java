...
/** Nostro and Vostro correspondent bank account ledger balancing */
@Entity @Table(name = "nostrovostroreconciliations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class NostroVostroReconciliation extends BaseEntity {
