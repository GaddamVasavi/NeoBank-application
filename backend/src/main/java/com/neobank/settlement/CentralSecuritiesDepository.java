...
/** CSD book-entry securities delivery-versus-payment */
@Entity @Table(name = "centralsecuritiesdepositorys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CentralSecuritiesDepository extends BaseEntity {
