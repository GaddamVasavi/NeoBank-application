...
/** Intraday central bank liquidity reserve buffer allocation */
@Entity @Table(name = "liquiditybufferallocations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LiquidityBufferAllocation extends BaseEntity {
