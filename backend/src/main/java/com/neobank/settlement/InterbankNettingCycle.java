...
/** Multilateral interbank netting and net settlement obligation */
@Entity @Table(name = "interbanknettingcycles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InterbankNettingCycle extends BaseEntity {
