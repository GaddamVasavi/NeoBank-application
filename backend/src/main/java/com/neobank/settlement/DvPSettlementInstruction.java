...
/** Delivery-versus-Payment instantaneous asset settlement */
@Entity @Table(name = "dvpsettlementinstructions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DvPSettlementInstruction extends BaseEntity {
