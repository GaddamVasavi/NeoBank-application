...
/** US Federal Reserve Fedwire funds transfer message record */
@Entity @Table(name = "fedwirefundstransfers") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
