...
/** Central bank high-value RTGS real-time gross settlement */
@Entity @Table(name = "realtimegrosssettlements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RealTimeGrossSettlement extends BaseEntity {
