...
/** Annual IRS 1099-INT bank interest income tax report */
@Entity @Table(name = "taxform1099intgenerations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TaxForm1099IntGeneration extends BaseEntity {
