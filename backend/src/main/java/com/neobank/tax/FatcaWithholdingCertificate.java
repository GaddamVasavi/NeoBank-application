...
@Entity @Table(name = "fatcawithholdingcertificates") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FatcaWithholdingCertificate extends BaseEntity {
