...
/** Statutory non-resident dividend withholding tax ledger */
@Entity @Table(name = "dividendtaxwithholdings") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DividendTaxWithholding extends BaseEntity {
