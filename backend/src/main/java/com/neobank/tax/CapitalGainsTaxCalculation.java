...
/** Short-term vs long-term investment capital gains tax schedule */
@Entity @Table(name = "capitalgainstaxcalculations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CapitalGainsTaxCalculation extends BaseEntity {
