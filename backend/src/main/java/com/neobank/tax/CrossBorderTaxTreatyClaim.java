...
/** Bilateral double taxation relief and foreign tax credit */
@Entity @Table(name = "crossbordertaxtreatyclaims") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CrossBorderTaxTreatyClaim extends BaseEntity {
