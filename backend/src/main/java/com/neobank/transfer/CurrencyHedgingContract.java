...
/** Forward FX exchange rate lock-in and hedging agreement execution */
@Entity
@Table(name = "currencyhedgingcontracts")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class CurrencyHedgingContract extends BaseEntity {
