...
/** Federal Reserve FedNow real-time gross settlement integration handler */
@Entity
@Table(name = "fednowinstantsettlements")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class FedNowInstantSettlement extends BaseEntity {
