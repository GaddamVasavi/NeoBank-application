...
/** Unauthorized transfer investigation, chargeback filing, and provisional credit */
@Entity
@Table(name = "transferdisputerecords")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class TransferDisputeRecord extends BaseEntity {
