...
/** Automated recurring payment schedules with weekend and holiday adjustment rules */
@Entity
@Table(name = "recurringtransferrules")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class RecurringTransferRule extends BaseEntity {
