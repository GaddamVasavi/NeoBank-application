...
/** High-volume corporate payroll and vendor batch disbursement file processor */
@Entity
@Table(name = "batchtransferjobs")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class BatchTransferJob extends BaseEntity {
