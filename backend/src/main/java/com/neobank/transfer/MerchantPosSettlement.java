...
/** Point-of-sale terminal batch reconciliation and merchant fee processing */
@Entity
@Table(name = "merchantpossettlements")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class MerchantPosSettlement extends BaseEntity {
