...
/** Domestic and international wire routing parameters with intermediary bank codes */
@Entity
@Table(name = "wiretransferinstructions")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class WireTransferInstruction extends BaseEntity {
