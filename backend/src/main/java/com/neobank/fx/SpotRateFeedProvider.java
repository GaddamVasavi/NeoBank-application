...
/** Interbank institutional FX spot price feed provider */
@Entity @Table(name = "spotratefeedproviders") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SpotRateFeedProvider extends BaseEntity {
