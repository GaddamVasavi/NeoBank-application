...
/** Automated market execution slippage protection rule */
@Entity @Table(name = "slippagetolerancerules") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SlippageToleranceRule extends BaseEntity {
