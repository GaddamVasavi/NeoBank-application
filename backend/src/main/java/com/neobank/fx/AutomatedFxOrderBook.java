...
/** Algorithmic limit and stop FX order matching book */
@Entity @Table(name = "automatedfxorderbooks") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AutomatedFxOrderBook extends BaseEntity {
