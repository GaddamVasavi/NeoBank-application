...
/** Emerging market non-deliverable forward currency contract */
@Entity @Table(name = "nondeliverableforwarddeals") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
