...
/** Tier 1 prime broker FX liquidity aggregator route */
@Entity @Table(name = "liquidityprovideraggregators") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LiquidityProviderAggregator extends BaseEntity {
