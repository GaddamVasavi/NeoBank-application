...
/** Continuous Linked Settlement (CLS) PvP settlement pool */
@Entity @Table(name = "multicurrencysettlementpools") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MultiCurrencySettlementPool extends BaseEntity {
