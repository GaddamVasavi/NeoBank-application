...
/** WM/Reuters 4 PM London benchmark fixing rate record */
@Entity @Table(name = "fixingratepublisherrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FixingRatePublisherRecord extends BaseEntity {
