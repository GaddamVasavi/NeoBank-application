...
/** European and American style FX currency call/put option */
@Entity @Table(name = "currencyoptioncontracts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CurrencyOptionContract extends BaseEntity {
