...
/** Real-time collateral margin call calculation for FX positions */
@Entity @Table(name = "fxmarginrequirementmetrics") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FxMarginRequirementMetric extends BaseEntity {
