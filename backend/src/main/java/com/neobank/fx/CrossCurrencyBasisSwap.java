...
/** Long-term cross-currency interest rate basis swap */
@Entity @Table(name = "crosscurrencybasisswaps") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CrossCurrencyBasisSwap extends BaseEntity {
