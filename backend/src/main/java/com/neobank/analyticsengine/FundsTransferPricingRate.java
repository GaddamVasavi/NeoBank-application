...
/** Internal matched-maturity Funds Transfer Pricing (FTP) curve */
@Entity @Table(name = "fundstransferpricingrates") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FundsTransferPricingRate extends BaseEntity {
