...
/** IFRS 9 Stage 1, Stage 2, and Stage 3 Expected Credit Loss */
@Entity @Table(name = "expectedcreditlossmodels") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ExpectedCreditLossModel extends BaseEntity {
