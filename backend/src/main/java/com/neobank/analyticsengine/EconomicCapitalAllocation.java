...
/** Business unit economic capital and RAROC performance */
@Entity @Table(name = "economiccapitalallocations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EconomicCapitalAllocation extends BaseEntity {
