...
/** Basel III Standardized Approach Risk-Weighted Asset (RWA) */
@Entity @Table(name = "riskweightedassetmodels") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RiskWeightedAssetModel extends BaseEntity {
