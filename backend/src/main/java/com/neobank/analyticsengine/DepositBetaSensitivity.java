...
/** Federal Reserve interest rate hike deposit beta pass-through */
@Entity @Table(name = "depositbetasensitivitys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DepositBetaSensitivity extends BaseEntity {
