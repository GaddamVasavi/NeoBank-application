...
/** Monthly recurring insurance premium direct debit schedule */
@Entity @Table(name = "premiumcollectionschedules") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PremiumCollectionSchedule extends BaseEntity {
