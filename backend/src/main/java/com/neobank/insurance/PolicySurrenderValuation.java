...
/** Cash surrender value calculation and early termination fee */
@Entity @Table(name = "policysurrendervaluations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PolicySurrenderValuation extends BaseEntity {
