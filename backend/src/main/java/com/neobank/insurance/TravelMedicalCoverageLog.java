...
/** International travel medical emergency and evacuation policy */
@Entity @Table(name = "travelmedicalcoveragelogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TravelMedicalCoverageLog extends BaseEntity {
