...
/** Automated insurance actuarial underwriting and risk assessment */
@Entity @Table(name = "policyunderwritingrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PolicyUnderwritingRecord extends BaseEntity {
