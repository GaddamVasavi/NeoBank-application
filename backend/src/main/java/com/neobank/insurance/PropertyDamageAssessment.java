...
/** Homeowners and commercial property damage survey appraisal */
@Entity @Table(name = "propertydamageassessments") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PropertyDamageAssessment extends BaseEntity {
