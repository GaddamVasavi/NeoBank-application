...
/** National insurance commission quarterly solvency II return */
@Entity @Table(name = "insuranceregulatoryfilings") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InsuranceRegulatoryFiling extends BaseEntity {
