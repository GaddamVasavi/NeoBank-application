...
/** Statutory IFRS 17 insurance loss reserve and risk adjustment */
@Entity @Table(name = "actuariallossreservemodels") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ActuarialLossReserveModel extends BaseEntity {
