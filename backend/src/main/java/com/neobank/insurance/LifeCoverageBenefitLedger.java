...
/** Term life insurance death benefit and beneficiary designation */
@Entity @Table(name = "lifecoveragebenefitledgers") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LifeCoverageBenefitLedger extends BaseEntity {
