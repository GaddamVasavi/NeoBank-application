...
/** Commercial and residential real estate mortgage lien registry */
@Entity @Table(name = "realestatecollateralmortgages") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RealEstateCollateralMortgage extends BaseEntity {
