...
/** Pledged cash deposit escrow and collateral margin account */
@Entity @Table(name = "cashmargincollateraldeposits") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CashMarginCollateralDeposit extends BaseEntity {
