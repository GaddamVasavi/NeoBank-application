...
/** Inspected commodity and metal warehouse warrant pledge */
@Entity @Table(name = "commoditywarehousecollaterals") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CommodityWarehouseCollateral extends BaseEntity {
