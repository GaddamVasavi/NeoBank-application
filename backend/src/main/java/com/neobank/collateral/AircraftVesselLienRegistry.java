...
/** Aviation and maritime vessel asset lien recording */
@Entity @Table(name = "aircraftvessellienregistrys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AircraftVesselLienRegistry extends BaseEntity {
