...
/** Listed equities and government bonds pledge agreement */
@Entity @Table(name = "securitiespledgeagreements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SecuritiesPledgeAgreement extends BaseEntity {
