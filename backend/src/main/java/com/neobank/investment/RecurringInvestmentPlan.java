...
/** Dollar-cost averaging automated monthly investment schedule */
@Entity @Table(name = "recurringinvestmentplans") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RecurringInvestmentPlan extends BaseEntity {
