...
/** Regulated digital asset custody balance and gas fee tracker */
@Entity @Table(name = "cryptoassetwallets") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CryptoAssetWallet extends BaseEntity {
