...
/** Market, limit, and stop-loss trade order execution */
@Entity @Table(name = "stockorderexecutions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class StockOrderExecution extends BaseEntity {
