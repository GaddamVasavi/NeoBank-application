...
/** MiFID II risk tolerance questionnaire and asset allocation */
@Entity @Table(name = "investmentriskprofiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InvestmentRiskProfile extends BaseEntity {
