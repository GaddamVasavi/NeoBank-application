...
/** Open-end fund SIP investment and NAV tracker */
@Entity @Table(name = "mutualfundpositions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MutualFundPosition extends BaseEntity {
