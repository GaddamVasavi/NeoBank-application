...
/** S&P 500, MSCI World, and custom benchmark tracking */
@Entity @Table(name = "benchmarkcomparisonmetrics") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BenchmarkComparisonMetric extends BaseEntity {
