...
/** Stock split, merger, and rights issue corporate action */
@Entity @Table(name = "corporateactionnotices") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorporateActionNotice extends BaseEntity {
