...
/** Automated capital gain offset and tax optimization schedule */
@Entity @Table(name = "taxlossharvestingrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TaxLossHarvestingRecord extends BaseEntity {
