...
/** Automated dividend distribution and tax withholding ledger */
@Entity @Table(name = "dividendpaymentcredits") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DividendPaymentCredit extends BaseEntity {
