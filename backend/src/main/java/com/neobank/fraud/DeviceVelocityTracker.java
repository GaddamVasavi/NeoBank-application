...
/** Cross-account device fingerprint hopping and session anomaly monitor */
@Entity
@Table(name = "devicevelocitytrackers")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class DeviceVelocityTracker extends BaseEntity {
