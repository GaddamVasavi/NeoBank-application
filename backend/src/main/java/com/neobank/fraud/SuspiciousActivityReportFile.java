...
/** Automated FinCEN XML/JSON filing package generator */
@Entity
@Table(name = "suspiciousactivityreportfiles")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class SuspiciousActivityReportFile extends BaseEntity {
