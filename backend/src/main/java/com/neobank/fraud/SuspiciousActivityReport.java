...
/** FinCEN automated SAR generation and regulatory narrative documentation */
@Entity
@Table(name = "suspiciousactivityreports")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class SuspiciousActivityReport extends BaseEntity {
