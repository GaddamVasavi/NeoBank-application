...
/** Credential stuffing and simultaneous multi-country login detector */
@Entity
@Table(name = "accounttakeoversignals")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class AccountTakeoverSignal extends BaseEntity {
