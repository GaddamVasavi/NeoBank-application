...
/** Real-time transaction frequency monitor over sliding windows */
@Entity
@Table(name = "transactionvelocitymetrics")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class TransactionVelocityMetric extends BaseEntity {
