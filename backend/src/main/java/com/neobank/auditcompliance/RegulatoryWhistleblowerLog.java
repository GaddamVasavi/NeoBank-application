...
/** Anonymous SEC/CFTC whistleblower complaint log */
@Entity @Table(name = "regulatorywhistleblowerlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RegulatoryWhistleblowerLog extends BaseEntity {
