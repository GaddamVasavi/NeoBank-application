...
/** SOX 404 internal control over financial reporting evaluation */
@Entity @Table(name = "sarbanesoxleysection404logs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SarbanesOxleySection404Log extends BaseEntity {
