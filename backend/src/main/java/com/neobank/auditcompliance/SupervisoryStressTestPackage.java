...
/** Federal Reserve CCAR stress test submission dataset */
@Entity @Table(name = "supervisorystresstestpackages") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SupervisoryStressTestPackage extends BaseEntity {
