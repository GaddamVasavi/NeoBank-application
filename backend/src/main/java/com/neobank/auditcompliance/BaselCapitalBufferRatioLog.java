...
/** Countercyclical capital buffer and G-SIB surcharge ratio */
@Entity @Table(name = "baselcapitalbufferratiologs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BaselCapitalBufferRatioLog extends BaseEntity {
