...
/** Material weakness and significant deficiency remediation file */
@Entity @Table(name = "internalcontroldeficiencyfiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InternalControlDeficiencyFile extends BaseEntity {
