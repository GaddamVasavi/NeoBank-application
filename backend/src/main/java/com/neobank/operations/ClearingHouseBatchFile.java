...
/** ACH, Fedwire, and CHIPS clearing transmission batch file */
@Entity @Table(name = "clearinghousebatchfiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ClearingHouseBatchFile extends BaseEntity {
