...
/** Banking regulator audit documentation and evidence package */
@Entity @Table(name = "regulatoryinspectionpackages") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RegulatoryInspectionPackage extends BaseEntity {
