...
/** ATM fleet terminal status, cash cassette level, and maintenance */
@Entity @Table(name = "atmterminalmanagementlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AtmTerminalManagementLog extends BaseEntity {
