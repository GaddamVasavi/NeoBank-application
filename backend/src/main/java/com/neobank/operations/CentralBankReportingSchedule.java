...
/** Prudential statistical reporting schedule and data extract */
@Entity @Table(name = "centralbankreportingschedules") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CentralBankReportingSchedule extends BaseEntity {
