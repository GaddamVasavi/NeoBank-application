...
/** Failover recovery point and recovery time objective validation log */
@Entity @Table(name = "disasterrecoveryauditlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DisasterRecoveryAuditLog extends BaseEntity {
