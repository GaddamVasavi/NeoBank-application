...
/** Automated ledger-to-clearing house break and exception investigation */
@Entity @Table(name = "reconciliationexceptionrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ReconciliationExceptionRecord extends BaseEntity {
