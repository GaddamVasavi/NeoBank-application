...
/** Physical bank branch vault cash inventory and dual-control audit */
@Entity @Table(name = "branchvaultbalancelogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BranchVaultBalanceLog extends BaseEntity {
