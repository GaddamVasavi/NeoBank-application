...
/** Armored carrier branch and ATM cash replenishment manifest */
@Entity @Table(name = "cashintransitrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CashInTransitRecord extends BaseEntity {
