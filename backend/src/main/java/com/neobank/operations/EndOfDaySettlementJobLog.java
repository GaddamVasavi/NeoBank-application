...
/** Overnight core banking batch closing and interest accrual run */
@Entity @Table(name = "endofdaysettlementjoblogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EndOfDaySettlementJobLog extends BaseEntity {
