...
/** Historical and parametric Value-at-Risk (VaR) portfolio risk metric */
@Entity @Table(name = "marketriskvalueatrisks") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MarketRiskValueAtRisk extends BaseEntity {
