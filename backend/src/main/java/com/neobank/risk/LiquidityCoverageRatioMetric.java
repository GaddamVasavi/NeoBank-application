...
/** Basel III 30-day high-quality liquid asset buffer metric */
@Entity @Table(name = "liquiditycoverageratiometrics") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LiquidityCoverageRatioMetric extends BaseEntity {
