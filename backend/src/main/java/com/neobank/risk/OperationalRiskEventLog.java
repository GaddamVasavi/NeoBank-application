...
/** Basel II operational risk loss event logging and classification */
@Entity @Table(name = "operationalriskeventlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class OperationalRiskEventLog extends BaseEntity {
