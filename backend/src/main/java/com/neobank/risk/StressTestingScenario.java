...
/** Macroeconomic shock scenario and balance sheet stress evaluation */
@Entity @Table(name = "stresstestingscenarios") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class StressTestingScenario extends BaseEntity {
