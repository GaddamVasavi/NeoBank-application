...
/** Economic Value of Equity (EVE) and Net Interest Income sensitivity */
@Entity @Table(name = "interestrateriskinbankings") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InterestRateRiskInBanking extends BaseEntity {
