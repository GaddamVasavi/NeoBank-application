...
/** Probability of Default (PD) and Loss Given Default (LGD) calculation */
@Entity @Table(name = "creditriskdefaultmodels") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CreditRiskDefaultModel extends BaseEntity {
