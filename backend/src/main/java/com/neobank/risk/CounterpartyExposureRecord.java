...
/** Interbank counterparty credit limit and current mark-to-market */
@Entity @Table(name = "counterpartyexposurerecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CounterpartyExposureRecord extends BaseEntity {
