...
/** Available vs required stable funding structural liquidity ratio */
@Entity @Table(name = "netstablefundingratiometrics") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class NetStableFundingRatioMetric extends BaseEntity {
