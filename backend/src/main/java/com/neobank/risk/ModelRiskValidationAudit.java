...
/** Financial quantitative model validation and backtesting audit */
@Entity @Table(name = "modelriskvalidationaudits") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ModelRiskValidationAudit extends BaseEntity {
