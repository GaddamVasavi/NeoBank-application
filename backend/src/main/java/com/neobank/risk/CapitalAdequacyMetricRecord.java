...
/** Common Equity Tier 1 (CET1) and Total Capital ratio calculation */
@Entity @Table(name = "capitaladequacymetricrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CapitalAdequacyMetricRecord extends BaseEntity {
