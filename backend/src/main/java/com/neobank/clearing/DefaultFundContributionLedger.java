...
/** CCP mutualized default waterfall clearing fund guarantee */
@Entity @Table(name = "defaultfundcontributionledgers") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DefaultFundContributionLedger extends BaseEntity {
