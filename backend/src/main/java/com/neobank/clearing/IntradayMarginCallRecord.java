...
/** Real-time intra-day market volatility margin demand notice */
@Entity @Table(name = "intradaymargincallrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class IntradayMarginCallRecord extends BaseEntity {
