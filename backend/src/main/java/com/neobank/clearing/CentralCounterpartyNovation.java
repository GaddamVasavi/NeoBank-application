...
/** Bilateral OTC trade clearing novation with central clearing */
@Entity @Table(name = "centralcounterpartynovations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CentralCounterpartyNovation extends BaseEntity {
