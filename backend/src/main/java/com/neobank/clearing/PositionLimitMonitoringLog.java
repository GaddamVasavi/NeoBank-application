...
/** Exchange traded commodity and interest rate position limit */
@Entity @Table(name = "positionlimitmonitoringlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PositionLimitMonitoringLog extends BaseEntity {
