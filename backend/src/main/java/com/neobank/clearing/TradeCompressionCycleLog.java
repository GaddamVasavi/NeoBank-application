...
/** Multilateral portfolio trade compression and tear-up run */
@Entity @Table(name = "tradecompressioncyclelogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TradeCompressionCycleLog extends BaseEntity {
