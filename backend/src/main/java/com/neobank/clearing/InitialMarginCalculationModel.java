...
/** ISDA SIMM standard initial margin model calculation */
@Entity @Table(name = "initialmargincalculationmodels") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InitialMarginCalculationModel extends BaseEntity {
