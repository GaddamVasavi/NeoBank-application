...
/** Cross-product risk-based portfolio margin offset model */
@Entity @Table(name = "portfoliomarginingrulemodels") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PortfolioMarginingRuleModel extends BaseEntity {
