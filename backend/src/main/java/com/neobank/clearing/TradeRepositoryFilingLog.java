...
/** EMIR / Dodd-Frank regulatory trade repository transaction report */
@Entity @Table(name = "traderepositoryfilinglogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TradeRepositoryFilingLog extends BaseEntity {
