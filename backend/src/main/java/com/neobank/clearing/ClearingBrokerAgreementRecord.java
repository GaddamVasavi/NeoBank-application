...
/** Direct clearing member broker sponsorship agreement */
@Entity @Table(name = "clearingbrokeragreementrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ClearingBrokerAgreementRecord extends BaseEntity {
