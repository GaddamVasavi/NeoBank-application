...
/** Energy, agriculture, and precious metals commodity future */
@Entity @Table(name = "commodityfuturecontractdeals") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CommodityFutureContractDeal extends BaseEntity {
