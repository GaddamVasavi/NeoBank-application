...
/** Synthetic equity and credit index total return swap */
@Entity @Table(name = "totalreturnswapdealagreements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TotalReturnSwapDealAgreement extends BaseEntity {
