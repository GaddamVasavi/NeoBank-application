...
/** Single-name and CDX index credit default swap protection */
@Entity @Table(name = "creditdefaultswapcontracts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CreditDefaultSwapContract extends BaseEntity {
