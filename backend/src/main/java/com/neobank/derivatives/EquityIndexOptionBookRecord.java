...
/** S&P 500 and EuroStoxx 50 exchange-traded index option book */
@Entity @Table(name = "equityindexoptionbookrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EquityIndexOptionBookRecord extends BaseEntity {
