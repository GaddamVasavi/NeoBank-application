...
/** Black-Scholes implied swaption volatility surface cube */
@Entity @Table(name = "swaptionvolatilitysurfacelogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SwaptionVolatilitySurfaceLog extends BaseEntity {
