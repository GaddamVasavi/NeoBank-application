...
/** Direct CSD delivery-versus-payment securities custody link */
@Entity @Table(name = "centralsecuritiesdepositorylinks") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CentralSecuritiesDepositoryLink extends BaseEntity {
