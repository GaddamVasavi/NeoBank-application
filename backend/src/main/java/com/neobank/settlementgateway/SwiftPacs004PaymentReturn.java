...
/** ISO 20022 PACS.004 payment return and recall investigation memo */
@Entity @Table(name = "swiftpacs004paymentreturns") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SwiftPacs004PaymentReturn extends BaseEntity {
