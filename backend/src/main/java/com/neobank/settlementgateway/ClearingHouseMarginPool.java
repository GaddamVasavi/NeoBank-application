...
/** CCP clearing house mutualized default waterfall margin pool */
@Entity @Table(name = "clearinghousemarginpools") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ClearingHouseMarginPool extends BaseEntity {
