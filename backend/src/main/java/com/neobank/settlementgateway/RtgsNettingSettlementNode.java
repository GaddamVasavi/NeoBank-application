...
/** Real-Time Gross Settlement high-value bilateral netting settlement node */
@Entity @Table(name = "rtgsnettingsettlementnodes") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RtgsNettingSettlementNode extends BaseEntity {
