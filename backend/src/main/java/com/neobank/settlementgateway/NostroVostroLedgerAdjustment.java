...
/** Correspondent bank Nostro account manual variance adjusting entry */
@Entity @Table(name = "nostrovostroledgeradjustments") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class NostroVostroLedgerAdjustment extends BaseEntity {
