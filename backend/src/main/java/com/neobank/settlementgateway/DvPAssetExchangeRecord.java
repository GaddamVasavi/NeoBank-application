...
/** Instant delivery-versus-payment equity and bond asset exchange slip */
@Entity @Table(name = "dvpassetexchangerecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DvPAssetExchangeRecord extends BaseEntity {
