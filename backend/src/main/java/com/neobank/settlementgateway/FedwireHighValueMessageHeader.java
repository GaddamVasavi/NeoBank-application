...
/** Federal Reserve Fedwire funds service high-priority message header */
@Entity @Table(name = "fedwirehighvaluemessageheaders") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FedwireHighValueMessageHeader extends BaseEntity {
