...
/** Individual Retirement Account (IRA) and pension fund */
@Entity @Table(name = "retirementsavingsaccounts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RetirementSavingsAccount extends BaseEntity {
