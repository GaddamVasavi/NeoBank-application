...
/** Employer matched 401(k) payroll deduction schedule */
@Entity @Table(name = "contributionschedule401ks") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ContributionSchedule401k extends BaseEntity {
