...
/** Required Minimum Distribution (RMD) systematic drawdown */
@Entity @Table(name = "postretirementdrawdownplans") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PostRetirementDrawdownPlan extends BaseEntity {
