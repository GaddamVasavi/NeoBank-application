...
/** Corporate pension trust defined contribution scheme */
@Entity @Table(name = "definedcontributionplans") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DefinedContributionPlan extends BaseEntity {
