...
/** Unit-linked private placement life insurance policy */
@Entity @Table(name = "lifeinsurancepolicywrappers") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LifeInsurancePolicyWrapper extends BaseEntity {
