...
/** Pre-tax compound growth and projected pension benefit */
@Entity @Table(name = "taxdeferredgrowthschedules") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TaxDeferredGrowthSchedule extends BaseEntity {
