...
/** Pension scheme funding ratio and actuarial liability */
@Entity @Table(name = "pensionactuarialvaluations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PensionActuarialValuation extends BaseEntity {
