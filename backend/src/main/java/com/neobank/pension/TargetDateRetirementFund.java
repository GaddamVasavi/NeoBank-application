...
/** Glidepath target-date 2055 asset allocation fund */
@Entity @Table(name = "targetdateretirementfunds") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TargetDateRetirementFund extends BaseEntity {
