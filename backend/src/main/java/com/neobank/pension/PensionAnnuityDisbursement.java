...
/** Guaranteed life annuity monthly retirement payout */
@Entity @Table(name = "pensionannuitydisbursements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PensionAnnuityDisbursement extends BaseEntity {
