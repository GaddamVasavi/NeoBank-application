...
/** Pension survivorship beneficiary designation audit */
@Entity @Table(name = "beneficiarydesignationaudits") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BeneficiaryDesignationAudit extends BaseEntity {
