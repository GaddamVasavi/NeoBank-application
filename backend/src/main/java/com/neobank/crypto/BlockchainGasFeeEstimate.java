...
/** Real-time layer-1 gas fee and priority fee calculation */
@Entity @Table(name = "blockchaingasfeeestimates") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BlockchainGasFeeEstimate extends BaseEntity {
