...
/** Zero-knowledge proof credential and decentralized ID claim */
@Entity @Table(name = "decentralizedidentityproofs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DecentralizedIdentityProof extends BaseEntity {
