...
/** Regulated security token and tokenized bond on-chain transfer */
@Entity @Table(name = "tokenizedassettransfers") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TokenizedAssetTransfer extends BaseEntity {
