...
/** Multi-sig MPC cold custody digital asset deposit transaction */
@Entity @Table(name = "cryptocustodyvaultdeposits") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CryptoCustodyVaultDeposit extends BaseEntity {
