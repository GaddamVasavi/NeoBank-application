...
/** Atomic cross-chain bridge swap and liquidity pool routing */
@Entity @Table(name = "crosschainbridgeswaps") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CrossChainBridgeSwap extends BaseEntity {
