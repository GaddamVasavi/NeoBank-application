...
/** W3C verifiable credential and decentralized identity attestation */
@Entity @Table(name = "decentralizedidentityclaims") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DecentralizedIdentityClaim extends BaseEntity {
