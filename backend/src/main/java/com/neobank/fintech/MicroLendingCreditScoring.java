...
/** Alternative underwriting machine learning credit score model */
@Entity @Table(name = "microlendingcreditscorings") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MicroLendingCreditScoring extends BaseEntity {
