...
/** Inter-ledger protocol atomic cross-border settlement bridge */
@Entity @Table(name = "instantsettlementbridgenodes") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InstantSettlementBridgeNode extends BaseEntity {
