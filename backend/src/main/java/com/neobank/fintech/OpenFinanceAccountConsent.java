...
/** Consumer data right open finance multidomain consent token */
@Entity @Table(name = "openfinanceaccountconsents") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class OpenFinanceAccountConsent extends BaseEntity {
