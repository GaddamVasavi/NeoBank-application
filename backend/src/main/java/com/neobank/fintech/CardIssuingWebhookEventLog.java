...
/** Real-time card transaction webhook delivery and retry log */
@Entity @Table(name = "cardissuingwebhookeventlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CardIssuingWebhookEventLog extends BaseEntity {
