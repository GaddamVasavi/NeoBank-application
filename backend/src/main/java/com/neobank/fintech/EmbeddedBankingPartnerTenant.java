...
/** Banking-as-a-Service (BaaS) co-branded partner API tenant */
@Entity @Table(name = "embeddedbankingpartnertenants") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EmbeddedBankingPartnerTenant extends BaseEntity {
