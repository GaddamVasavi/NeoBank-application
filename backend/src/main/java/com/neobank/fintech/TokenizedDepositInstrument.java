...
/** Digital tokenized bank deposit on permissioned ledger */
@Entity @Table(name = "tokenizeddepositinstruments") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TokenizedDepositInstrument extends BaseEntity {
