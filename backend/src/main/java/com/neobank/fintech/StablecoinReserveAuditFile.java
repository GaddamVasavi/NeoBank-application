...
/** 100% cash and short-term US Treasury backed reserve audit */
@Entity @Table(name = "stablecoinreserveauditfiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class StablecoinReserveAuditFile extends BaseEntity {
