...
/** Automated algorithmic smart contract escrow milestone lock */
@Entity @Table(name = "smartcontractescrowdeposits") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SmartContractEscrowDeposit extends BaseEntity {
