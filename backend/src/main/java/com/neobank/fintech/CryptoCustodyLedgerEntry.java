...
/** Multi-signature cold storage vault digital asset custody ledger */
@Entity @Table(name = "cryptocustodyledgerentrys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CryptoCustodyLedgerEntry extends BaseEntity {
