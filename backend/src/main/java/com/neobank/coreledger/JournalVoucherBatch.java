...
/** Multi-legged balancing accounting journal voucher batch */
@Entity @Table(name = "journalvoucherbatchs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class JournalVoucherBatch extends BaseEntity {
