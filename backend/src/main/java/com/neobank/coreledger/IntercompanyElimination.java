...
/** Consolidated financial statement intercompany elimination */
@Entity @Table(name = "intercompanyeliminations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
