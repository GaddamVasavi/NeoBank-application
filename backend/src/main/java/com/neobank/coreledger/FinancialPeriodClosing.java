...
/** Monthly and annual financial accounting period closing lock */
@Entity @Table(name = "financialperiodclosings") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
