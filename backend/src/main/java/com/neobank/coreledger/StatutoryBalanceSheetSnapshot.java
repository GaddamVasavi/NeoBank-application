...
/** Quarterly published statutory balance sheet snapshot */
@Entity @Table(name = "statutorybalancesheetsnapshots") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class StatutoryBalanceSheetSnapshot extends BaseEntity {
