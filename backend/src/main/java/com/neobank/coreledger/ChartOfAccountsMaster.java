...
/** Standard multi-currency hierarchical chart of accounts definition */
@Entity @Table(name = "chartofaccountsmasters") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
