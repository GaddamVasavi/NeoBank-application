...
/** LIBOR/SOFR rate fixing and rollover notice transmission */
@Entity @Table(name = "agentbanknoticebroadcasts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AgentBankNoticeBroadcast extends BaseEntity {
