...
/** Accounts receivable and inventory formula borrowing base */
@Entity @Table(name = "borrowingbasecertificates") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BorrowingBaseCertificate extends BaseEntity {
