...
/** Underwritten and best-efforts syndication lead mandate */
@Entity @Table(name = "syndicatesyndicationmandates") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SyndicateSyndicationMandate extends BaseEntity {
