...
/** Multi-lender facility tranche booking and drawdown allocation */
@Entity @Table(name = "syndicatedfacilitybookings") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SyndicatedFacilityBooking extends BaseEntity {
