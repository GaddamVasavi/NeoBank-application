...
/** Syndicate member majority consent and amendment voting record */
@Entity @Table(name = "lendervotingrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LenderVotingRecord extends BaseEntity {
