...
/** Facility agent administrative fee calculation and distribution */
@Entity @Table(name = "agencyfeedistributions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AgencyFeeDistribution extends BaseEntity {
