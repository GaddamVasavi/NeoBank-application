...
/** Quarterly leverage and interest coverage covenant certification */
@Entity @Table(name = "covenantcomplianceaudits") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CovenantComplianceAudit extends BaseEntity {
