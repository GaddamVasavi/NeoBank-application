...
/** Senior vs mezzanine priority waterfall and subordination terms */
@Entity @Table(name = "intercreditorsubordinations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class IntercreditorSubordination extends BaseEntity {
