...
/** LMA / LSTA par loan secondary market trade settlement log */
@Entity @Table(name = "secondarymarkettradelogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SecondaryMarketTradeLog extends BaseEntity {
