...
/** Borrower amortized principal repayment allocation waterfall */
@Entity @Table(name = "syndicatedrepaymentwaterfalls") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SyndicatedRepaymentWaterfall extends BaseEntity {
