...
/** Negotiable agricultural and commodity warehouse receipt */
@Entity @Table(name = "warehousereceiptcollaterals") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class WarehouseReceiptCollateral extends BaseEntity {
