...
/** Irrevocable documentary letter of credit compliance check */
@Entity @Table(name = "letterofcreditdocuments") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LetterOfCreditDocument extends BaseEntity {
