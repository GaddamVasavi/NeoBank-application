...
/** Government export credit agency political risk guarantee */
@Entity @Table(name = "exportcreditagencyguarantees") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ExportCreditAgencyGuarantee extends BaseEntity {
