...
/** Contractor performance bond and standby letter of credit */
@Entity @Table(name = "tradefinanceguaranteebonds") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TradeFinanceGuaranteeBond extends BaseEntity {
