...
/** Commercial bill of lading and sea cargo manifest */
@Entity @Table(name = "shippingconsignmentledgers") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ShippingConsignmentLedger extends BaseEntity {
