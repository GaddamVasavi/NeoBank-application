...
/** International maritime transit cargo insurance certificate */
@Entity @Table(name = "marinecargoinsurancepolicys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
