...
/** Trade bill of exchange acceptance and discounting */
@Entity @Table(name = "billofexchangeacceptances") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BillOfExchangeAcceptance extends BaseEntity {
