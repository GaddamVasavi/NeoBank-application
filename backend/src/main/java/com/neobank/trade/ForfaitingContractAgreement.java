...
/** Medium-term non-recourse export receivables forfaiting */
@Entity @Table(name = "forfaitingcontractagreements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ForfaitingContractAgreement extends BaseEntity {
