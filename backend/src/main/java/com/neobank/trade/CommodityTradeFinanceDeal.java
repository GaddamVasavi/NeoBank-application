...
/** Structured commodity inventory and pre-export financing */
@Entity @Table(name = "commoditytradefinancedeals") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CommodityTradeFinanceDeal extends BaseEntity {
