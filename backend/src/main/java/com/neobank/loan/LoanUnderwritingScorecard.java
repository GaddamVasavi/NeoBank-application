...
/** Automated debt-to-income and credit capacity underwriting rubric */
@Entity
@Table(name = "loanunderwritingscorecards")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class LoanUnderwritingScorecard extends BaseEntity {
