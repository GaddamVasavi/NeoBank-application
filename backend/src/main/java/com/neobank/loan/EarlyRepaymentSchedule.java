...
/** Prepayment penalty calculation, interest reduction, and adjusted amortization */
@Entity
@Table(name = "earlyrepaymentschedules")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class EarlyRepaymentSchedule extends BaseEntity {
