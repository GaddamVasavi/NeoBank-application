...
/** Multi-currency correspondent bank account funding projection */
@Entity @Table(name = "nostrofundingforecastmodels") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class NostroFundingForecastModel extends BaseEntity {
