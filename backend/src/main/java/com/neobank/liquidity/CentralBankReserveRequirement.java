...
/** Statutory mandatory minimum reserve balance compliance */
@Entity @Table(name = "centralbankreserverequirements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CentralBankReserveRequirement extends BaseEntity {
