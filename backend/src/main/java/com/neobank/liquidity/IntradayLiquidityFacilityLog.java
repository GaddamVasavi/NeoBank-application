...
/** Central bank committed intraday overdraft and liquidity line */
@Entity @Table(name = "intradayliquidityfacilitylogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class IntradayLiquidityFacilityLog extends BaseEntity {
