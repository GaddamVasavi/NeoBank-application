...
/** Severe idiosyncratic and market-wide 30-day liquidity stress test */
@Entity @Table(name = "baselliquiditystresstests") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BaselLiquidityStressTest extends BaseEntity {
