...
/** Cheapest-to-deliver cross-triparty collateral allocation */
@Entity @Table(name = "collateraloptimizationlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CollateralOptimizationLog extends BaseEntity {
