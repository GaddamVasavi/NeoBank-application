...
/** Visa / Mastercard chargeback representment and evidence */
@Entity @Table(name = "chargebackdisputereversals") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ChargebackDisputeReversal extends BaseEntity {
