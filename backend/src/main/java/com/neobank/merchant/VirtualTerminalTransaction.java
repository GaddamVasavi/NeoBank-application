...
/** MOTO mail-order and telephone-order virtual terminal charge */
@Entity @Table(name = "virtualterminaltransactions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class VirtualTerminalTransaction extends BaseEntity {
