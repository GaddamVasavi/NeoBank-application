...
/** Merchant customer recurring SaaS and subscription billing */
@Entity @Table(name = "recurringsubscriptionplans") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RecurringSubscriptionPlan extends BaseEntity {
