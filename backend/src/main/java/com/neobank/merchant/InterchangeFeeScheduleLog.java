...
/** Card network assessment and interchange fee schedule */
@Entity @Table(name = "interchangefeeschedulelogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InterchangeFeeScheduleLog extends BaseEntity {
