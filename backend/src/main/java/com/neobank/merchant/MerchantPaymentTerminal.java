...
/** In-store POS smart terminal and payment terminal fleet */
@Entity @Table(name = "merchantpaymentterminals") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MerchantPaymentTerminal extends BaseEntity {
