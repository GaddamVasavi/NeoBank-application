...
/** Quarterly CASS 6/7 client asset regulatory inspection */
@Entity @Table(name = "assetsafekeepingaudittrails") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AssetSafekeepingAuditTrail extends BaseEntity {
