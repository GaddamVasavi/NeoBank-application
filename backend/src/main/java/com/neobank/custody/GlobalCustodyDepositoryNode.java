...
/** Euroclear, Clearstream, and DTC depository interface */
@Entity @Table(name = "globalcustodydepositorynodes") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class GlobalCustodyDepositoryNode extends BaseEntity {
