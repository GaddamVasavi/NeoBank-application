...
/** Institutional equity and bond securities lending contract */
@Entity @Table(name = "securitieslendingagreements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SecuritiesLendingAgreement extends BaseEntity {
