...
/** Triparty repo and securities financing collateral schedule */
@Entity @Table(name = "tripartycollateraldeals") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TripartyCollateralDeal extends BaseEntity {
