...
/** Institutional shareholder annual general meeting mandate */
@Entity @Table(name = "proxyvotingmandaterecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ProxyVotingMandateRecord extends BaseEntity {
