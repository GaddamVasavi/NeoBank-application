...
/** Shareholder proxy voting instruction and meeting notice */
@Entity @Table(name = "corporateactionvoterecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorporateActionVoteRecord extends BaseEntity {
