...
/** Double taxation treaty cross-border tax reclaim filing */
@Entity @Table(name = "withholdingtaxreclaimlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class WithholdingTaxReclaimLog extends BaseEntity {
