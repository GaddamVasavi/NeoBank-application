...
/** Segregated client asset safekeeping custody account */
@Entity @Table(name = "assetcustodyaccounts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AssetCustodyAccount extends BaseEntity {
