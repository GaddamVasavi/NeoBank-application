...
/** Buyer-led supply chain financing early payment discount */
@Entity @Table(name = "reversefactoringprograms") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ReverseFactoringProgram extends BaseEntity {
