...
/** Customer commercial dispute retention and withholding */
@Entity @Table(name = "invoicedisputeretentions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InvoiceDisputeRetention extends BaseEntity {
