...
/** Approved debtor exposure ceiling and concentration rule */
@Entity @Table(name = "buyercreditlimitallocations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BuyerCreditLimitAllocation extends BaseEntity {
