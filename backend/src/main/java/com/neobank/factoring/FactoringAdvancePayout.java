...
/** Immediate 85% invoice advance disbursement to supplier */
@Entity @Table(name = "factoringadvancepayouts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FactoringAdvancePayout extends BaseEntity {
