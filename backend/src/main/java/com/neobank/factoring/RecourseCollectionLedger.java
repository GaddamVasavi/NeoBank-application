...
/** Non-payment recourse notification and supplier buyback ledger */
@Entity @Table(name = "recoursecollectionledgers") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RecourseCollectionLedger extends BaseEntity {
