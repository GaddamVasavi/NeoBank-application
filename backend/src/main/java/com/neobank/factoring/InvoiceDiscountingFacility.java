...
/** Working capital invoice factoring credit line agreement */
@Entity @Table(name = "invoicediscountingfacilitys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InvoiceDiscountingFacility extends BaseEntity {
