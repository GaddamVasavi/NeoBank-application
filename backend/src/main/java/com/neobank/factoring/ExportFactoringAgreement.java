...
/** Cross-border two-factor FCI import/export credit cover */
@Entity @Table(name = "exportfactoringagreements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ExportFactoringAgreement extends BaseEntity {
