...
/** Corporate commercial buyer credit rating and payment history */
@Entity @Table(name = "debtorcreditassessmentlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DebtorCreditAssessmentLog extends BaseEntity {
