...
/** Legal demand letter and debt recovery agency assignment */
@Entity @Table(name = "delinquentdebtorrecoverys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DelinquentDebtorRecovery extends BaseEntity {
