...
/** Daily factoring discount fee and service charge computation */
@Entity @Table(name = "factoringfeecalculations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FactoringFeeCalculation extends BaseEntity {
