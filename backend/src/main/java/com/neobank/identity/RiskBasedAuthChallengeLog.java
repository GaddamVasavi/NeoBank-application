...
/** Step-up authentication challenge on anomalous device/IP */
@Entity @Table(name = "riskbasedauthchallengelogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RiskBasedAuthChallengeLog extends BaseEntity {
