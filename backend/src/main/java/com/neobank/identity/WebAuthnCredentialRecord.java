...
/** Passkey and hardware security key registration entry */
@Entity @Table(name = "webauthncredentialrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class WebAuthnCredentialRecord extends BaseEntity {
