...
/** Hardware security module (HSM) bound device certificate */
@Entity @Table(name = "devicetrustcertificatefiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DeviceTrustCertificateFile extends BaseEntity {
