...
/** SMS, TOTP, and Push approval multi-factor authentication log */
@Entity @Table(name = "multifactorauthauditlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MultiFactorAuthAuditLog extends BaseEntity {
