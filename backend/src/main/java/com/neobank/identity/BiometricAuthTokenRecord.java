...
/** FIDO2 WebAuthn biometric public key credential record */
@Entity @Table(name = "biometricauthtokenrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BiometricAuthTokenRecord extends BaseEntity {
