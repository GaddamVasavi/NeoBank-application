...
/** Account membership tiers with personalized interest rate multipliers and fee waivers */
@Entity
@Table(name = "accounttiers")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class AccountTier extends BaseEntity {
