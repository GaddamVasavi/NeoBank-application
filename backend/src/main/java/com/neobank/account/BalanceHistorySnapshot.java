...
/** Daily end-of-day balance snapshots for compliance and ledger reconciliation */
@Entity
@Table(name = "balancehistorysnapshots")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class BalanceHistorySnapshot extends BaseEntity {
