...
/** Automated overdraft coverage limits, interest penalties, and grace periods */
@Entity
@Table(name = "overdraftfacilitys")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class OverdraftFacility extends BaseEntity {
