...
/** Dynamic service charge calculation, monthly maintenance fees, and waiver rules */
@Entity
@Table(name = "accountfeeschedules")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class AccountFeeSchedule extends BaseEntity {
