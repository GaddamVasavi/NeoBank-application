...
/** Annual interest reporting, tax withholding certificates, and 1099-INT generation */
@Entity
@Table(name = "accounttaxreports")
@Getter
@Setter
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class AccountTaxReport extends BaseEntity {
