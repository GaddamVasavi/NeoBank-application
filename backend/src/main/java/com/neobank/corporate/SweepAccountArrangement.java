...
/** Target balance and zero-balance automated inter-account sweeping */
@Entity @Table(name = "sweepaccountarrangements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SweepAccountArrangement extends BaseEntity {
