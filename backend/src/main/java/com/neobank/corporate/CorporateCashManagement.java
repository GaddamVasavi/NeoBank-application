...
/** Enterprise cash forecasting, intra-day sweep, and balance optimization */
@Entity @Table(name = "corporatecashmanagements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorporateCashManagement extends BaseEntity {
