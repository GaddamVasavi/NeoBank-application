...
/** Multi-bank syndicated loan participation and agent bank workflow */
@Entity @Table(name = "syndicatedloanfacilitys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SyndicatedLoanFacility extends BaseEntity {
