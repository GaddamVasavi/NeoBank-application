...
/** Corporate procurement card policy, spend limit, and category restrictions */
@Entity @Table(name = "corporatecardpolicyrules") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorporateCardPolicyRule extends BaseEntity {
