...
/** Customer-allocated virtual IBAN pool for instant receivables matching */
@Entity @Table(name = "virtualibanpools") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class VirtualIbanPool extends BaseEntity {
