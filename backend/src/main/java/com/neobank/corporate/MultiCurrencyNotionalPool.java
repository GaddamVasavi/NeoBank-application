...
/** Multi-currency interest offset and consolidated balance pooling */
@Entity @Table(name = "multicurrencynotionalpools") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MultiCurrencyNotionalPool extends BaseEntity {
