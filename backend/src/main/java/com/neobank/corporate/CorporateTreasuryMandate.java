...
/** Board authorized banking signatories and multi-tier approval matrix */
@Entity @Table(name = "corporatetreasurymandates") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorporateTreasuryMandate extends BaseEntity {
