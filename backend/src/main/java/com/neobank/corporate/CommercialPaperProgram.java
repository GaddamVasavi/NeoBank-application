...
/** Short-term promissory note issuance and maturity settlement */
@Entity @Table(name = "commercialpaperprograms") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CommercialPaperProgram extends BaseEntity {
