...
/** Employee expense reimbursement filing, receipt OCR, and approval */
@Entity @Table(name = "corporateexpenseclaims") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorporateExpenseClaim extends BaseEntity {
