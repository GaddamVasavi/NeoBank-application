...
/** Payment gateway merchant batch settlement and interchange deduction */
@Entity @Table(name = "merchantsettlementbatchfiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MerchantSettlementBatchFile extends BaseEntity {
