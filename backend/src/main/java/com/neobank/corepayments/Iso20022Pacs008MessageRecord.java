...
/** ISO 20022 PACS.008 financial institutional credit transfer */
@Entity @Table(name = "iso20022pacs008messagerecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class Iso20022Pacs008MessageRecord extends BaseEntity {
