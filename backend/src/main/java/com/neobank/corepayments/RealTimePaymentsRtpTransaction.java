...
/** The Clearing House Real-Time Payments (RTP) credit transfer */
@Entity @Table(name = "realtimepaymentsrtptransactions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RealTimePaymentsRtpTransaction extends BaseEntity {
