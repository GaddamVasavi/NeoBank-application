...
/** Federal Reserve Fedwire high-value funds batch settlement */
@Entity @Table(name = "fedwirefundssettlementbatchs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FedwireFundsSettlementBatch extends BaseEntity {
