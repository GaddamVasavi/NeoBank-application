...
/** NACHA ACH PPD, CCD, and WEB electronic debit/credit batch */
@Entity @Table(name = "automatedclearinghousenachas") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AutomatedClearingHouseNacha extends BaseEntity {
