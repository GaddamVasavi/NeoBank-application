...
/** Central bank and interbank benchmark yield curve tracker */
@Entity @Table(name = "yieldcurvebenchmarks") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class YieldCurveBenchmark extends BaseEntity {
