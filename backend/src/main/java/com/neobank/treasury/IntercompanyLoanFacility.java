...
/** Corporate group internal liquidity loan agreement */
@Entity @Table(name = "intercompanyloanfacilitys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class IntercompanyLoanFacility extends BaseEntity {
