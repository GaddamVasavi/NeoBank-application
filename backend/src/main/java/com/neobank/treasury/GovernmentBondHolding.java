...
/** Sovereign treasury bill portfolio and duration metric */
@Entity @Table(name = "governmentbondholdings") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class GovernmentBondHolding extends BaseEntity {
