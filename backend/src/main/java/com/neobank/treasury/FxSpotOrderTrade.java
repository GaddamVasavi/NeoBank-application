...
/** Institutional FX spot trade execution and settlement ledger */
@Entity @Table(name = "fxspotordertrades") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FxSpotOrderTrade extends BaseEntity {
