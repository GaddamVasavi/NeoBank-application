...
/** Contractual and behavioral cash flow liquidity horizon */
@Entity @Table(name = "liquidityladderreports") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LiquidityLadderReport extends BaseEntity {
