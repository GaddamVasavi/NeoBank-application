...
/** Custom maturity currency forward hedging contract */
@Entity @Table(name = "fxforwardcontractagreements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
