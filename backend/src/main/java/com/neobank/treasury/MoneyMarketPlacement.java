...
/** Overnight and short-term commercial paper investment */
@Entity @Table(name = "moneymarketplacements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MoneyMarketPlacement extends BaseEntity {
