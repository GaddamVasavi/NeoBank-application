...
/** Fixed-to-floating interest rate risk mitigation swap */
@Entity @Table(name = "interestrateswapcontracts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
