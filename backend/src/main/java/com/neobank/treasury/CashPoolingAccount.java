...
/** Multi-entity zero-balance cash concentration pool */
@Entity @Table(name = "cashpoolingaccounts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CashPoolingAccount extends BaseEntity {
