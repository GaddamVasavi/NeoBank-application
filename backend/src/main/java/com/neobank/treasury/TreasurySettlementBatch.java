...
/** High-value SWIFT MT103 / MT202 clearing batch */
@Entity @Table(name = "treasurysettlementbatchs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TreasurySettlementBatch extends BaseEntity {
