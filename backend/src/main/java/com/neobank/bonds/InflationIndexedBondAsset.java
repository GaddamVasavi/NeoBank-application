...
/** TIPS consumer price index inflation protected bond holding */
@Entity @Table(name = "inflationindexedbondassets") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
