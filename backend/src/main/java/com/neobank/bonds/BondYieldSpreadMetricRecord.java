...
/** Sovereign benchmark credit spread and z-spread metric */
@Entity @Table(name = "bondyieldspreadmetricrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BondYieldSpreadMetricRecord extends BaseEntity {
