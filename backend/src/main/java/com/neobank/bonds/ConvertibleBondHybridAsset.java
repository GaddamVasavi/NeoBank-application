...
/** Convertible corporate bond hybrid debt-equity instrument */
@Entity @Table(name = "convertiblebondhybridassets") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ConvertibleBondHybridAsset extends BaseEntity {
