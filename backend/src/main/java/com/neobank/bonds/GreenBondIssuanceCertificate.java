...
/** ESG certified sustainable green bond issuance and impact report */
@Entity @Table(name = "greenbondissuancecertificates") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class GreenBondIssuanceCertificate extends BaseEntity {
