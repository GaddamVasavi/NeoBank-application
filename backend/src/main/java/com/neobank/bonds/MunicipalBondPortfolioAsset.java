...
/** Tax-exempt municipal bond and infrastructure bond portfolio */
@Entity @Table(name = "municipalbondportfolioassets") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MunicipalBondPortfolioAsset extends BaseEntity {
