...
/** Third-Party Provider (TPP) eIDAS certificate and QWAC registration */
@Entity @Table(name = "tppclientregistrations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TppClientRegistration extends BaseEntity {
