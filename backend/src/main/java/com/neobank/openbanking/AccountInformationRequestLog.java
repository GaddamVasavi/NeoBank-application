...
/** AISP transaction history and balance fetch audit log */
@Entity @Table(name = "accountinformationrequestlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AccountInformationRequestLog extends BaseEntity {
