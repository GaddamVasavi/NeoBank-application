...
/** Open Banking REST API request latency, status, and payload log */
@Entity @Table(name = "openbankingapitrafficlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class OpenBankingApiTrafficLog extends BaseEntity {
