...
/** OAuth2 dynamic client registration with open banking directory */
@Entity @Table(name = "dynamicclientregistrationrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DynamicClientRegistrationRecord extends BaseEntity {
