...
/** Mutual TLS (mTLS) certificate pinning and expiration tracker */
@Entity @Table(name = "openbankingsecuritycertificates") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class OpenBankingSecurityCertificate extends BaseEntity {
