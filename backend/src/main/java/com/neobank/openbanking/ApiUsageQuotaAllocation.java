...
/** Rate limit and monthly API call quota allocation per fintech partner */
@Entity @Table(name = "apiusagequotaallocations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ApiUsageQuotaAllocation extends BaseEntity {
