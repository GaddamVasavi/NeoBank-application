...
/** Customer consent withdrawal audit trail and TPP token revocation */
@Entity @Table(name = "consentrevocationauditlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ConsentRevocationAuditLog extends BaseEntity {
