...
/** PISP instant payment initiation and funds confirmation audit */
@Entity @Table(name = "paymentinitiationrequestlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PaymentInitiationRequestLog extends BaseEntity {
