...
/** PSD2 Regulatory Strong Customer Authentication (SCA) consent token */
@Entity @Table(name = "psd2consentrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class Psd2ConsentRecord extends BaseEntity {
