...
/** Redlock distributed mutex acquisition and lock lease time */
@Entity @Table(name = "distributedlockauditlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DistributedLockAuditLog extends BaseEntity {
