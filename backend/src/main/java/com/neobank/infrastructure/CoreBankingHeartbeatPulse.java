...
/** Mainframe and ledger subsystem heartbeat availability pulse */
@Entity @Table(name = "corebankingheartbeatpulses") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CoreBankingHeartbeatPulse extends BaseEntity {
