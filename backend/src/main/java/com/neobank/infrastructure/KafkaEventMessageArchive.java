...
/** Event-driven architecture streaming topic audit record */
@Entity @Table(name = "kafkaeventmessagearchives") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class KafkaEventMessageArchive extends BaseEntity {
