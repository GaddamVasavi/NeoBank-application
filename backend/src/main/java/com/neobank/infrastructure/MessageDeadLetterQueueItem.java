...
/** Poison pill and unprocessable message dead letter queue */
@Entity @Table(name = "messagedeadletterqueueitems") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MessageDeadLetterQueueItem extends BaseEntity {
