...
/** HashiCorp Vault dynamic database credential and key rotation */
@Entity @Table(name = "vaultsecretrotationlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class VaultSecretRotationLog extends BaseEntity {
