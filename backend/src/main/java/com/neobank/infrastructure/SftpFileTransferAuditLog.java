...
/** Clearing house and core banking SFTP batch transmission log */
@Entity @Table(name = "sftpfiletransferauditlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SftpFileTransferAuditLog extends BaseEntity {
