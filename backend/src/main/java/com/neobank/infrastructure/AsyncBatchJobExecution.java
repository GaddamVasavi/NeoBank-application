...
/** Spring Batch overnight chunk processing and step execution */
@Entity @Table(name = "asyncbatchjobexecutions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AsyncBatchJobExecution extends BaseEntity {
