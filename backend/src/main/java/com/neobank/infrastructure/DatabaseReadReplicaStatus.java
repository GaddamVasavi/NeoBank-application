...
/** PostgreSQL streaming replication lag and connection pool */
@Entity @Table(name = "databasereadreplicastatuss") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DatabaseReadReplicaStatus extends BaseEntity {
