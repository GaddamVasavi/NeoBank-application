...
/** Kubernetes cluster node CPU, memory, and pod health metric */
@Entity @Table(name = "clusternodehealthtelemetrys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ClusterNodeHealthTelemetry extends BaseEntity {
