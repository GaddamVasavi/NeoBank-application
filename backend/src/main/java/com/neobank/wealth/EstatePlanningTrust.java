...
/** Family trust entity structure, beneficiaries, and distribution milestones */
@Entity @Table(name = "estateplanningtrusts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EstatePlanningTrust extends BaseEntity {
