...
/** Alternative investment fund subscription and capital call ledger */
@Entity @Table(name = "hedgefundsubscriptions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class HedgeFundSubscription extends BaseEntity {
