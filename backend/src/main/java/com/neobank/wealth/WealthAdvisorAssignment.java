...
/** Private banker portfolio allocation and advisory agreement */
@Entity @Table(name = "wealthadvisorassignments") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class WealthAdvisorAssignment extends BaseEntity {
