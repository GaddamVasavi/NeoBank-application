...
/** Fine art and luxury asset appraisal and collateral pledge */
@Entity @Table(name = "artcollectiblescollaterals") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ArtCollectiblesCollateral extends BaseEntity {
