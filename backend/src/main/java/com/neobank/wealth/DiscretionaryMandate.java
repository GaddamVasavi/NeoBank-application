...
/** Discretionary asset management strategy and risk envelope */
@Entity @Table(name = "discretionarymandates") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DiscretionaryMandate extends BaseEntity {
