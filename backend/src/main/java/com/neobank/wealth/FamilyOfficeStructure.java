...
/** Multi-family office governance, voting shares, and asset holding */
@Entity @Table(name = "familyofficestructures") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FamilyOfficeStructure extends BaseEntity {
