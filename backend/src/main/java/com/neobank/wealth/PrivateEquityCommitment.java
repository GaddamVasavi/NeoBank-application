...
/** Private equity fund commitment, drawdown, and distribution tracker */
@Entity @Table(name = "privateequitycommitments") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PrivateEquityCommitment extends BaseEntity {
