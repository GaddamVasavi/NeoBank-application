...
/** Charitable foundation endowment fund and grant disbursement */
@Entity @Table(name = "philanthropicendowments") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PhilanthropicEndowment extends BaseEntity {
