...
/** Ultra-high-net-worth customer profile with dedicated relationship manager */
@Entity @Table(name = "privatebankingclients") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PrivateBankingClient extends BaseEntity {
