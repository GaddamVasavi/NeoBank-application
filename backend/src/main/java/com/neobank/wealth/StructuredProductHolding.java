...
/** Capital-protected note, reverse convertible, and derivative asset */
@Entity @Table(name = "structuredproductholdings") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class StructuredProductHolding extends BaseEntity {
