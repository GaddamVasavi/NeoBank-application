...
/** Performance bond and bid guarantee collateral agreement */
@Entity @Table(name = "bankguaranteebonds") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BankGuaranteeBond extends BaseEntity {
