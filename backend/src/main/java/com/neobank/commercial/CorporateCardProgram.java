...
/** Company employee expense card fleet with policy controls */
@Entity @Table(name = "corporatecardprograms") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorporateCardProgram extends BaseEntity {
