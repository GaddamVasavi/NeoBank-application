...
/** Multi-tier direct deposit salary disbursement batch */
@Entity @Table(name = "corporatepayrollbatchs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorporatePayrollBatch extends BaseEntity {
