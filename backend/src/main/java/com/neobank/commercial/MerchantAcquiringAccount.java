...
/** E-commerce and POS payment processing gateway account */
@Entity @Table(name = "merchantacquiringaccounts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MerchantAcquiringAccount extends BaseEntity {
