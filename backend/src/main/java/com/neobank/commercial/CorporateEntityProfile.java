...
/** Business registration, EIN, and corporate charter record */
@Entity @Table(name = "corporateentityprofiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorporateEntityProfile extends BaseEntity {
