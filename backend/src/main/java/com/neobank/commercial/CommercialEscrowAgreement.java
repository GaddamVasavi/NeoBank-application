...
/** Merger & acquisition escrow deposit milestone contract */
@Entity @Table(name = "commercialescrowagreements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CommercialEscrowAgreement extends BaseEntity {
