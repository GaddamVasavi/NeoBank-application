...
/** Bill of lading and customs import documentation ledger */
@Entity @Table(name = "tradefinanceshipments") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class TradeFinanceShipment extends BaseEntity {
