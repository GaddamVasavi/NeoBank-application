...
/** Revolving line of credit and working capital facility */
@Entity @Table(name = "commercialcreditfacilitys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CommercialCreditFacility extends BaseEntity {
