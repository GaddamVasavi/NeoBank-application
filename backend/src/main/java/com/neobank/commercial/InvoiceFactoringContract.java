...
/** Accounts receivable invoice discounting and advance */
@Entity @Table(name = "invoicefactoringcontracts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InvoiceFactoringContract extends BaseEntity {
