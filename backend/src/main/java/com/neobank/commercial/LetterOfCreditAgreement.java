...
/** Documentary trade import/export letter of credit */
@Entity @Table(name = "letterofcreditagreements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LetterOfCreditAgreement extends BaseEntity {
