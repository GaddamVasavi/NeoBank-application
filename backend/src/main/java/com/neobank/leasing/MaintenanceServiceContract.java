...
/** Included equipment service level and scheduled maintenance */
@Entity @Table(name = "maintenanceservicecontracts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MaintenanceServiceContract extends BaseEntity {
