...
/** Fair market value asset title transfer and purchase bill */
@Entity @Table(name = "endofleasepurchaseoptions") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EndOfLeasePurchaseOption extends BaseEntity {
