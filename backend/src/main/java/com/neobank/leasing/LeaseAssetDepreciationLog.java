...
/** MACRS / straight-line tax depreciation schedule */
@Entity @Table(name = "leaseassetdepreciationlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LeaseAssetDepreciationLog extends BaseEntity {
