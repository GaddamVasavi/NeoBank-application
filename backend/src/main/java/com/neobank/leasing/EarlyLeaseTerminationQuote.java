...
/** Contractual buyout and unearned interest settlement quote */
@Entity @Table(name = "earlyleaseterminationquotes") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EarlyLeaseTerminationQuote extends BaseEntity {
