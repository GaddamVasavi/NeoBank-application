...
/** End-of-term asset residual value and secondary market forecast */
@Entity @Table(name = "residualvaluevaluations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ResidualValueValuation extends BaseEntity {
