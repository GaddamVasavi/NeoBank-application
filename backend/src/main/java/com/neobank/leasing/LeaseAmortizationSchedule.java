...
/** Monthly rental, finance charge, and principal amortization */
@Entity @Table(name = "leaseamortizationschedules") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LeaseAmortizationSchedule extends BaseEntity {
