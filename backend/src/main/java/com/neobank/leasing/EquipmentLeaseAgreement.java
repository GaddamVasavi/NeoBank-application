...
/** Commercial machinery and industrial equipment lease contract */
@Entity @Table(name = "equipmentleaseagreements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EquipmentLeaseAgreement extends BaseEntity {
