...
/** Dynamic behavioral, balance, and demographic customer tagging */
@Entity @Table(name = "customersegmentationrules") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CustomerSegmentationRule extends BaseEntity {
