...
/** Customer peer referral attribution and bonus disbursement ledger */
@Entity @Table(name = "referralbonusledgerentrys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ReferralBonusLedgerEntry extends BaseEntity {
