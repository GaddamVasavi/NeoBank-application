...
/** Bulk push notification and marketing email campaign job */
@Entity @Table(name = "notificationcampaignjobs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class NotificationCampaignJob extends BaseEntity {
