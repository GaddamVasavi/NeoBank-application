...
/** Customer omnichannel marketing preference and opt-in ledger */
@Entity @Table(name = "marketingconsentauditrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class MarketingConsentAuditRecord extends BaseEntity {
