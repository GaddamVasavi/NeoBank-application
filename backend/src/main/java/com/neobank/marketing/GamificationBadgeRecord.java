...
/** Financial milestone achievement badge and savings challenge */
@Entity @Table(name = "gamificationbadgerecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class GamificationBadgeRecord extends BaseEntity {
