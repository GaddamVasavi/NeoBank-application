...
/** Targeted customer deposit bonus and cashback promo campaign */
@Entity @Table(name = "promotionalcampaignschedules") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PromotionalCampaignSchedule extends BaseEntity {
