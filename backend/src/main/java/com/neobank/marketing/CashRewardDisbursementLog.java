...
/** Automated merchant partner cashback reward payout ledger */
@Entity @Table(name = "cashrewarddisbursementlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CashRewardDisbursementLog extends BaseEntity {
