...
/** Co-branded retailer discount offer and affiliate link */
@Entity @Table(name = "partnermerchantofferrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PartnerMerchantOfferRecord extends BaseEntity {
