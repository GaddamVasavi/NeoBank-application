...
/** Loyalty tier cashback rate multiplier and accelerated earning */
@Entity @Table(name = "cashbacktiermultiplierrules") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CashbackTierMultiplierRule extends BaseEntity {
