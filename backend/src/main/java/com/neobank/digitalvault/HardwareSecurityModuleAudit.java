...
/** PKCS#11 cloud HSM cryptographic key usage audit trail */
@Entity @Table(name = "hardwaresecuritymoduleaudits") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class HardwareSecurityModuleAudit extends BaseEntity {
