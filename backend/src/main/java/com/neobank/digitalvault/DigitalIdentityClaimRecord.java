...
/** W3C verifiable credential credential-subject identity claim */
@Entity @Table(name = "digitalidentityclaimrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DigitalIdentityClaimRecord extends BaseEntity {
