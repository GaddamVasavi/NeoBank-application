...
/** Incapacitation or estate inheritance digital executor access */
@Entity @Table(name = "emergencyaccessdelegations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EmergencyAccessDelegation extends BaseEntity {
