...
/** Blockchain-anchored SHA-256 hash time-stamped log block */
@Entity @Table(name = "cryptographicauditchains") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CryptographicAuditChain extends BaseEntity {
