...
/** Global Redis distributed session termination broadcast */
@Entity @Table(name = "sessionrevocationbroadcasts") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SessionRevocationBroadcast extends BaseEntity {
