...
/** Zk-SNARK identity and solvency proof verification token */
@Entity @Table(name = "zeroknowledgeproofattestations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ZeroKnowledgeProofAttestation extends BaseEntity {
