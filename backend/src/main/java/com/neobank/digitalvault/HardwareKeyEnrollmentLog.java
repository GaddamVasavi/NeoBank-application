...
/** FIDO2 / YubiKey WebAuthn hardware security key enrollment */
@Entity @Table(name = "hardwarekeyenrollmentlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class HardwareKeyEnrollmentLog extends BaseEntity {
