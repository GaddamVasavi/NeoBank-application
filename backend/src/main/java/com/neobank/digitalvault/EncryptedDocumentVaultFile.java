...
/** AES-256 GCM client document digital safe deposit box item */
@Entity @Table(name = "encrypteddocumentvaultfiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class EncryptedDocumentVaultFile extends BaseEntity {
