...
/** Kyber / Dilithium post-quantum lattice cryptography key exchange */
@Entity @Table(name = "postquantumkeyexchangelogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PostQuantumKeyExchangeLog extends BaseEntity {
