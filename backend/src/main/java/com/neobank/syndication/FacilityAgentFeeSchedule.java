...
/** Administrative and collateral agency annual fee schedule */
@Entity @Table(name = "facilityagentfeeschedules") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FacilityAgentFeeSchedule extends BaseEntity {
