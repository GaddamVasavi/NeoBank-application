...
/** Term Loan A, Term Loan B, and Revolver multicurrency tranches */
@Entity @Table(name = "debtsyndicationtranches") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class DebtSyndicationTranche extends BaseEntity {
