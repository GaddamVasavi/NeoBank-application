...
/** Quarterly leverage and interest coverage ratio certificate */
@Entity @Table(name = "covenantcompliancecertificates") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CovenantComplianceCertificate extends BaseEntity {
