...
/** Agent bank interest fixing and rate rollover notice broadcast */
@Entity @Table(name = "agencynoticedistributionlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AgencyNoticeDistributionLog extends BaseEntity {
