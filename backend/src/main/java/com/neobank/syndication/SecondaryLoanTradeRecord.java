...
/** LMA / LSTA par and distressed loan market trade confirmation */
@Entity @Table(name = "secondaryloantraderecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SecondaryLoanTradeRecord extends BaseEntity {
