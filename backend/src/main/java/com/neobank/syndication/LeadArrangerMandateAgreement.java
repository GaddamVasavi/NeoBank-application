...
/** Underwritten and best-efforts loan syndication mandate */
@Entity @Table(name = "leadarrangermandateagreements") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LeadArrangerMandateAgreement extends BaseEntity {
