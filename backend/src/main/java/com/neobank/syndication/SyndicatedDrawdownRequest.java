...
/** Borrower utilization request and multi-bank funding schedule */
@Entity @Table(name = "syndicateddrawdownrequests") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SyndicatedDrawdownRequest extends BaseEntity {
