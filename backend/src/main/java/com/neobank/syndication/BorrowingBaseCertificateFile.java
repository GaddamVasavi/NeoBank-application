...
/** Eligible inventory and accounts receivable borrowing formula */
@Entity @Table(name = "borrowingbasecertificatefiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BorrowingBaseCertificateFile extends BaseEntity {
