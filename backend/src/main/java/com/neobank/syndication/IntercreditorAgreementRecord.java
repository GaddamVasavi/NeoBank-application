...
/** Senior vs mezzanine priority and subordination waterfall */
@Entity @Table(name = "intercreditoragreementrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class IntercreditorAgreementRecord extends BaseEntity {
