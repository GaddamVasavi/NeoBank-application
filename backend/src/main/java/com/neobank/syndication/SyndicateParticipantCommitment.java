...
/** Participating lender pro-rata commitment and voting weight */
@Entity @Table(name = "syndicateparticipantcommitments") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SyndicateParticipantCommitment extends BaseEntity {
