...
/** General partner key person departure event and investment freeze */
@Entity @Table(name = "keypersonclausetriggers") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class KeyPersonClauseTrigger extends BaseEntity {
