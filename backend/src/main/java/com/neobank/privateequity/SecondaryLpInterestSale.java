...
/** LP fund interest transfer, right of first refusal, and novation */
@Entity @Table(name = "secondarylpinterestsales") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SecondaryLpInterestSale extends BaseEntity {
