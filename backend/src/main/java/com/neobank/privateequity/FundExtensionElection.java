...
/** LP advisory committee one-year fund life extension vote */
@Entity @Table(name = "fundextensionelections") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FundExtensionElection extends BaseEntity {
