...
/** Bespoke institutional investor fee break and reporting side letter */
@Entity @Table(name = "sideletteragreementrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SideLetterAgreementRecord extends BaseEntity {
