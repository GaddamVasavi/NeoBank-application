...
/** Institutional LP fund commitment and unfunded capital tracker */
@Entity @Table(name = "limitedpartnercommitments") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class LimitedPartnerCommitment extends BaseEntity {
