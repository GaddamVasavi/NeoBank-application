...
/** Limited partner capital call drawdown notice and receipt */
@Entity @Table(name = "capitalcalldrawdownnotices") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
