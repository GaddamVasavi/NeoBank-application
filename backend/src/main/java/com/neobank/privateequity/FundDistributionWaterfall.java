...
/** Hurdle rate, catch-up, and carried interest waterfall calculation */
@Entity @Table(name = "funddistributionwaterfalls") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class FundDistributionWaterfall extends BaseEntity {
