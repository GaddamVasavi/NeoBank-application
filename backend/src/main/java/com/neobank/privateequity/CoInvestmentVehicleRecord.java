...
/** Direct co-investment SPV entity and syndication allocation */
@Entity @Table(name = "coinvestmentvehiclerecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CoInvestmentVehicleRecord extends BaseEntity {
