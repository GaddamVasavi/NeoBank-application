...
/** Invested capital vs committed capital quarterly management fee */
@Entity @Table(name = "managementfeecalculations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ManagementFeeCalculation extends BaseEntity {
