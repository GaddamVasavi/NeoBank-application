...
/** EBITDA multiple and discounted cash flow quarterly valuation */
@Entity @Table(name = "portfoliocompanyvaluations") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
