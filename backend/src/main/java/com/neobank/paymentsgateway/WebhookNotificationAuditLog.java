...
/** Payment webhook dispatch delivery attempt, retry, and HMAC */
@Entity @Table(name = "webhooknotificationauditlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class WebhookNotificationAuditLog extends BaseEntity {
