...
/** Tokenized hosted checkout payment session and payment intent */
@Entity @Table(name = "hostedcheckoutsessionfiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class HostedCheckoutSessionFile extends BaseEntity {
