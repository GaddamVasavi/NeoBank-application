...
/** Payment gateway merchant API keys, webhook URLs, and fee tiers */
@Entity @Table(name = "paymentgatewaymerchantconfigs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class PaymentGatewayMerchantConfig extends BaseEntity {
