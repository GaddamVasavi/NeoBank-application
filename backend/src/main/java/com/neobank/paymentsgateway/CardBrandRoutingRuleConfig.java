...
/** Least-cost debit and card brand network routing optimization */
@Entity @Table(name = "cardbrandroutingruleconfigs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CardBrandRoutingRuleConfig extends BaseEntity {
