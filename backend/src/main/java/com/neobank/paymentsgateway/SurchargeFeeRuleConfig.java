...
/** Credit card processing surcharge and merchant fee rules */
@Entity @Table(name = "surchargefeeruleconfigs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class SurchargeFeeRuleConfig extends BaseEntity {
