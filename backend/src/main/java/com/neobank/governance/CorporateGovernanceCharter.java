...
/** Bank governance framework, committee charters, and terms */
@Entity @Table(name = "corporategovernancecharters") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class CorporateGovernanceCharter extends BaseEntity {
