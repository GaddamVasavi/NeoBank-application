...
/** Restricted trading blackout window and insider dealing registry */
@Entity @Table(name = "insidertradingregistrys") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class InsiderTradingRegistry extends BaseEntity {
