...
/** Formal shareholder notice, agenda, and minutes record */
@Entity @Table(name = "annualgeneralmeetingdossiers") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AnnualGeneralMeetingDossier extends BaseEntity {
