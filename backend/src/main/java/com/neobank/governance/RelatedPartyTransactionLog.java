...
/** Arm-length transaction review with director affiliated entity */
@Entity @Table(name = "relatedpartytransactionlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class RelatedPartyTransactionLog extends BaseEntity {
