...
/** Institutional proxy voting policy recommendations and rationale */
@Entity @Table(name = "proxyvoteadvisoryfiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ProxyVoteAdvisoryFile extends BaseEntity {
