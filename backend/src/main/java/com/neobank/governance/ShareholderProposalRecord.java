...
/** Annual shareholder meeting proxy ballot proposal and vote */
@Entity @Table(name = "shareholderproposalrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ShareholderProposalRecord extends BaseEntity {
