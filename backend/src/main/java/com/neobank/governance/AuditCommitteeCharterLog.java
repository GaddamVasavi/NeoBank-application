...
/** Board audit committee quarterly review and statutory finding */
@Entity @Table(name = "auditcommitteecharterlogs") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class AuditCommitteeCharterLog extends BaseEntity {
