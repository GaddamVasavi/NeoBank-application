...
/** Independent board audit committee ethics investigation */
@Entity @Table(name = "whistleblowerinvestigationfiles") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class WhistleblowerInvestigationFile extends BaseEntity {
