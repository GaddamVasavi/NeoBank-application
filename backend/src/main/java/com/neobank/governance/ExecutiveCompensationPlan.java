...
/** Long-term incentive plan, stock grants, and malus/clawback */
@Entity @Table(name = "executivecompensationplans") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class ExecutiveCompensationPlan extends BaseEntity {
