...
/** Board of directors approved credit, dividend, and strategy resolution */
@Entity @Table(name = "boardresolutionrecords") @Getter @Setter @Builder @NoArgsConstructor @AllArgsConstructor
public class BoardResolutionRecord extends BaseEntity {
