...
export const PrivateBankingPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Private Wealth & Bespoke Portfolio</h1>
          <p className="text-sm text-slate-400 mt-1">Exclusive high-net-worth advisory, family trust management, and discretionary mandates</p>
        </div>
