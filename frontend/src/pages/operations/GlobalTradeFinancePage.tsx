...
export const GlobalTradeFinancePage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Global Trade Finance & Customs Ledger</h1>
          <p className="text-sm text-slate-400 mt-1">Monitor documentary letters of credit, marine transit insurance, and bill of lading</p>
        </div>
            ...
            <tbody className="divide-y divide-slate-800">
              {[1, 2, 3, 4, 5].map((item) => (
                <tr key={item} className="hover:bg-slate-800/30 transition">
                  ...
                  <td className="p-3 font-medium text-white">Institutional Global Trade Finance & Customs Ledger Batch #{item}</td>
