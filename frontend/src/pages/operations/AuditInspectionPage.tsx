...
export const AuditInspectionPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Regulatory Audit & Examination Center</h1>
          <p className="text-sm text-slate-400 mt-1">Immutable audit trail exports, compliance logs, and central bank reporting packages</p>
        </div>
