  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Enterprise Risk & Capital Adequacy</h1>
          <p className="text-sm text-slate-400 mt-1">Value-at-Risk modeling, Basel III Liquidity Coverage Ratio, and macroeconomic stress testing</p>
        </div>
