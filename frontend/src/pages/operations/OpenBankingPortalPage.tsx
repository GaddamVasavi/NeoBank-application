...
export const OpenBankingPortalPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Open Banking & Fintech Partner Gateway</h1>
          <p className="text-sm text-slate-400 mt-1">Manage third-party fintech API access, PSD2 consent tokens, and sandbox credentials</p>
        </div>
