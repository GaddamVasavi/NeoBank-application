...
export const CorporateCardFleetPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Corporate Card Fleet & Policy Controls</h1>
          <p className="text-sm text-slate-400 mt-1">Manage company employee expense cards, merchant category restrictions, and receipt audits</p>
        </div>
