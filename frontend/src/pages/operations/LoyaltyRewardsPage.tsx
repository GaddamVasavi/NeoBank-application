  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Cashback Rewards & Gamification Hub</h1>
          <p className="text-sm text-slate-400 mt-1">Redeem earned reward points, track milestone badges, and discover partner merchant offers</p>
        </div>
