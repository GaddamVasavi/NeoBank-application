...
export const CorporateTreasuryPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Enterprise Corporate Treasury & Sweeping</h1>
          <p className="text-sm text-slate-400 mt-1">Multi-entity target balance sweeps, virtual IBAN allocation, and FX liquidity pooling</p>
        </div>
