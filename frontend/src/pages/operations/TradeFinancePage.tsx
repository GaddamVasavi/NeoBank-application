...
export const TradeFinancePage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Trade Finance & Documentary Credits</h1>
          <p className="text-sm text-slate-400 mt-1">Import/export letters of credit, customs shipping manifests, and bank guarantee bonds</p>
        </div>
