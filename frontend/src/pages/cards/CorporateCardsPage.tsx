  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Virtual & Physical Corporate Cards</h1>
          <p className="text-sm text-slate-400 mt-1">Issue instant virtual cards, set MCC controls, and monitor limits</p>
        </div>
            ...
            <tbody className="divide-y divide-slate-800">
              {[1, 2, 3, 4, 5, 6].map((item) => (
                <tr key={item} className="hover:bg-slate-800/30 transition">
                  ...
                  <td className="p-3 font-medium text-white">Institutional Virtual & Physical Corporate Cards Event #{item}</td>
