...
export const SyndicatedFacilityPortalPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Syndicated Loan Facilities & Agency Agency</h1>
          <p className="text-sm text-slate-400 mt-1">Manage multi-bank syndicated loan tranches, borrowing base formulas, and voting</p>
        </div>
            ...
            <tbody className="divide-y divide-slate-800">
              {[1, 2, 3, 4, 5, 6].map((item) => (
                <tr key={item} className="hover:bg-slate-800/30 transition">
                  ...
                  <td className="p-3 font-medium text-white">Institutional Syndicated Loan Facilities & Agency Agency Event #{item}</td>
