...
export const ClearingHouseCcpPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Central Clearing (CCP) & Initial Margin</h1>
          <p className="text-sm text-slate-400 mt-1">Initial margin modeling (ISDA SIMM), variation margin calls, and default fund</p>
        </div>
            ...
            <tbody className="divide-y divide-slate-800">
              {[1, 2, 3, 4, 5].map((item) => (
                <tr key={item} className="hover:bg-slate-800/30 transition">
                  ...
                  <td className="p-3 font-medium text-white">Regulatory Central Clearing (CCP) & Initial Margin Record #{item}</td>
