...
export const PrudentialReportingPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-white">Prudential Regulatory Returns & Basel III</h1>
          <p className="text-sm text-slate-400 mt-1">Quarterly capital adequacy filings, liquidity coverage reports, and large exposure limits</p>
        </div>
            ...
            <tbody className="divide-y divide-slate-800">
              {[1, 2, 3, 4].map((item) => (
                <tr key={item} className="hover:bg-slate-800/30 transition">
                  ...
                  <td className="p-3 font-medium text-white">Regulatory Prudential Regulatory Returns & Basel III Submission #{item}</td>
